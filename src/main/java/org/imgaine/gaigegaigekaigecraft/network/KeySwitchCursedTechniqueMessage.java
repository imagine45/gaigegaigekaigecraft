...
public class KeySwitchCursedTechniqueMessage {
   ...
   public static void registerMessage(FMLCommonSetupEvent event) {
      Gaigegaigekaigecraft.addNetworkMessage(KeySwitchCursedTechniqueMessage.class, KeySwitchCursedTechniqueMessage::buffer, KeySwitchCursedTechniqueMessage::new, KeySwitchCursedTechniqueMessage::handler);
   }
}
