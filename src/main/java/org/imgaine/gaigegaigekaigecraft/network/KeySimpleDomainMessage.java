...
public class KeySimpleDomainMessage {
   ...
   public static void registerMessage(FMLCommonSetupEvent event) {
      JujutsucraftMod.addNetworkMessage(KeySimpleDomainMessage.class, KeySimpleDomainMessage::buffer, KeySimpleDomainMessage::new, KeySimpleDomainMessage::handler);
   }
}
