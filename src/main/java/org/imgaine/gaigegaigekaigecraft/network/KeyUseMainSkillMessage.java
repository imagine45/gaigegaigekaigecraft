...
public class KeyUseMainSkillMessage {
   ...
   public static void registerMessage(FMLCommonSetupEvent event) {
      JujutsucraftMod.addNetworkMessage(KeyUseMainSkillMessage.class, KeyUseMainSkillMessage::buffer, KeyUseMainSkillMessage::new, KeyUseMainSkillMessage::handler);
   }
}
