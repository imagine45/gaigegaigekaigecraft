...
public class BulletKitchenKnifeRenderer extends EntityRenderer<BulletKitchenKnifeEntity> {
   private static final ResourceLocation texture = new ResourceLocation("gaigegaigekaigecraft:textures/entities/kitchen_knife.png");
   private final Modelkitchen_knife model;

   public BulletKitchenKnifeRenderer(EntityRendererProvider.Context context) {
      super(context);
      this.model = new Modelkitchen_knife(context.bakeLayer(Modelkitchen_knife.LAYER_LOCATION));
   }

   public void render(BulletKitchenKnifeEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(BulletKitchenKnifeEntity entity) {
      return texture;
   }
}
