...
import org.imgaine.gaigegaigekaigecraft.item.model.ClothesUroModel;
...
public class ClothesUroArmorRenderer extends GeoArmorRenderer<ClothesUroItem> {
   public ClothesUroArmorRenderer() {
      super(new ClothesUroModel());
