...
import org.imgaine.gaigegaigekaigecraft.item.model.HeadPropellerModel;
...
public class HeadPropellerArmorRenderer extends GeoArmorRenderer<HeadPropellerItem> {
   public HeadPropellerArmorRenderer() {
      super(new HeadPropellerModel());
