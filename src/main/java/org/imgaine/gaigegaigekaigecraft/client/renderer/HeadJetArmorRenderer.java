...
import org.imgaine.gaigegaigekaigecraft.item.model.HeadJetModel;
...
public class HeadJetArmorRenderer extends GeoArmorRenderer<HeadJetItem> {
   public HeadJetArmorRenderer() {
      super(new HeadJetModel());
   ...
   public RenderType getRenderType(HeadJetItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
