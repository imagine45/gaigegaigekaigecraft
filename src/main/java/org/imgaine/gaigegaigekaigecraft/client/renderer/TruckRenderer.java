...
import org.imgaine.gaigegaigekaigecraft.entity.model.TruckModel;
...
public class TruckRenderer extends DynamicGeoEntityRenderer<TruckEntity> {
   ...
   public void preRender(PoseStack poseStack, TruckEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
      float scale = 1.0F;
