...
import org.imgaine.gaigegaigekaigecraft.item.model.ClothesAngelModel;
...
public class ClothesAngelArmorRenderer extends GeoArmorRenderer<ClothesAngelItem> {
   public ClothesAngelArmorRenderer() {
      super(new ClothesAngelModel());
   ...
   public RenderType getRenderType(ClothesAngelItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
