...
import org.imgaine.gaigegaigekaigecraft.entity.layer.ProjectileSlashLayer;
...
public class ProjectileSlashRenderer extends DynamicGeoEntityRenderer<ProjectileSlashEntity> {
   public ProjectileSlashRenderer(EntityRendererProvider.Context renderManager) {
      super(renderManager, new ProjectileSlashModel());
      this.f_114477_ = 0.0F;
      this.addRenderLayer(new ProjectileSlashLayer(this));
