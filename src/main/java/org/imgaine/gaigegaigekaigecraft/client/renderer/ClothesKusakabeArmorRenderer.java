...
import org.imgaine.gaigegaigekaigecraft.item.model.ClothesKusakabeModel;
...
public class ClothesKusakabeArmorRenderer extends GeoArmorRenderer<ClothesKusakabeItem> {
   public ClothesKusakabeArmorRenderer() {
      super(new ClothesKusakabeModel());
   ...
   public RenderType getRenderType(ClothesKusakabeItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
