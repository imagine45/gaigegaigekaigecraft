...
import org.imgaine.gaigegaigekaigecraft.item.model.ClothesDagonModel;
...
public class ClothesDagonArmorRenderer extends GeoArmorRenderer<ClothesDagonItem> {
   public ClothesDagonArmorRenderer() {
      super(new ClothesDagonModel());
   ...
   public RenderType getRenderType(ClothesDagonItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
