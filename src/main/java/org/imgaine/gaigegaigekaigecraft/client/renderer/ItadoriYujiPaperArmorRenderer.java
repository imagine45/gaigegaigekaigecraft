...
import org.imgaine.gaigegaigekaigecraft.item.model.ItadoriYujiPaperModel;
...
public class ItadoriYujiPaperArmorRenderer extends GeoArmorRenderer<ItadoriYujiPaperItem> {
   public ItadoriYujiPaperArmorRenderer() {
      super(new ItadoriYujiPaperModel());
   ...
   public RenderType getRenderType(ItadoriYujiPaperItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
