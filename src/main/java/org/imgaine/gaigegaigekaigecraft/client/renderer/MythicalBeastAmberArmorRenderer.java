...
import org.imgaine.gaigegaigekaigecraft.item.model.MythicalBeastAmberModel;
...
public class MythicalBeastAmberArmorRenderer extends GeoArmorRenderer<MythicalBeastAmberItem> {
   public MythicalBeastAmberArmorRenderer() {
      super(new MythicalBeastAmberModel());
   ...
   public RenderType getRenderType(MythicalBeastAmberItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
