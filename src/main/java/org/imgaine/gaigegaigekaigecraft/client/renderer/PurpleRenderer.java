...
public class PurpleRenderer extends MobRenderer<PurpleEntity, Modelball<PurpleEntity>> {
   public PurpleRenderer(EntityRendererProvider.Context context) {
      ...
      this.addLayer(new RenderLayer<PurpleEntity, Modelball<PurpleEntity>>(this) {
         final ResourceLocation LAYER_TEXTURE = new ResourceLocation("gaigegaigekaigecraft:textures/entities/purple.png");

         public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, PurpleEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
   ...
   protected void scale(PurpleEntity entity, PoseStack poseStack, float f) {
