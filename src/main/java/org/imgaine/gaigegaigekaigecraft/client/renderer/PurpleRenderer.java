...
public class PurpleRenderer extends MobRenderer<PurpleEntity, Modelball<PurpleEntity>> {
   public PurpleRenderer(EntityRendererProvider.Context context) {
      ...
      this.m_115326_(new RenderLayer<PurpleEntity, Modelball<PurpleEntity>>(this) {
         final ResourceLocation LAYER_TEXTURE = new ResourceLocation("jujutsucraft:textures/entities/purple.png");
