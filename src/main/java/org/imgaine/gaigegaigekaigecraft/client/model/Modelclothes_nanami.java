...
public class Modelclothes_nanami<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("jujutsucraft", "modelclothes_nanami"), "main");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      Body.m_171599_("Body_r1", CubeListBuilder.m_171558_().m_171514_(24, 0).m_171480_().m_171488_(-1.5F, -0.5F, 1.5F, 4.0F, 1.0F, 0.0F, new CubeDeformation(0.2F)).m_171555_(false), PartPose.m_171423_(1.5F, 11.5F, -3.5F, -0.7854F, 0.3927F, 1.1781F));
      Body.m_171599_("Body_r2", CubeListBuilder.m_171558_().m_171514_(24, 0).m_171488_(-2.5F, -0.5F, 1.5F, 4.0F, 1.0F, 0.0F, new CubeDeformation(0.2F)), PartPose.m_171423_(-1.5F, 11.5F, -3.5F, -0.7854F, -0.3927F, -1.1781F));
      partdefinition.m_171599_("RightArm", CubeListBuilder.m_171558_().m_171514_(0, 16).m_171488_(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.15F)), PartPose.m_171419_(-5.0F, 2.0F, 0.0F));
      partdefinition.m_171599_("LeftArm", CubeListBuilder.m_171558_().m_171514_(16, 16).m_171480_().m_171488_(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.15F)).m_171555_(false), PartPose.m_171419_(5.0F, 2.0F, 0.0F));
