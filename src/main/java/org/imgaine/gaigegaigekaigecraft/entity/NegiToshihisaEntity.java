...
public class NegiToshihisaEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "negi_toshihisa");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = NegiToshihisaEntity.this.getX();
            double y = NegiToshihisaEntity.this.getY();
            double z = NegiToshihisaEntity.this.getZ();
            Entity entity = NegiToshihisaEntity.this;
            Level world = NegiToshihisaEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIKumiyaJuzoProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.NEGI_TOSHIHISA.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(NegiToshihisaEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(NegiToshihisaEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(NegiToshihisaEntity.class, EntityDataSerializers.STRING);
   }
}
