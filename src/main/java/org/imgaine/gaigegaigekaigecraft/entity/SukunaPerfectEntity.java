...
public class SukunaPerfectEntity extends Monster implements GeoEntity {
   ...
   public SukunaPerfectEntity(EntityType<SukunaPerfectEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.HITEN.get()));
      this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack((ItemLike)JujutsucraftModItems.SUPREME_MARTIAL_SOLUTION.get()));
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.SUKUNA_BODY_CHESTPLATE.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "sukuna_perfect");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = SukunaPerfectEntity.this.getX();
            double y = SukunaPerfectEntity.this.getY();
            double z = SukunaPerfectEntity.this.getZ();
            Entity entity = SukunaPerfectEntity.this;
            Level world = SukunaPerfectEntity.this.level();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(SukunaPerfectEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(SukunaPerfectEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(SukunaPerfectEntity.class, EntityDataSerializers.STRING);
   }
}
