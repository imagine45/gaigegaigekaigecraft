...
public class SukunaPerfectEntity extends Monster implements GeoEntity {
   ...
   public SukunaPerfectEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.SUKUNA_PERFECT.get(), world);
   }

   public SukunaPerfectEntity(EntityType<SukunaPerfectEntity> type, Level world) {
      super(type, world);
      ...
      this.m_21557_(false);
      this.m_274367_(0.6F);
      this.m_8061_(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.HITEN.get()));
      this.m_8061_(EquipmentSlot.OFFHAND, new ItemStack((ItemLike)JujutsucraftModItems.SUPREME_MARTIAL_SOLUTION.get()));
      this.m_8061_(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.SUKUNA_BODY_CHESTPLATE.get()));
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "sukuna_perfect");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = SukunaPerfectEntity.this.m_20185_();
            double y = SukunaPerfectEntity.this.m_20186_();
            double z = SukunaPerfectEntity.this.m_20189_();
            Entity entity = SukunaPerfectEntity.this;
            Level world = SukunaPerfectEntity.this.m_9236_();
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22276_, 900.0);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(SukunaPerfectEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(SukunaPerfectEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(SukunaPerfectEntity.class, EntityDataSerializers.f_135030_);
   }
}
