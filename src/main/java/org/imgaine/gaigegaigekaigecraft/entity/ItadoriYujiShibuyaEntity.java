...
public class ItadoriYujiShibuyaEntity extends Monster implements GeoEntity {
   ...
   public static final EntityDataAccessor<Boolean> DATA_sukuna;
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(DATA_sukuna, true);
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = ItadoriYujiShibuyaEntity.this.getX();
            double y = ItadoriYujiShibuyaEntity.this.getY();
            double z = ItadoriYujiShibuyaEntity.this.getZ();
            Entity entity = ItadoriYujiShibuyaEntity.this;
            Level world = ItadoriYujiShibuyaEntity.this.level();
   ...
   public void addAdditionalSaveData(CompoundTag compound) {
      ...
      compound.putBoolean("Datasukuna", (Boolean)this.entityData.get(DATA_sukuna));
   }
   ...
   public void readAdditionalSaveData(CompoundTag compound) {
      ...
      if (compound.contains("Datasukuna")) {
         this.entityData.set(DATA_sukuna, compound.getBoolean("Datasukuna"));
      }
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.ITADORI_YUJI_SHIBUYA.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(ItadoriYujiShibuyaEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(ItadoriYujiShibuyaEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(ItadoriYujiShibuyaEntity.class, EntityDataSerializers.STRING);
      DATA_sukuna = SynchedEntityData.defineId(ItadoriYujiShibuyaEntity.class, EntityDataSerializers.BOOLEAN);
   }
}
