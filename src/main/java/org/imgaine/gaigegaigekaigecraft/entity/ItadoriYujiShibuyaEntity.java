...
public class ItadoriYujiShibuyaEntity extends Monster implements GeoEntity {
   ...
   public ItadoriYujiShibuyaEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ITADORI_YUJI_SHIBUYA.get(), world);
   }

   public ItadoriYujiShibuyaEntity(EntityType<ItadoriYujiShibuyaEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = ItadoriYujiShibuyaEntity.this.m_20185_();
            double y = ItadoriYujiShibuyaEntity.this.m_20186_();
            double z = ItadoriYujiShibuyaEntity.this.m_20189_();
            Entity entity = ItadoriYujiShibuyaEntity.this;
            Level world = ItadoriYujiShibuyaEntity.this.m_9236_();
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.ITADORI_YUJI_SHIBUYA.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22276_, 190.0);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(ItadoriYujiShibuyaEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(ItadoriYujiShibuyaEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(ItadoriYujiShibuyaEntity.class, EntityDataSerializers.f_135030_);
   }
}
