...
import org.imgaine.gaigegaigekaigecraft.procedures.AICursedSpirit015Procedure;
...
public class CursedSpiritGrade015Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade015Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_015.get(), world);
   }

   public CursedSpiritGrade015Entity(EntityType<CursedSpiritGrade015Entity> type, Level world) {
      super(type, world);
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.DAITENGU_FAN.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "cursedspirit0_15");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade015Entity.this.getX();
            double y = CursedSpiritGrade015Entity.this.getY();
            double z = CursedSpiritGrade015Entity.this.getZ();
            Entity entity = CursedSpiritGrade015Entity.this;
            Level world = CursedSpiritGrade015Entity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AICursedSpirit015Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_015.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CursedSpiritGrade015Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CursedSpiritGrade015Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CursedSpiritGrade015Entity.class, EntityDataSerializers.STRING);
   }
}
