...
public class CursedSpiritGrade310Entity extends Monster {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, false) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade310Entity.this.getX();
            double y = CursedSpiritGrade310Entity.this.getY();
            double z = CursedSpiritGrade310Entity.this.getZ();
            Entity entity = CursedSpiritGrade310Entity.this;
            Level world = CursedSpiritGrade310Entity.this.level();
      ...
      this.goalSelector.addGoal(6, new LeapAtTargetGoal(this, 0.25F) {
         public boolean canUse() {
            double x = CursedSpiritGrade310Entity.this.getX();
            double y = CursedSpiritGrade310Entity.this.getY();
            double z = CursedSpiritGrade310Entity.this.getZ();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_310.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
