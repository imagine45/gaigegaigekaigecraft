...
public class CursedSpiritGrade217Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade217Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_217.get(), world);
   }

   public CursedSpiritGrade217Entity(EntityType<CursedSpiritGrade217Entity> type, Level world) {
      super(type, world);
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "cursedspirit2_17");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, false) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade217Entity.this.getX();
            double y = CursedSpiritGrade217Entity.this.getY();
            double z = CursedSpiritGrade217Entity.this.getZ();
            Entity entity = CursedSpiritGrade217Entity.this;
            Level world = CursedSpiritGrade217Entity.this.level();
   ...
   public void playStepSound(BlockPos pos, BlockState blockIn) {
      this.playSound((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.slime.jump_small")), 0.15F, 1.0F);
   }
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_217.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CursedSpiritGrade217Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CursedSpiritGrade217Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CursedSpiritGrade217Entity.class, EntityDataSerializers.STRING);
   }
}
