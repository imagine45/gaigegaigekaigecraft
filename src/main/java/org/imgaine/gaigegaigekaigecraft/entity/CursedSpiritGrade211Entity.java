...
public class CursedSpiritGrade211Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade211Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_211.get(), world);
   }

   public CursedSpiritGrade211Entity(EntityType<CursedSpiritGrade211Entity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "cursedspirit2_11");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.3, true) {
         ...
         public boolean m_8036_() {
            double x = CursedSpiritGrade211Entity.this.m_20185_();
            double y = CursedSpiritGrade211Entity.this.m_20186_();
            double z = CursedSpiritGrade211Entity.this.m_20189_();
            Entity entity = CursedSpiritGrade211Entity.this;
            Level world = CursedSpiritGrade211Entity.this.m_9236_();
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_211.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(CursedSpiritGrade211Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(CursedSpiritGrade211Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(CursedSpiritGrade211Entity.class, EntityDataSerializers.f_135030_);
   }
}
