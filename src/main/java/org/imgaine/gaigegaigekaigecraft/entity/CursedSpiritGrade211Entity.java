...
public class CursedSpiritGrade211Entity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "cursedspirit2_11");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.3, true) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade211Entity.this.getX();
            double y = CursedSpiritGrade211Entity.this.getY();
            double z = CursedSpiritGrade211Entity.this.getZ();
            Entity entity = CursedSpiritGrade211Entity.this;
            Level world = CursedSpiritGrade211Entity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_211.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CursedSpiritGrade211Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CursedSpiritGrade211Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CursedSpiritGrade211Entity.class, EntityDataSerializers.STRING);
   }
}
