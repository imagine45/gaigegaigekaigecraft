...
public class CursedSpiritGrade317Entity extends Monster {
   public CursedSpiritGrade317Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_317.get(), world);
   }
