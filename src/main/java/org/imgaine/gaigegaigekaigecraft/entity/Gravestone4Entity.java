...
public class Gravestone4Entity extends PathfinderMob {
   public Gravestone4Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.GRAVESTONE_4.get(), world);
   }

   public Gravestone4Entity(EntityType<Gravestone4Entity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 0;
      this.m_21557_(false);
   ...
   public EntityDimensions m_6972_(Pose pose) {
      return super.m_6972_(pose).m_20388_(3.0F);
   }
