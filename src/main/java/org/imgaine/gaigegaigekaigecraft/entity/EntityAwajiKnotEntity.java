...
public class EntityAwajiKnotEntity extends PathfinderMob {
   public static final EntityDataAccessor<Integer> DATA_size;

   public EntityAwajiKnotEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_AWAJI_KNOT.get(), world);
   }

   public EntityAwajiKnotEntity(EntityType<EntityAwajiKnotEntity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 0;
      this.m_21557_(true);
   ...
   protected void m_8097_() {
      super.m_8097_();
      this.f_19804_.m_135372_(DATA_size, 10);
   }
   ...
   public void m_7380_(CompoundTag compound) {
      ...
      compound.m_128405_("Datasize", (Integer)this.f_19804_.m_135370_(DATA_size));
   }

   public void m_7378_(CompoundTag compound) {
      super.m_7378_(compound);
      if (compound.m_128441_("Datasize")) {
         this.f_19804_.m_135381_(DATA_size, compound.m_128451_("Datasize"));
      }
   ...
   static {
      DATA_size = SynchedEntityData.m_135353_(EntityAwajiKnotEntity.class, EntityDataSerializers.f_135028_);
   }
}
