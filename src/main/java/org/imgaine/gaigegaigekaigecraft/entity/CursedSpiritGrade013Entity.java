...
import org.imgaine.gaigegaigekaigecraft.procedures.AICursedSpirit013Procedure;
...
public class CursedSpiritGrade013Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade013Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_013.get(), world);
   }

   public CursedSpiritGrade013Entity(EntityType<CursedSpiritGrade013Entity> type, Level world) {
      super(type, world);
      ...
      this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack((ItemLike)JujutsucraftModItems.SWORD_OGI.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "cursedspirit0_13");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade013Entity.this.getX();
            double y = CursedSpiritGrade013Entity.this.getY();
            double z = CursedSpiritGrade013Entity.this.getZ();
            Entity entity = CursedSpiritGrade013Entity.this;
            Level world = CursedSpiritGrade013Entity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AICursedSpirit013Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_013.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CursedSpiritGrade013Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CursedSpiritGrade013Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CursedSpiritGrade013Entity.class, EntityDataSerializers.STRING);
   }
}
