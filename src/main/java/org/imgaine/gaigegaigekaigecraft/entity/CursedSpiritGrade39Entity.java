...
public class CursedSpiritGrade39Entity extends Monster {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, false) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade39Entity.this.getX();
            double y = CursedSpiritGrade39Entity.this.getY();
            double z = CursedSpiritGrade39Entity.this.getZ();
            Entity entity = CursedSpiritGrade39Entity.this;
            Level world = CursedSpiritGrade39Entity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_39.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
