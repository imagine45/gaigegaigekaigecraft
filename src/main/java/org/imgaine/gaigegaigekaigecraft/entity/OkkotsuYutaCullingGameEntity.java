...
import org.imgaine.gaigegaigekaigecraft.procedures.AIOkkotsuProcedure;
...
public class OkkotsuYutaCullingGameEntity extends Monster implements GeoEntity {
   ...
   public OkkotsuYutaCullingGameEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.OKKOTSU_YUTA_CULLING_GAME.get(), world);
   }

   public OkkotsuYutaCullingGameEntity(EntityType<OkkotsuYutaCullingGameEntity> type, Level world) {
      super(type, world);
      ...
      this.m_21557_(false);
      this.m_274367_(0.6F);
      this.m_8061_(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.SWORD_OKKOTSU_YUTA.get()));
      this.m_8061_(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.UNIFORM_OKKOTSU_CHESTPLATE.get()));
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "okkotsu_yuta_culling_game_arc");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = OkkotsuYutaCullingGameEntity.this.m_20185_();
            double y = OkkotsuYutaCullingGameEntity.this.m_20186_();
            double z = OkkotsuYutaCullingGameEntity.this.m_20189_();
            Entity entity = OkkotsuYutaCullingGameEntity.this;
            Level world = OkkotsuYutaCullingGameEntity.this.m_9236_();
   ...
   public void m_6075_() {
      super.m_6075_();
      AIOkkotsuProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.OKKOTSU_YUTA_CULLING_GAME.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(OkkotsuYutaCullingGameEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(OkkotsuYutaCullingGameEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(OkkotsuYutaCullingGameEntity.class, EntityDataSerializers.f_135030_);
   }
}
