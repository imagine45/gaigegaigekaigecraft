...
public class OkkotsuYutaCullingGameEntity extends Monster implements GeoEntity {
   ...
   public OkkotsuYutaCullingGameEntity(EntityType<OkkotsuYutaCullingGameEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.UNIFORM_OKKOTSU_CHESTPLATE.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "okkotsu_yuta_culling_game_arc");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = OkkotsuYutaCullingGameEntity.this.getX();
            double y = OkkotsuYutaCullingGameEntity.this.getY();
            double z = OkkotsuYutaCullingGameEntity.this.getZ();
            Entity entity = OkkotsuYutaCullingGameEntity.this;
            Level world = OkkotsuYutaCullingGameEntity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.OKKOTSU_YUTA_CULLING_GAME.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(OkkotsuYutaCullingGameEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(OkkotsuYutaCullingGameEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(OkkotsuYutaCullingGameEntity.class, EntityDataSerializers.STRING);
   }
}
