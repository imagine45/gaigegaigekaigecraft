...
public class LarueEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "larue");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = LarueEntity.this.getX();
            double y = LarueEntity.this.getY();
            double z = LarueEntity.this.getZ();
            Entity entity = LarueEntity.this;
            Level world = LarueEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AILarueProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.LARUE.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(LarueEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(LarueEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(LarueEntity.class, EntityDataSerializers.STRING);
   }
}
