...
public class RozetsuShikigamiVesselEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "rozetsu_shikigami_vessel");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.4, true) {
         ...
         public boolean canUse() {
            double x = RozetsuShikigamiVesselEntity.this.getX();
            double y = RozetsuShikigamiVesselEntity.this.getY();
            double z = RozetsuShikigamiVesselEntity.this.getZ();
            Entity entity = RozetsuShikigamiVesselEntity.this;
            Level world = RozetsuShikigamiVesselEntity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.ROZETSU_SHIKIGAMI_VESSEL.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(RozetsuShikigamiVesselEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(RozetsuShikigamiVesselEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(RozetsuShikigamiVesselEntity.class, EntityDataSerializers.STRING);
   }
}
