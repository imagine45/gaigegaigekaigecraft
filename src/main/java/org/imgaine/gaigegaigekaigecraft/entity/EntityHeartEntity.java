...
public class EntityHeartEntity extends PathfinderMob implements GeoEntity {
   ...
   public EntityHeartEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_HEART.get(), world);
   }

   public EntityHeartEntity(EntityType<EntityHeartEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "heart");
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EntityHeartEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EntityHeartEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EntityHeartEntity.class, EntityDataSerializers.f_135030_);
   }
}
