...
public class EntityHeartEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "heart");
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityHeartEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityHeartEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityHeartEntity.class, EntityDataSerializers.STRING);
   }
}
