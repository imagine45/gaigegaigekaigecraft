...
import org.imgaine.gaigegaigekaigecraft.procedures.AIMobProcedure;
...
public class CurseUserEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT;
   public static final EntityDataAccessor<String> ANIMATION;
   public static final EntityDataAccessor<String> TEXTURE;
   public static final EntityDataAccessor<Integer> DATA_power;
   ...
   public CurseUserEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSE_USER.get(), world);
   }

   public CurseUserEntity(EntityType<CurseUserEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "mob_vindicator");
      this.f_19804_.m_135372_(DATA_power, 0);
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = CurseUserEntity.this.m_20185_();
            double y = CurseUserEntity.this.m_20186_();
            double z = CurseUserEntity.this.m_20189_();
            Entity entity = CurseUserEntity.this;
            Level world = CurseUserEntity.this.m_9236_();
            return super.m_8036_() && LogicAttackTargetProcedure.execute(entity);
         }
      });
      this.f_21346_.m_25352_(2, new HurtByTargetGoal(this, new Class[0]));
      this.f_21346_.m_25352_(3, new NearestAttackableTargetGoal(this, JujutsuSorcererEntity.class, false, false) {
         public boolean m_8036_() {
            double x = CurseUserEntity.this.m_20185_();
            double y = CurseUserEntity.this.m_20186_();
            double z = CurseUserEntity.this.m_20189_();
   ...
   public void m_7380_(CompoundTag compound) {
      ...
      compound.m_128405_("Datapower", (Integer)this.f_19804_.m_135370_(DATA_power));
   }
   ...
   public void m_7378_(CompoundTag compound) {
      ...
      if (compound.m_128441_("Datapower")) {
         this.f_19804_.m_135381_(DATA_power, compound.m_128451_("Datapower"));
      }
   ...
   public void m_6075_() {
      super.m_6075_();
      AIMobProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.CURSE_USER.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(CurseUserEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(CurseUserEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(CurseUserEntity.class, EntityDataSerializers.f_135030_);
      DATA_power = SynchedEntityData.m_135353_(CurseUserEntity.class, EntityDataSerializers.f_135028_);
   }
}
