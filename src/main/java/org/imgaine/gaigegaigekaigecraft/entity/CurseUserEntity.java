...
public class CurseUserEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "mob_vindicator");
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = CurseUserEntity.this.getX();
            double y = CurseUserEntity.this.getY();
            double z = CurseUserEntity.this.getZ();
            Entity entity = CurseUserEntity.this;
            Level world = CurseUserEntity.this.level();
            return super.canUse() && LogicAttackTargetProcedure.execute(entity);
         }
      });
      this.targetSelector.addGoal(2, new HurtByTargetGoal(this, new Class[0]));
      this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, JujutsuSorcererEntity.class, false, false) {
         public boolean canUse() {
            double x = CurseUserEntity.this.getX();
            double y = CurseUserEntity.this.getY();
            double z = CurseUserEntity.this.getZ();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSE_USER.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CurseUserEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CurseUserEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CurseUserEntity.class, EntityDataSerializers.STRING);
      DATA_power = SynchedEntityData.defineId(CurseUserEntity.class, EntityDataSerializers.INT);
   }
}
