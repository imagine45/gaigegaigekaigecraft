...
public class DaidoHaganeEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "daido_hagane");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = DaidoHaganeEntity.this.getX();
            double y = DaidoHaganeEntity.this.getY();
            double z = DaidoHaganeEntity.this.getZ();
            Entity entity = DaidoHaganeEntity.this;
            Level world = DaidoHaganeEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIDaidoHaganeProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.DAIDO_HAGANE.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(DaidoHaganeEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(DaidoHaganeEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(DaidoHaganeEntity.class, EntityDataSerializers.STRING);
   }
}
