...
import org.imgaine.gaigegaigekaigecraft.procedures.AICursedSpiritGrade17Procedure;
...
public class CursedSpiritGrade17Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade17Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_17.get(), world);
   }

   public CursedSpiritGrade17Entity(EntityType<CursedSpiritGrade17Entity> type, Level world) {
      super(type, world);
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "cursedspirit1_7");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade17Entity.this.getX();
            double y = CursedSpiritGrade17Entity.this.getY();
            double z = CursedSpiritGrade17Entity.this.getZ();
            Entity entity = CursedSpiritGrade17Entity.this;
            Level world = CursedSpiritGrade17Entity.this.level();
   ...
   public void playStepSound(BlockPos pos, BlockState blockIn) {
      this.playSound((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.slime_block.step")), 0.15F, 1.0F);
   }
   ...
   public void baseTick() {
      super.baseTick();
      AICursedSpiritGrade17Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_17.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CursedSpiritGrade17Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CursedSpiritGrade17Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CursedSpiritGrade17Entity.class, EntityDataSerializers.STRING);
   }
}
