...
public class EntityJacobsLadderAngelEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "jacobs_ladder_angel");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new RandomStrollGoal(this, 1.5, 20) {
         protected Vec3 getPosition() {
            RandomSource random = EntityJacobsLadderAngelEntity.this.getRandom();
            double dir_x = EntityJacobsLadderAngelEntity.this.getX() + (double)((random.nextFloat() * 2.0F - 1.0F) * 16.0F);
            double dir_y = EntityJacobsLadderAngelEntity.this.getY() + (double)((random.nextFloat() * 2.0F - 1.0F) * 16.0F);
            double dir_z = EntityJacobsLadderAngelEntity.this.getZ() + (double)((random.nextFloat() * 2.0F - 1.0F) * 16.0F);
   ...
   public void baseTick() {
      super.baseTick();
      AIAngelProcedure.execute(this.level(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityJacobsLadderAngelEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityJacobsLadderAngelEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityJacobsLadderAngelEntity.class, EntityDataSerializers.STRING);
   }
}
