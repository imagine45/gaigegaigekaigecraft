...
public class EntityHandsEntity extends PathfinderMob {
   public EntityHandsEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_HANDS.get(), world);
   }

   public EntityHandsEntity(EntityType<EntityHandsEntity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 0;
      this.m_21557_(true);
