...
public class KashimoHajimeEntity extends Monster implements GeoEntity {
   ...
   public KashimoHajimeEntity(EntityType<KashimoHajimeEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.NYOI_STAFF.get()));
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_KASHIMO_HAJIME_HELMET.get()));
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_KASHIMO_HAJIME_CHESTPLATE.get()));
      this.setItemSlot(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_KASHIMO_HAJIME_LEGGINGS.get()));
      this.setItemSlot(EquipmentSlot.FEET, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_KASHIMO_HAJIME_BOOTS.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "kashimo_hajime");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = KashimoHajimeEntity.this.getX();
            double y = KashimoHajimeEntity.this.getY();
            double z = KashimoHajimeEntity.this.getZ();
            Entity entity = KashimoHajimeEntity.this;
            Level world = KashimoHajimeEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIKashimoHajimeProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.KASHIMO_HAJIME.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(KashimoHajimeEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(KashimoHajimeEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(KashimoHajimeEntity.class, EntityDataSerializers.STRING);
   }
}
