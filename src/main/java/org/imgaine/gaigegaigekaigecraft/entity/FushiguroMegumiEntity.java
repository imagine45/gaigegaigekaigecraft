...
public class FushiguroMegumiEntity extends Monster implements GeoEntity {
   ...
   public FushiguroMegumiEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.FUSHIGURO_MEGUMI.get(), world);
   }

   public FushiguroMegumiEntity(EntityType<FushiguroMegumiEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = FushiguroMegumiEntity.this.m_20185_();
            double y = FushiguroMegumiEntity.this.m_20186_();
            double z = FushiguroMegumiEntity.this.m_20189_();
            Entity entity = FushiguroMegumiEntity.this;
            Level world = FushiguroMegumiEntity.this.m_9236_();
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.FUSHIGURO_MEGUMI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22276_, 140.0);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(FushiguroMegumiEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(FushiguroMegumiEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(FushiguroMegumiEntity.class, EntityDataSerializers.f_135030_);
   }
}
