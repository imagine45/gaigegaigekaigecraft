...
public class FushiguroMegumiEntity extends Monster implements GeoEntity {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = FushiguroMegumiEntity.this.getX();
            double y = FushiguroMegumiEntity.this.getY();
            double z = FushiguroMegumiEntity.this.getZ();
            Entity entity = FushiguroMegumiEntity.this;
            Level world = FushiguroMegumiEntity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.FUSHIGURO_MEGUMI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.add(Attributes.MAX_HEALTH, 140.0);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(FushiguroMegumiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(FushiguroMegumiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(FushiguroMegumiEntity.class, EntityDataSerializers.STRING);
   }
}
