...
public class CharlesBernardEntity extends Monster implements GeoEntity {
   ...
   public CharlesBernardEntity(EntityType<CharlesBernardEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.G_STAFF.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "charles_bernard");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = CharlesBernardEntity.this.getX();
            double y = CharlesBernardEntity.this.getY();
            double z = CharlesBernardEntity.this.getZ();
            Entity entity = CharlesBernardEntity.this;
            Level world = CharlesBernardEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AICharlesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CHARLES_BERNARD.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CharlesBernardEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CharlesBernardEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CharlesBernardEntity.class, EntityDataSerializers.STRING);
   }
}
