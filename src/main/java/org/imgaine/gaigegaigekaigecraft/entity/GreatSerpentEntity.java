...
public class GreatSerpentEntity extends Monster {
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.0, true) {
         ...
         public boolean m_8036_() {
            double x = GreatSerpentEntity.this.m_20185_();
            double y = GreatSerpentEntity.this.m_20186_();
            double z = GreatSerpentEntity.this.m_20189_();
            Entity entity = GreatSerpentEntity.this;
            Level world = GreatSerpentEntity.this.m_9236_();
   ...
   public void m_6075_() {
      super.m_6075_();
      AIGreatSerpentProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
   }
