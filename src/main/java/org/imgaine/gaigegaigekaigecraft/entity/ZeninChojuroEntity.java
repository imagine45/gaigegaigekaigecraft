...
public class ZeninChojuroEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "zenin_chojuro");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.4, true) {
         ...
         public boolean canUse() {
            double x = ZeninChojuroEntity.this.getX();
            double y = ZeninChojuroEntity.this.getY();
            double z = ZeninChojuroEntity.this.getZ();
            Entity entity = ZeninChojuroEntity.this;
            Level world = ZeninChojuroEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIZeninChojuroProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.ZENIN_CHOJURO.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(ZeninChojuroEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(ZeninChojuroEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(ZeninChojuroEntity.class, EntityDataSerializers.STRING);
   }
}
