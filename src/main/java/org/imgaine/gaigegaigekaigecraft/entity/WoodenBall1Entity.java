...
public class WoodenBall1Entity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "tex_wood");
   }
   ...
   public void baseTick() {
      super.baseTick();
      AIWoodenBallProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(WoodenBall1Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(WoodenBall1Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(WoodenBall1Entity.class, EntityDataSerializers.STRING);
   }
}
