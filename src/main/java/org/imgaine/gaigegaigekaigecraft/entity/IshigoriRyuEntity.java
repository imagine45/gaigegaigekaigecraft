...
import org.imgaine.gaigegaigekaigecraft.procedures.AIIshigoriRyuProcedure;
...
public class IshigoriRyuEntity extends Monster implements GeoEntity {
   ...
   public IshigoriRyuEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ISHIGORI_RYU.get(), world);
   }

   public IshigoriRyuEntity(EntityType<IshigoriRyuEntity> type, Level world) {
      super(type, world);
      ...
      this.m_21557_(false);
      this.m_274367_(0.6F);
      this.m_8061_(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_ISHIGORI_HELMET.get()));
      this.m_8061_(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_ISHIGORI_CHESTPLATE.get()));
      this.m_8061_(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_ISHIGORI_LEGGINGS.get()));
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "ishigori_ryu");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = IshigoriRyuEntity.this.m_20185_();
            double y = IshigoriRyuEntity.this.m_20186_();
            double z = IshigoriRyuEntity.this.m_20189_();
            Entity entity = IshigoriRyuEntity.this;
            Level world = IshigoriRyuEntity.this.m_9236_();
   ...
   public void m_6075_() {
      super.m_6075_();
      AIIshigoriRyuProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.ISHIGORI_RYU.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(IshigoriRyuEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(IshigoriRyuEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(IshigoriRyuEntity.class, EntityDataSerializers.f_135030_);
   }
}
