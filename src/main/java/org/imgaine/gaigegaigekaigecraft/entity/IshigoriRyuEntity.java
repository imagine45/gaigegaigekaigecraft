...
public class IshigoriRyuEntity extends Monster implements GeoEntity {
   ...
   public IshigoriRyuEntity(EntityType<IshigoriRyuEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_ISHIGORI_HELMET.get()));
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_ISHIGORI_CHESTPLATE.get()));
      this.setItemSlot(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_ISHIGORI_LEGGINGS.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "ishigori_ryu");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = IshigoriRyuEntity.this.getX();
            double y = IshigoriRyuEntity.this.getY();
            double z = IshigoriRyuEntity.this.getZ();
            Entity entity = IshigoriRyuEntity.this;
            Level world = IshigoriRyuEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIIshigoriRyuProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.ISHIGORI_RYU.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(IshigoriRyuEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(IshigoriRyuEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(IshigoriRyuEntity.class, EntityDataSerializers.STRING);
   }
}
