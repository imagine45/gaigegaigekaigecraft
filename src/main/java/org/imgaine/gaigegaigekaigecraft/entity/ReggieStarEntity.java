...
public class ReggieStarEntity extends Monster implements GeoEntity {
   ...
   public ReggieStarEntity(EntityType<ReggieStarEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_REGGIE_STAR_CHESTPLATE.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "reggie_star");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = ReggieStarEntity.this.getX();
            double y = ReggieStarEntity.this.getY();
            double z = ReggieStarEntity.this.getZ();
            Entity entity = ReggieStarEntity.this;
            Level world = ReggieStarEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIReggieStarProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.REGGIE_STAR.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(ReggieStarEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(ReggieStarEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(ReggieStarEntity.class, EntityDataSerializers.STRING);
   }
}
