...
public class JujutsuSorcererEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "mob_villager");
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = JujutsuSorcererEntity.this.getX();
            double y = JujutsuSorcererEntity.this.getY();
            double z = JujutsuSorcererEntity.this.getZ();
            Entity entity = JujutsuSorcererEntity.this;
            Level world = JujutsuSorcererEntity.this.level();
   ...
   public void addAdditionalSaveData(CompoundTag compound) {
      ...
      compound.putInt("Datapower", (Integer)this.entityData.get(DATA_power));
   }
   ...
   public void baseTick() {
      super.baseTick();
      AIMobProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.JUJUTSU_SORCERER.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(JujutsuSorcererEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(JujutsuSorcererEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(JujutsuSorcererEntity.class, EntityDataSerializers.STRING);
      DATA_power = SynchedEntityData.defineId(JujutsuSorcererEntity.class, EntityDataSerializers.INT);
   }
}
