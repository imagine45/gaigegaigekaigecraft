...
public class OkkotsuYutaEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "okkotsu_yuta");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = OkkotsuYutaEntity.this.getX();
            double y = OkkotsuYutaEntity.this.getY();
            double z = OkkotsuYutaEntity.this.getZ();
            Entity entity = OkkotsuYutaEntity.this;
            Level world = OkkotsuYutaEntity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.OKKOTSU_YUTA.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(OkkotsuYutaEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(OkkotsuYutaEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(OkkotsuYutaEntity.class, EntityDataSerializers.STRING);
   }
}
