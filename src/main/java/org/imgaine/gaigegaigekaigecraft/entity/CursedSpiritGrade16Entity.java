...
import org.imgaine.gaigegaigekaigecraft.procedures.AICursedSpirit16Procedure;
...
public class CursedSpiritGrade16Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade16Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_16.get(), world);
   }

   public CursedSpiritGrade16Entity(EntityType<CursedSpiritGrade16Entity> type, Level world) {
      super(type, world);
