...
public class CursedSpiritGrade26Entity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "cursedspirit2_6");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.4, true) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade26Entity.this.getX();
            double y = CursedSpiritGrade26Entity.this.getY();
            double z = CursedSpiritGrade26Entity.this.getZ();
            Entity entity = CursedSpiritGrade26Entity.this;
            Level world = CursedSpiritGrade26Entity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_26.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.add(Attributes.ARMOR, 11.0);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CursedSpiritGrade26Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CursedSpiritGrade26Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CursedSpiritGrade26Entity.class, EntityDataSerializers.STRING);
   }
}
