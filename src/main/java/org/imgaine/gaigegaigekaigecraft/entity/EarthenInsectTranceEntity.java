...
public class EarthenInsectTranceEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "earthen_insect_trance");
   }
   ...
   public void baseTick() {
      super.baseTick();
      AIEarthenInsectTranceProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EarthenInsectTranceEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EarthenInsectTranceEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EarthenInsectTranceEntity.class, EntityDataSerializers.STRING);
   }
}
