...
public class FushiguroTojiBugEntity extends Monster implements GeoEntity {
   ...
   public FushiguroTojiBugEntity(EntityType<FushiguroTojiBugEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.PLAYFUL_CLOUD.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "fushiguro_toji_bug");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = FushiguroTojiBugEntity.this.getX();
            double y = FushiguroTojiBugEntity.this.getY();
            double z = FushiguroTojiBugEntity.this.getZ();
            Entity entity = FushiguroTojiBugEntity.this;
            Level world = FushiguroTojiBugEntity.this.level();
   ...
   public void die(DamageSource source) {
      super.die(source);
      FushiguroTojiEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }
   ...
   public void baseTick() {
      super.baseTick();
      AIFushiguroTojiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.FUSHIGURO_TOJI_BUG.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(FushiguroTojiBugEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(FushiguroTojiBugEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(FushiguroTojiBugEntity.class, EntityDataSerializers.STRING);
   }
}
