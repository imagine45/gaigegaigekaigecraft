...
public class SudaManamiEntity extends Monster implements GeoEntity {
   ...
   public SudaManamiEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.SUDA_MANAMI.get(), world);
   }

   public SudaManamiEntity(EntityType<SudaManamiEntity> type, Level world) {
      super(type, world);
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "suda_manami");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = SudaManamiEntity.this.getX();
            double y = SudaManamiEntity.this.getY();
            double z = SudaManamiEntity.this.getZ();
            Entity entity = SudaManamiEntity.this;
            Level world = SudaManamiEntity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.SUDA_MANAMI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(SudaManamiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(SudaManamiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(SudaManamiEntity.class, EntityDataSerializers.STRING);
   }
}
