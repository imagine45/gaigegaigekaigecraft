...
public class InumakiTogeEntity extends Monster implements GeoEntity {
   ...
   public InumakiTogeEntity(EntityType<InumakiTogeEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.UNIFORM_NORMAL_HELMET.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "inumaki_toge");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = InumakiTogeEntity.this.getX();
            double y = InumakiTogeEntity.this.getY();
            double z = InumakiTogeEntity.this.getZ();
            Entity entity = InumakiTogeEntity.this;
            Level world = InumakiTogeEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIInumakiTogeProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.INUMAKI_TOGE.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(InumakiTogeEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(InumakiTogeEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(InumakiTogeEntity.class, EntityDataSerializers.STRING);
   }
}
