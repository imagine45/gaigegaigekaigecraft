...
import org.imgaine.gaigegaigekaigecraft.procedures.AIJogoProcedure;
import org.imgaine.gaigegaigekaigecraft.procedures.JogoEntityDiesProcedure;
...
public class JogoEntity extends Monster implements GeoEntity {
   ...
   public JogoEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.JOGO.get(), world);
   }
   ...
   public JogoEntity(EntityType<JogoEntity> type, Level world) {
      ...
      this.m_21557_(false);
      this.m_274367_(0.6F);
      this.m_8061_(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_JOGO_HELMET.get()));
      this.m_8061_(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_JOGO_CHESTPLATE.get()));
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "jogo");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.5, true) {
         ...
         public boolean m_8036_() {
            double x = JogoEntity.this.m_20185_();
            double y = JogoEntity.this.m_20186_();
            double z = JogoEntity.this.m_20189_();
            Entity entity = JogoEntity.this;
            Level world = JogoEntity.this.m_9236_();
   ...
   public void m_6667_(DamageSource source) {
      ...
      JogoEntityDiesProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      AIJogoProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.JOGO.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22276_, 405.0);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(JogoEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(JogoEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(JogoEntity.class, EntityDataSerializers.f_135030_);
   }
}
