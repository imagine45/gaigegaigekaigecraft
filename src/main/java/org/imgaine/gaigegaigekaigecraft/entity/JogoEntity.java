...
public class JogoEntity extends Monster implements GeoEntity {
   ...
   public JogoEntity(EntityType<JogoEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_JOGO_HELMET.get()));
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_JOGO_CHESTPLATE.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "jogo");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.5, true) {
         ...
         public boolean canUse() {
            double x = JogoEntity.this.getX();
            double y = JogoEntity.this.getY();
            double z = JogoEntity.this.getZ();
            Entity entity = JogoEntity.this;
            Level world = JogoEntity.this.level();
   ...
   public void die(DamageSource source) {
      super.die(source);
      JogoEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }
   ...
   public void baseTick() {
      super.baseTick();
      AIJogoProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.JOGO.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.add(Attributes.MAX_HEALTH, 405.0);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(JogoEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(JogoEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(JogoEntity.class, EntityDataSerializers.STRING);
   }
}
