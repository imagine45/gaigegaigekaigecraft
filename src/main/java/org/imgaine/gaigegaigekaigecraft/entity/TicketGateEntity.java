...
public class TicketGateEntity extends PathfinderMob {
   public TicketGateEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.TICKET_GATE.get(), world);
   }

   public TicketGateEntity(EntityType<TicketGateEntity> type, Level world) {
      super(type, world);
