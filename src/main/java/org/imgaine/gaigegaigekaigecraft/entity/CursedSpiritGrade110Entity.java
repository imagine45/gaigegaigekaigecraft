...
public class CursedSpiritGrade110Entity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "cursedspirit1_10");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.0, true) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade110Entity.this.getX();
            double y = CursedSpiritGrade110Entity.this.getY();
            double z = CursedSpiritGrade110Entity.this.getZ();
            Entity entity = CursedSpiritGrade110Entity.this;
            Level world = CursedSpiritGrade110Entity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AICursedSpiritGrade110Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_110.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CursedSpiritGrade110Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CursedSpiritGrade110Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CursedSpiritGrade110Entity.class, EntityDataSerializers.STRING);
   }
}
