...
public class YorozuEntity extends Monster implements GeoEntity {
   ...
   public YorozuEntity(EntityType<YorozuEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_YOROZU_CHESTPLATE.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "yorozu");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = YorozuEntity.this.getX();
            double y = YorozuEntity.this.getY();
            double z = YorozuEntity.this.getZ();
            Entity entity = YorozuEntity.this;
            Level world = YorozuEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIYorozuProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.YOROZU.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(YorozuEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(YorozuEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(YorozuEntity.class, EntityDataSerializers.STRING);
   }
}
