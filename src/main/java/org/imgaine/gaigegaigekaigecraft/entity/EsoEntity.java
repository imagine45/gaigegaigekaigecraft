...
public class EsoEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "eso");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = EsoEntity.this.getX();
            double y = EsoEntity.this.getY();
            double z = EsoEntity.this.getZ();
            Entity entity = EsoEntity.this;
            Level world = EsoEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIEsoProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.ESO.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EsoEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EsoEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EsoEntity.class, EntityDataSerializers.STRING);
   }
}
