...
import org.imgaine.gaigegaigekaigecraft.procedures.AIRainbowDragonProcedure;
...
public class CursedSpiritGrade13Entity extends Monster {
   public CursedSpiritGrade13Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_13.get(), world);
   }

   public CursedSpiritGrade13Entity(EntityType<CursedSpiritGrade13Entity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 80;
      this.m_21557_(false);
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.0, true) {
         ...
         public boolean m_8036_() {
            double x = CursedSpiritGrade13Entity.this.m_20185_();
            double y = CursedSpiritGrade13Entity.this.m_20186_();
            double z = CursedSpiritGrade13Entity.this.m_20189_();
            Entity entity = CursedSpiritGrade13Entity.this;
            Level world = CursedSpiritGrade13Entity.this.m_9236_();
   ...
   public void m_6075_() {
      super.m_6075_();
      AIRainbowDragonProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
   }

   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_13.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
