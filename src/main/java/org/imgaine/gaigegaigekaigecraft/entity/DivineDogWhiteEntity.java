...
public class DivineDogWhiteEntity extends Monster {
   public DivineDogWhiteEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.DIVINE_DOG_WHITE.get(), world);
   }

   public DivineDogWhiteEntity(EntityType<DivineDogWhiteEntity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 0;
      this.m_21557_(false);
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.3, true) {
         ...
         public boolean m_8036_() {
            double x = DivineDogWhiteEntity.this.m_20185_();
            double y = DivineDogWhiteEntity.this.m_20186_();
            double z = DivineDogWhiteEntity.this.m_20189_();
            Entity entity = DivineDogWhiteEntity.this;
            Level world = DivineDogWhiteEntity.this.m_9236_();
