   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.3, true) {
         ...
         public boolean canUse() {
            double x = DivineDogWhiteEntity.this.getX();
            double y = DivineDogWhiteEntity.this.getY();
            double z = DivineDogWhiteEntity.this.getZ();
            Entity entity = DivineDogWhiteEntity.this;
            Level world = DivineDogWhiteEntity.this.level();
