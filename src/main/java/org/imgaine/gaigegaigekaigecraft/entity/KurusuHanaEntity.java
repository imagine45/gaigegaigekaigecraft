...
public class KurusuHanaEntity extends Monster implements GeoEntity {
   ...
   public KurusuHanaEntity(EntityType<KurusuHanaEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_ANGEL_HELMET.get()));
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_ANGEL_CHESTPLATE.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "kurusu_hana");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = KurusuHanaEntity.this.getX();
            double y = KurusuHanaEntity.this.getY();
            double z = KurusuHanaEntity.this.getZ();
            Entity entity = KurusuHanaEntity.this;
            Level world = KurusuHanaEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIHanaKurusuProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.KURUSU_HANA.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(KurusuHanaEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(KurusuHanaEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(KurusuHanaEntity.class, EntityDataSerializers.STRING);
   }
}
