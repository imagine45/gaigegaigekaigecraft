...
public class FrameEntity extends PathfinderMob {
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
      ...
      FrameOnEntityTickUpdateProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
      return retval;
   }

   public void baseTick() {
      super.baseTick();
      FrameOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
