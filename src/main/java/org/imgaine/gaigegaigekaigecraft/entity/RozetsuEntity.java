...
public class RozetsuEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "rozetsu");
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.4, true) {
         ...
         public boolean canUse() {
            double x = RozetsuEntity.this.getX();
            double y = RozetsuEntity.this.getY();
            double z = RozetsuEntity.this.getZ();
            Entity entity = RozetsuEntity.this;
            Level world = RozetsuEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIRozetsuProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.ROZETSU.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(RozetsuEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(RozetsuEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(RozetsuEntity.class, EntityDataSerializers.STRING);
      DATA_form = SynchedEntityData.defineId(RozetsuEntity.class, EntityDataSerializers.INT);
   }
}
