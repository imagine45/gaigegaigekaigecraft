...
import org.imgaine.gaigegaigekaigecraft.procedures.AITrueSphereProcedure;
...
public class TrueSphereEntity extends PathfinderMob {
   public TrueSphereEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.TRUE_SPHERE.get(), world);
   }

   public TrueSphereEntity(EntityType<TrueSphereEntity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 0;
      this.m_21557_(false);
   ...
   public void m_6075_() {
      super.m_6075_();
      AITrueSphereProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22276_, 314.0);
