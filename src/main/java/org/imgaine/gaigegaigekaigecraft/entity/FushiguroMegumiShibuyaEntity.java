...
public class FushiguroMegumiShibuyaEntity extends Monster implements GeoEntity {
   ...
   public FushiguroMegumiShibuyaEntity(EntityType<FushiguroMegumiShibuyaEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.HAIR_FUSHIGURO_MEGUMI_HELMET.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "fushiguro_megumi");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = FushiguroMegumiShibuyaEntity.this.getX();
            double y = FushiguroMegumiShibuyaEntity.this.getY();
            double z = FushiguroMegumiShibuyaEntity.this.getZ();
            Entity entity = FushiguroMegumiShibuyaEntity.this;
            Level world = FushiguroMegumiShibuyaEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIFushiguroMegumiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.FUSHIGURO_MEGUMI_SHIBUYA.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(FushiguroMegumiShibuyaEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(FushiguroMegumiShibuyaEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(FushiguroMegumiShibuyaEntity.class, EntityDataSerializers.STRING);
   }
}
