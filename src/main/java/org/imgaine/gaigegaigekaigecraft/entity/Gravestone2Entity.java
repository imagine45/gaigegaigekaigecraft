...
public class Gravestone2Entity extends PathfinderMob {
   public Gravestone2Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.GRAVESTONE_2.get(), world);
   }

   public Gravestone2Entity(EntityType<Gravestone2Entity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 0;
      this.m_21557_(false);
