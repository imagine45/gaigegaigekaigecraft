...
public class CursedSpiritGrade32Entity extends Monster {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.3, false) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade32Entity.this.getX();
            double y = CursedSpiritGrade32Entity.this.getY();
            double z = CursedSpiritGrade32Entity.this.getZ();
            Entity entity = CursedSpiritGrade32Entity.this;
            Level world = CursedSpiritGrade32Entity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_32.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
