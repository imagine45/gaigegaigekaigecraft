...
public class KaichiEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "kaichi");
   }
   ...
   public void baseTick() {
      super.baseTick();
      AIKaichiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(KaichiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(KaichiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(KaichiEntity.class, EntityDataSerializers.STRING);
   }
}
