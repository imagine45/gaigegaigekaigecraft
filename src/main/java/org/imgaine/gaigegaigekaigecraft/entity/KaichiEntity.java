...
import org.imgaine.gaigegaigekaigecraft.procedures.AIKaichiProcedure;
...
public class KaichiEntity extends PathfinderMob implements GeoEntity {
   ...
   public KaichiEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.KAICHI.get(), world);
   }

   public KaichiEntity(EntityType<KaichiEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "kaichi");
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      AIKaichiProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(KaichiEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(KaichiEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(KaichiEntity.class, EntityDataSerializers.f_135030_);
   }
}
