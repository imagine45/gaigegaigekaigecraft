...
import org.imgaine.gaigegaigekaigecraft.procedures.TakadaOnEntityTickUpdateProcedure;
...
public class TakadaEntity extends PathfinderMob implements GeoEntity {
   ...
   public TakadaEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.TAKADA.get(), world);
   }
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "takada");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(3, new MoveBackToVillageGoal(this, 0.6, false));
   ...
   public void m_6075_() {
      super.m_6075_();
      TakadaOnEntityTickUpdateProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(TakadaEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(TakadaEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(TakadaEntity.class, EntityDataSerializers.f_135030_);
   }
}
