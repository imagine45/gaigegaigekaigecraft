...
public class TakadaEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "takada");
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(TakadaEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(TakadaEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(TakadaEntity.class, EntityDataSerializers.STRING);
   }
}
