...
public class AwasakaJiroEntity extends Monster implements GeoEntity {
   ...
   public AwasakaJiroEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.AWASAKA_JIRO.get(), world);
   }

   public AwasakaJiroEntity(EntityType<AwasakaJiroEntity> type, Level world) {
      super(type, world);
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "awasaka_jiro");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = AwasakaJiroEntity.this.getX();
            double y = AwasakaJiroEntity.this.getY();
            double z = AwasakaJiroEntity.this.getZ();
            Entity entity = AwasakaJiroEntity.this;
            Level world = AwasakaJiroEntity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.AWASAKA_JIRO.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.add(Attributes.MAX_HEALTH, 155.0);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(AwasakaJiroEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(AwasakaJiroEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(AwasakaJiroEntity.class, EntityDataSerializers.STRING);
   }
}
