...
import org.imgaine.gaigegaigekaigecraft.procedures.AIThunderBoltImpactProcedure;
...
public class ThunderImpactEntity extends PathfinderMob {
   public ThunderImpactEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.THUNDER_IMPACT.get(), world);
   }

   public ThunderImpactEntity(EntityType<ThunderImpactEntity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 0;
      this.m_21557_(true);
   ...
   public void m_6075_() {
      super.m_6075_();
      AIThunderBoltImpactProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
   }
