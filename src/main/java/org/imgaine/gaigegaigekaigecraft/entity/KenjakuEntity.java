...
public class KenjakuEntity extends Monster implements GeoEntity {
   ...
   public KenjakuEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.KENJAKU.get(), world);
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "kenjaku");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = KenjakuEntity.this.getX();
            double y = KenjakuEntity.this.getY();
            double z = KenjakuEntity.this.getZ();
            Entity entity = KenjakuEntity.this;
            Level world = KenjakuEntity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.KENJAKU.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(KenjakuEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(KenjakuEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(KenjakuEntity.class, EntityDataSerializers.STRING);
   }
}
