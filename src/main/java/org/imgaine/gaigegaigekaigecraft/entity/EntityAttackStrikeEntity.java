...
public class EntityAttackStrikeEntity extends PathfinderMob implements GeoEntity {
   ...
   public EntityAttackStrikeEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_ATTACK_STRIKE.get(), world);
   }

   public EntityAttackStrikeEntity(EntityType<EntityAttackStrikeEntity> type, Level world) {
      super(type, world);
   ...
   public void baseTick() {
      super.baseTick();
      AIEntitySlashProcedure.execute(this.level(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityAttackStrikeEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityAttackStrikeEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityAttackStrikeEntity.class, EntityDataSerializers.STRING);
   }
}
