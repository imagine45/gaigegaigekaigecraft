...
public class BlueEntity extends PathfinderMob {
   ...
   static {
      DATA_flag_purple = SynchedEntityData.defineId(BlueEntity.class, EntityDataSerializers.BOOLEAN);
      DATA_flag_start = SynchedEntityData.defineId(BlueEntity.class, EntityDataSerializers.BOOLEAN);
   }
}
