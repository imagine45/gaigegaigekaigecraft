...
public class EntityMalevolentShrine2Entity extends PathfinderMob implements GeoEntity {
   ...
   public EntityMalevolentShrine2Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_MALEVOLENT_SHRINE_2.get(), world);
   }

   public EntityMalevolentShrine2Entity(EntityType<EntityMalevolentShrine2Entity> type, Level world) {
      super(type, world);
   ...
   public void baseTick() {
      super.baseTick();
      AIMalevolentShrineProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityMalevolentShrine2Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityMalevolentShrine2Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityMalevolentShrine2Entity.class, EntityDataSerializers.STRING);
   }
}
