...
public class EntityMalevolentShrine2Entity extends PathfinderMob implements GeoEntity {
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "malevolent_shrine_incomplete");
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EntityMalevolentShrine2Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EntityMalevolentShrine2Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EntityMalevolentShrine2Entity.class, EntityDataSerializers.f_135030_);
   }
}
