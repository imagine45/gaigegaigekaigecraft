...
public class EntityAttackSlashEntity extends PathfinderMob implements GeoEntity {
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityAttackSlashEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityAttackSlashEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityAttackSlashEntity.class, EntityDataSerializers.STRING);
   }
}
