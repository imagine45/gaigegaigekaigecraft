...
public class EntityAttackSlashEntity extends PathfinderMob implements GeoEntity {
   ...
   public EntityAttackSlashEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_ATTACK_SLASH.get(), world);
   }

   public EntityAttackSlashEntity(EntityType<EntityAttackSlashEntity> type, Level world) {
      super(type, world);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EntityAttackSlashEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EntityAttackSlashEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EntityAttackSlashEntity.class, EntityDataSerializers.f_135030_);
   }
}
