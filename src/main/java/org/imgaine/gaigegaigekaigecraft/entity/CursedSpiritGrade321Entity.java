...
public class CursedSpiritGrade321Entity extends Monster {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, false) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade321Entity.this.getX();
            double y = CursedSpiritGrade321Entity.this.getY();
            double z = CursedSpiritGrade321Entity.this.getZ();
            Entity entity = CursedSpiritGrade321Entity.this;
            Level world = CursedSpiritGrade321Entity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_321.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
