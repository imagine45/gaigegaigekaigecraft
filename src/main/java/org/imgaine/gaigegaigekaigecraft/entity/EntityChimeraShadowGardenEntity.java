...
public class EntityChimeraShadowGardenEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "chimera_shadow_garden");
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityChimeraShadowGardenEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityChimeraShadowGardenEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityChimeraShadowGardenEntity.class, EntityDataSerializers.STRING);
   }
}
