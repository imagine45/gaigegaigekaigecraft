...
public class EntityChimeraShadowGardenEntity extends PathfinderMob implements GeoEntity {
   ...
   public EntityChimeraShadowGardenEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_CHIMERA_SHADOW_GARDEN.get(), world);
   }

   public EntityChimeraShadowGardenEntity(EntityType<EntityChimeraShadowGardenEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "chimera_shadow_garden");
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EntityChimeraShadowGardenEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EntityChimeraShadowGardenEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EntityChimeraShadowGardenEntity.class, EntityDataSerializers.f_135030_);
   }
}
