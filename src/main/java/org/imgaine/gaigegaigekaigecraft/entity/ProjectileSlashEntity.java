...
public class ProjectileSlashEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "slash_sukuna");
   ...
   public void baseTick() {
      super.baseTick();
      AIProjectileSlashProcedure.execute(this.level(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(ProjectileSlashEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(ProjectileSlashEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(ProjectileSlashEntity.class, EntityDataSerializers.STRING);
      DATA_mode = SynchedEntityData.defineId(ProjectileSlashEntity.class, EntityDataSerializers.INT);
   }
}
