...
public class UraumeEntity extends Monster implements GeoEntity {
   ...
   public UraumeEntity(EntityType<UraumeEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_URAUME_CHESTPLATE.get()));
      this.setItemSlot(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_URAUME_LEGGINGS.get()));
      this.setItemSlot(EquipmentSlot.FEET, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_URAUME_BOOTS.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "uraume");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = UraumeEntity.this.getX();
            double y = UraumeEntity.this.getY();
            double z = UraumeEntity.this.getZ();
            Entity entity = UraumeEntity.this;
            Level world = UraumeEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIUraumeProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.URAUME.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(UraumeEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(UraumeEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(UraumeEntity.class, EntityDataSerializers.STRING);
   }
}
