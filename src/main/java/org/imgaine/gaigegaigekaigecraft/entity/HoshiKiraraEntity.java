...
import org.imgaine.gaigegaigekaigecraft.procedures.AIHoshiKiraraProcedure;
...
public class HoshiKiraraEntity extends Monster implements GeoEntity {
   ...
   public HoshiKiraraEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.HOSHI_KIRARA.get(), world);
   }

   public HoshiKiraraEntity(EntityType<HoshiKiraraEntity> type, Level world) {
      super(type, world);
      ...
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_KIRARA_HELMET.get()));
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_KIRARA_CHESTPLATE.get()));
      this.setItemSlot(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_KIRARA_LEGGINGS.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "kirara");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = HoshiKiraraEntity.this.getX();
            double y = HoshiKiraraEntity.this.getY();
            double z = HoshiKiraraEntity.this.getZ();
            Entity entity = HoshiKiraraEntity.this;
            Level world = HoshiKiraraEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIHoshiKiraraProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.HOSHI_KIRARA.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(HoshiKiraraEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(HoshiKiraraEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(HoshiKiraraEntity.class, EntityDataSerializers.STRING);
   }
}
