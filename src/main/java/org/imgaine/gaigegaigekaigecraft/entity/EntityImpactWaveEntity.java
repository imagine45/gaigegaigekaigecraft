...
import org.imgaine.gaigegaigekaigecraft.procedures.AIImpactWaveProcedure;
...
public class EntityImpactWaveEntity extends PathfinderMob implements GeoEntity {
   ...
   public EntityImpactWaveEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_IMPACT_WAVE.get(), world);
   }

   public EntityImpactWaveEntity(EntityType<EntityImpactWaveEntity> type, Level world) {
      super(type, world);
   ...
   public void baseTick() {
      super.baseTick();
      AIImpactWaveProcedure.execute(this.level(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityImpactWaveEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityImpactWaveEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityImpactWaveEntity.class, EntityDataSerializers.STRING);
      DATA_mode = SynchedEntityData.defineId(EntityImpactWaveEntity.class, EntityDataSerializers.INT);
   }
}
