...
public class MechamaruEntity extends Monster implements GeoEntity {
   ...
   public MechamaruEntity(EntityType<MechamaruEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.SWORD_OPTION.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "muta_kokichi");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = MechamaruEntity.this.getX();
            double y = MechamaruEntity.this.getY();
            double z = MechamaruEntity.this.getZ();
            Entity entity = MechamaruEntity.this;
            Level world = MechamaruEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIMechamaruProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.MECHAMARU.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(MechamaruEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(MechamaruEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(MechamaruEntity.class, EntityDataSerializers.STRING);
   }
}
