...
public class HazenokiEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "hazenoki");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = HazenokiEntity.this.getX();
            double y = HazenokiEntity.this.getY();
            double z = HazenokiEntity.this.getZ();
            Entity entity = HazenokiEntity.this;
            Level world = HazenokiEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIHazenokiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.HAZENOKI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(HazenokiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(HazenokiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(HazenokiEntity.class, EntityDataSerializers.STRING);
   }
}
