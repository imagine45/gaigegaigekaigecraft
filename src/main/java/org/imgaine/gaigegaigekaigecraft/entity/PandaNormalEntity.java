...
public class PandaNormalEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "panda_normal");
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.3, true) {
         ...
         public boolean canUse() {
            double x = PandaNormalEntity.this.getX();
            double y = PandaNormalEntity.this.getY();
            double z = PandaNormalEntity.this.getZ();
            Entity entity = PandaNormalEntity.this;
            Level world = PandaNormalEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIPandaProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.PANDA_NORMAL.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(PandaNormalEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(PandaNormalEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(PandaNormalEntity.class, EntityDataSerializers.STRING);
      DATA_form = SynchedEntityData.defineId(PandaNormalEntity.class, EntityDataSerializers.INT);
   }
}
