...
import org.imgaine.gaigegaigekaigecraft.procedures.AIPandaProcedure;
...
public class PandaNormalEntity extends Monster implements GeoEntity {
   ...
   public PandaNormalEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.PANDA_NORMAL.get(), world);
   }

   public PandaNormalEntity(EntityType<PandaNormalEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "panda_normal");
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.3, true) {
         ...
         public boolean m_8036_() {
            double x = PandaNormalEntity.this.m_20185_();
            double y = PandaNormalEntity.this.m_20186_();
            double z = PandaNormalEntity.this.m_20189_();
            Entity entity = PandaNormalEntity.this;
            Level world = PandaNormalEntity.this.m_9236_();
   ...
   public void m_6075_() {
      super.m_6075_();
      AIPandaProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.PANDA_NORMAL.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(PandaNormalEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(PandaNormalEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(PandaNormalEntity.class, EntityDataSerializers.f_135030_);
      DATA_form = SynchedEntityData.m_135353_(PandaNormalEntity.class, EntityDataSerializers.f_135028_);
   }
}
