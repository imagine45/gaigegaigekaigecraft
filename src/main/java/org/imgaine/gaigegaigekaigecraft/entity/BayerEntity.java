...
import org.imgaine.gaigegaigekaigecraft.procedures.AIQProcedure;
...
public class BayerEntity extends Monster implements GeoEntity {
   ...
   public BayerEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.BAYER.get(), world);
   }

   public BayerEntity(EntityType<BayerEntity> type, Level world) {
      super(type, world);
      ...
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.UNIFORM_Q_HELMET.get()));
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.UNIFORM_Q_CHESTPLATE.get()));
      this.setItemSlot(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.UNIFORM_Q_LEGGINGS.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "bayer");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = BayerEntity.this.getX();
            double y = BayerEntity.this.getY();
            double z = BayerEntity.this.getZ();
            Entity entity = BayerEntity.this;
            Level world = BayerEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIQProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.BAYER.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(BayerEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(BayerEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(BayerEntity.class, EntityDataSerializers.STRING);
   }
}
