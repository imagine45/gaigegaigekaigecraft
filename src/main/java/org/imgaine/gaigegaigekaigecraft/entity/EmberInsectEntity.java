...
public class EmberInsectEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "ember_insects");
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      AIEmberInsectsProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EmberInsectEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EmberInsectEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EmberInsectEntity.class, EntityDataSerializers.f_135030_);
   }
}
