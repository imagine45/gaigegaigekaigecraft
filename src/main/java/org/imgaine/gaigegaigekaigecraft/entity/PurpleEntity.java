...
import org.imgaine.gaigegaigekaigecraft.procedures.AIPurpleProcedure;
...
public class PurpleEntity extends PathfinderMob {
   public PurpleEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.PURPLE.get(), world);
   }

   public PurpleEntity(EntityType<PurpleEntity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 0;
      this.m_21557_(false);
   ...
   public void m_6075_() {
      super.m_6075_();
      AIPurpleProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
