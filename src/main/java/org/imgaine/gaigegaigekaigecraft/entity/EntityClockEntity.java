...
public class EntityClockEntity extends PathfinderMob {
   public EntityClockEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_CLOCK.get(), world);
   }

   public EntityClockEntity(EntityType<EntityClockEntity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 0;
      this.m_21557_(true);
