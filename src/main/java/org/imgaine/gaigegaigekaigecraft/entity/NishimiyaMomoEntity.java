...
public class NishimiyaMomoEntity extends Monster implements GeoEntity {
   ...
   public NishimiyaMomoEntity(EntityType<NishimiyaMomoEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.BROOM.get()));
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_NISHIMIYA_HELMET.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "nishimiya_momo");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = NishimiyaMomoEntity.this.getX();
            double y = NishimiyaMomoEntity.this.getY();
            double z = NishimiyaMomoEntity.this.getZ();
            Entity entity = NishimiyaMomoEntity.this;
            Level world = NishimiyaMomoEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AINishimiyaProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.NISHIMIYA_MOMO.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(NishimiyaMomoEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(NishimiyaMomoEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(NishimiyaMomoEntity.class, EntityDataSerializers.STRING);
   }
}
