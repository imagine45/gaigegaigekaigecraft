...
public class NanakoEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "nanako");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = NanakoEntity.this.getX();
            double y = NanakoEntity.this.getY();
            double z = NanakoEntity.this.getZ();
            Entity entity = NanakoEntity.this;
            Level world = NanakoEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIMimiNanaProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.NANAKO.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(NanakoEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(NanakoEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(NanakoEntity.class, EntityDataSerializers.STRING);
   }
}
