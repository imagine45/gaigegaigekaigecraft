...
public class KusakabeAtsuyaEntity extends Monster implements GeoEntity {
   ...
   public KusakabeAtsuyaEntity(EntityType<KusakabeAtsuyaEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.SWORD_KUSAKABE.get()));
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_KUSAKABE_CHESTPLATE.get()));
      this.setItemSlot(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_KUSAKABE_LEGGINGS.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "kusakabe_atsuya");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = KusakabeAtsuyaEntity.this.getX();
            double y = KusakabeAtsuyaEntity.this.getY();
            double z = KusakabeAtsuyaEntity.this.getZ();
            Entity entity = KusakabeAtsuyaEntity.this;
            Level world = KusakabeAtsuyaEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIKusakabeAtsuyaProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.KUSAKABE_ATSUYA.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(KusakabeAtsuyaEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(KusakabeAtsuyaEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(KusakabeAtsuyaEntity.class, EntityDataSerializers.STRING);
   }
}
