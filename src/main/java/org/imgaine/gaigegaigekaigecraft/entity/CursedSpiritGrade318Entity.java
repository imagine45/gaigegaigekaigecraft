...
public class CursedSpiritGrade318Entity extends Monster {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, false) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade318Entity.this.getX();
            double y = CursedSpiritGrade318Entity.this.getY();
            double z = CursedSpiritGrade318Entity.this.getZ();
            Entity entity = CursedSpiritGrade318Entity.this;
            Level world = CursedSpiritGrade318Entity.this.level();
   ...
   public EntityDimensions getDimensions(Pose pose) {
      return super.getDimensions(pose).scale(0.4F);
   }

   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_318.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
