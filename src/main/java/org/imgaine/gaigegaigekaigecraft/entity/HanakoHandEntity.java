...
import org.imgaine.gaigegaigekaigecraft.procedures.AINeedleProcedure;
...
public class HanakoHandEntity extends PathfinderMob implements GeoEntity {
   ...
   public HanakoHandEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.HANAKO_HAND.get(), world);
   }

   public HanakoHandEntity(EntityType<HanakoHandEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "hanako_hand");
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      AINeedleProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(HanakoHandEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(HanakoHandEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(HanakoHandEntity.class, EntityDataSerializers.f_135030_);
   }
}
