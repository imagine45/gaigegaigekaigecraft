...
public class HanakoHandEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "hanako_hand");
   }
   ...
   public void baseTick() {
      super.baseTick();
      AINeedleProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(HanakoHandEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(HanakoHandEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(HanakoHandEntity.class, EntityDataSerializers.STRING);
   }
}
