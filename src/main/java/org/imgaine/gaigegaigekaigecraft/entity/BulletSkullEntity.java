...
import org.imgaine.gaigegaigekaigecraft.procedures.AIBulletSkullProcedure;
...
public class BulletSkullEntity extends PathfinderMob {
   public BulletSkullEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.BULLET_SKULL.get(), world);
   }

   public BulletSkullEntity(EntityType<BulletSkullEntity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 0;
      this.m_21557_(false);
   ...
   public void m_6075_() {
      super.m_6075_();
      AIBulletSkullProcedure.execute(this.m_9236_(), this);
      this.m_6210_();
   }
