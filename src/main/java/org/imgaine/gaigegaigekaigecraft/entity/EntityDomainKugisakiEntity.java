...
public class EntityDomainKugisakiEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "kugisaki_domain");
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityDomainKugisakiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityDomainKugisakiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityDomainKugisakiEntity.class, EntityDataSerializers.STRING);
   }
}
