...
public class EntityDomainKugisakiEntity extends PathfinderMob implements GeoEntity {
   ...
   public EntityDomainKugisakiEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_DOMAIN_KUGISAKI.get(), world);
   }

   public EntityDomainKugisakiEntity(EntityType<EntityDomainKugisakiEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "kugisaki_domain");
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EntityDomainKugisakiEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EntityDomainKugisakiEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EntityDomainKugisakiEntity.class, EntityDataSerializers.f_135030_);
   }
}
