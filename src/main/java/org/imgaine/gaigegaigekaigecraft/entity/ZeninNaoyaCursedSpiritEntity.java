...
public class ZeninNaoyaCursedSpiritEntity extends Monster implements GeoEntity {
   ...
   public ZeninNaoyaCursedSpiritEntity(EntityType<ZeninNaoyaCursedSpiritEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.NAOYA_CURSED_SPIRIT_BODY_CHESTPLATE.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "naoya_cursed_spirit1");
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = ZeninNaoyaCursedSpiritEntity.this.getX();
            double y = ZeninNaoyaCursedSpiritEntity.this.getY();
            double z = ZeninNaoyaCursedSpiritEntity.this.getZ();
            Entity entity = ZeninNaoyaCursedSpiritEntity.this;
            Level world = ZeninNaoyaCursedSpiritEntity.this.level();
   ...
   public void addAdditionalSaveData(CompoundTag compound) {
      ...
      compound.putInt("Dataform", (Integer)this.entityData.get(DATA_form));
   }
   ...
   public void readAdditionalSaveData(CompoundTag compound) {
      ...
      if (compound.contains("Dataform")) {
         this.entityData.set(DATA_form, compound.getInt("Dataform"));
      }
   ...
   public void baseTick() {
      super.baseTick();
      AIZeninNaoyaCursedSpirit1Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public EntityDimensions getDimensions(Pose p_33597_) {
      ...
      return EntityDimensions.scalable(customWidth, customHeight);
   }

   private float calculateCustomWidth(Entity entity) {
      int entityForm = (Integer)entity.getEntityData().get(DATA_form);
      switch (entityForm) {
         case 2 -> {
            return 1.2F;
         }
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.ZENIN_NAOYA_CURSED_SPIRIT.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(ZeninNaoyaCursedSpiritEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(ZeninNaoyaCursedSpiritEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(ZeninNaoyaCursedSpiritEntity.class, EntityDataSerializers.STRING);
      DATA_form = SynchedEntityData.defineId(ZeninNaoyaCursedSpiritEntity.class, EntityDataSerializers.INT);
   }
}
