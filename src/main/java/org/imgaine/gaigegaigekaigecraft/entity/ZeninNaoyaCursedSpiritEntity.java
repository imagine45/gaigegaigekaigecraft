...
import org.imgaine.gaigegaigekaigecraft.procedures.AIZeninNaoyaCursedSpirit1Procedure;
...
public class ZeninNaoyaCursedSpiritEntity extends Monster implements GeoEntity {
   ...
   public ZeninNaoyaCursedSpiritEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ZENIN_NAOYA_CURSED_SPIRIT.get(), world);
   }

   public ZeninNaoyaCursedSpiritEntity(EntityType<ZeninNaoyaCursedSpiritEntity> type, Level world) {
      super(type, world);
      ...
      this.m_21557_(false);
      this.m_274367_(0.6F);
      this.m_8061_(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.NAOYA_CURSED_SPIRIT_BODY_CHESTPLATE.get()));
   }
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "naoya_cursed_spirit1");
      this.f_19804_.m_135372_(DATA_form, 0);
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = ZeninNaoyaCursedSpiritEntity.this.m_20185_();
            double y = ZeninNaoyaCursedSpiritEntity.this.m_20186_();
            double z = ZeninNaoyaCursedSpiritEntity.this.m_20189_();
            Entity entity = ZeninNaoyaCursedSpiritEntity.this;
            Level world = ZeninNaoyaCursedSpiritEntity.this.m_9236_();
   ...
   public void m_7380_(CompoundTag compound) {
      ...
      compound.m_128405_("Dataform", (Integer)this.f_19804_.m_135370_(DATA_form));
   }
   ...
   public void m_7378_(CompoundTag compound) {
      ...
      if (compound.m_128441_("Dataform")) {
         this.f_19804_.m_135381_(DATA_form, compound.m_128451_("Dataform"));
      }
   ...
   public void m_6075_() {
      super.m_6075_();
      AIZeninNaoyaCursedSpirit1Procedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public EntityDimensions m_6972_(Pose p_33597_) {
      ...
      float customWidth = this.calculateCustomWidth(this);
      float customHeight = this.calculateCustomHeight(this);
      return EntityDimensions.m_20395_(customWidth, customHeight);
   }

   private float calculateCustomWidth(Entity entity) {
      int entityForm = (Integer)entity.m_20088_().m_135370_(DATA_form);
      switch (entityForm) {
         case 2 -> {
            return 1.2F;
         }
   ...
   private float calculateCustomHeight(Entity entity) {
      int entityForm = (Integer)entity.m_20088_().m_135370_(DATA_form);
      switch (entityForm) {
         case 2 -> {
            return 3.1F;
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.ZENIN_NAOYA_CURSED_SPIRIT.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(ZeninNaoyaCursedSpiritEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(ZeninNaoyaCursedSpiritEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(ZeninNaoyaCursedSpiritEntity.class, EntityDataSerializers.f_135030_);
      DATA_form = SynchedEntityData.m_135353_(ZeninNaoyaCursedSpiritEntity.class, EntityDataSerializers.f_135028_);
   }
}
