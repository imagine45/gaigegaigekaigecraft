...
public class JudgemanEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "judgeman");
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(JudgemanEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(JudgemanEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(JudgemanEntity.class, EntityDataSerializers.STRING);
   }
}
