...
public class JudgemanEntity extends PathfinderMob implements GeoEntity {
   ...
   public JudgemanEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.JUDGEMAN.get(), world);
   }

   public JudgemanEntity(EntityType<JudgemanEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "judgeman");
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(JudgemanEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(JudgemanEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(JudgemanEntity.class, EntityDataSerializers.f_135030_);
   }
}
