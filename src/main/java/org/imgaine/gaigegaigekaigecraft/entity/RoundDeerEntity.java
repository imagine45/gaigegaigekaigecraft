...
public class RoundDeerEntity extends Monster {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.0, true) {
         ...
         public boolean canUse() {
            double x = RoundDeerEntity.this.getX();
            double y = RoundDeerEntity.this.getY();
            double z = RoundDeerEntity.this.getZ();
            Entity entity = RoundDeerEntity.this;
            Level world = RoundDeerEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIRoundDeerProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }
