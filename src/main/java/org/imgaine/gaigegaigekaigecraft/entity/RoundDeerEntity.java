...
import org.imgaine.gaigegaigekaigecraft.procedures.AIRoundDeerProcedure;
...
public class RoundDeerEntity extends Monster {
   public RoundDeerEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ROUND_DEER.get(), world);
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.0, true) {
         ...
         public boolean m_8036_() {
            double x = RoundDeerEntity.this.m_20185_();
            double y = RoundDeerEntity.this.m_20186_();
            double z = RoundDeerEntity.this.m_20189_();
            Entity entity = RoundDeerEntity.this;
            Level world = RoundDeerEntity.this.m_9236_();
   ...
   public void m_6075_() {
      super.m_6075_();
      AIRoundDeerProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
   }
