...
public class EntitySkullEntity extends PathfinderMob {
   public EntitySkullEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_SKULL.get(), world);
   }

   public EntitySkullEntity(EntityType<EntitySkullEntity> type, Level world) {
      super(type, world);
