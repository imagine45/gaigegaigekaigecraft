...
public class CursedSpiritGrade01Entity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "cursedspirit0_1");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade01Entity.this.getX();
            double y = CursedSpiritGrade01Entity.this.getY();
            double z = CursedSpiritGrade01Entity.this.getZ();
            Entity entity = CursedSpiritGrade01Entity.this;
            Level world = CursedSpiritGrade01Entity.this.level();
   ...
   protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
      ...
      this.spawnAtLocation(new ItemStack((ItemLike)JujutsucraftModItems.SUKUNA_FINGER.get()));
   }
   ...
   public void baseTick() {
      super.baseTick();
      AICursedSpiritSpecialProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_01.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CursedSpiritGrade01Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CursedSpiritGrade01Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CursedSpiritGrade01Entity.class, EntityDataSerializers.STRING);
   }
}
