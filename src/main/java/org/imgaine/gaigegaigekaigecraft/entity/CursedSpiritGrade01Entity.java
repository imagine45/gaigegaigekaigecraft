...
import org.imgaine.gaigegaigekaigecraft.procedures.AICursedSpiritSpecialProcedure;
...
public class CursedSpiritGrade01Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade01Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_01.get(), world);
   }

   public CursedSpiritGrade01Entity(EntityType<CursedSpiritGrade01Entity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "cursedspirit0_1");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = CursedSpiritGrade01Entity.this.m_20185_();
            double y = CursedSpiritGrade01Entity.this.m_20186_();
            double z = CursedSpiritGrade01Entity.this.m_20189_();
            Entity entity = CursedSpiritGrade01Entity.this;
            Level world = CursedSpiritGrade01Entity.this.m_9236_();
   ...
   protected void m_7472_(DamageSource source, int looting, boolean recentlyHitIn) {
      ...
      this.m_19983_(new ItemStack((ItemLike)JujutsucraftModItems.SUKUNA_FINGER.get()));
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      AICursedSpiritSpecialProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_01.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(CursedSpiritGrade01Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(CursedSpiritGrade01Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(CursedSpiritGrade01Entity.class, EntityDataSerializers.f_135030_);
   }
}
