...
public class MiyoRokujushiEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "miyo_rokujushi");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = MiyoRokujushiEntity.this.getX();
            double y = MiyoRokujushiEntity.this.getY();
            double z = MiyoRokujushiEntity.this.getZ();
            Entity entity = MiyoRokujushiEntity.this;
            Level world = MiyoRokujushiEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIRokujushiMiyoProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.MIYO_ROKUJUSHI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(MiyoRokujushiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(MiyoRokujushiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(MiyoRokujushiEntity.class, EntityDataSerializers.STRING);
   }
}
