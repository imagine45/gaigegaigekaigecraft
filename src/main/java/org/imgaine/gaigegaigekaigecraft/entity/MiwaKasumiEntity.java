...
public class MiwaKasumiEntity extends Monster implements GeoEntity {
   ...
   public MiwaKasumiEntity(EntityType<MiwaKasumiEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.SWORD_MIWA_KASUMI.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "miwa_kasumi");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = MiwaKasumiEntity.this.getX();
            double y = MiwaKasumiEntity.this.getY();
            double z = MiwaKasumiEntity.this.getZ();
            Entity entity = MiwaKasumiEntity.this;
            Level world = MiwaKasumiEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIMiwaKasumiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.MIWA_KASUMI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(MiwaKasumiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(MiwaKasumiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(MiwaKasumiEntity.class, EntityDataSerializers.STRING);
   }
}
