...
public class Doll1Entity extends Monster implements GeoEntity {
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(DATA_move, 0);
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = Doll1Entity.this.m_20185_();
            double y = Doll1Entity.this.m_20186_();
            double z = Doll1Entity.this.m_20189_();
            Entity entity = Doll1Entity.this;
            Level world = Doll1Entity.this.m_9236_();
   ...
   public void m_7380_(CompoundTag compound) {
      ...
      compound.m_128405_("Datamove", (Integer)this.f_19804_.m_135370_(DATA_move));
   }
   ...
   public void m_7378_(CompoundTag compound) {
      ...
      if (compound.m_128441_("Datamove")) {
         this.f_19804_.m_135381_(DATA_move, compound.m_128451_("Datamove"));
      }
   ...
   public void m_6075_() {
      super.m_6075_();
      AIDollsProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(Doll1Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(Doll1Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(Doll1Entity.class, EntityDataSerializers.f_135030_);
      DATA_move = SynchedEntityData.m_135353_(Doll1Entity.class, EntityDataSerializers.f_135028_);
   }
}
