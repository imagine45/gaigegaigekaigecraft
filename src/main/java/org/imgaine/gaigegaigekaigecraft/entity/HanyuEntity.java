...
public class HanyuEntity extends Monster implements GeoEntity {
   ...
   public HanyuEntity(EntityType<HanyuEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.HEAD_JET_HELMET.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "hanyu");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = HanyuEntity.this.getX();
            double y = HanyuEntity.this.getY();
            double z = HanyuEntity.this.getZ();
            Entity entity = HanyuEntity.this;
            Level world = HanyuEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIHabaHanyuProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.HANYU.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(HanyuEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(HanyuEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(HanyuEntity.class, EntityDataSerializers.STRING);
   }
}
