...
public class ZeninOgiEntity extends Monster implements GeoEntity {
   ...
   public ZeninOgiEntity(EntityType<ZeninOgiEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.SWORD_OGI.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "zenin_ogi");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = ZeninOgiEntity.this.getX();
            double y = ZeninOgiEntity.this.getY();
            double z = ZeninOgiEntity.this.getZ();
            Entity entity = ZeninOgiEntity.this;
            Level world = ZeninOgiEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIZeninOgiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.ZENIN_OGI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(ZeninOgiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(ZeninOgiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(ZeninOgiEntity.class, EntityDataSerializers.STRING);
   }
}
