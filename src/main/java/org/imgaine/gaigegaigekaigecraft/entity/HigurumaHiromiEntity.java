...
public class HigurumaHiromiEntity extends Monster implements GeoEntity {
   ...
   public HigurumaHiromiEntity(EntityType<HigurumaHiromiEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.GAVEL.get()));
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.UNIFORM_HIGURUMA_CHESTPLATE.get()));
      this.setItemSlot(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.UNIFORM_HIGURUMA_LEGGINGS.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "higuruma_hiromi");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = HigurumaHiromiEntity.this.getX();
            double y = HigurumaHiromiEntity.this.getY();
            double z = HigurumaHiromiEntity.this.getZ();
            Entity entity = HigurumaHiromiEntity.this;
            Level world = HigurumaHiromiEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIHigurumaProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.HIGURUMA_HIROMI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(HigurumaHiromiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(HigurumaHiromiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(HigurumaHiromiEntity.class, EntityDataSerializers.STRING);
   }
}
