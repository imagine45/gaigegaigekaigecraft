...
public class GetoSuguruEntity extends Monster implements GeoEntity {
   ...
   public GetoSuguruEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.GETO_SUGURU.get(), world);
   }

   public GetoSuguruEntity(EntityType<GetoSuguruEntity> type, Level world) {
      super(type, world);
      ...
      this.setItemSlot(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.UNIFORM_GETO_LEGGINGS.get()));
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = GetoSuguruEntity.this.getX();
            double y = GetoSuguruEntity.this.getY();
            double z = GetoSuguruEntity.this.getZ();
            Entity entity = GetoSuguruEntity.this;
            Level world = GetoSuguruEntity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.GETO_SUGURU.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(GetoSuguruEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(GetoSuguruEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(GetoSuguruEntity.class, EntityDataSerializers.STRING);
   }
}
