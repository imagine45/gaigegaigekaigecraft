...
public class GetoSuguruEntity extends Monster implements GeoEntity {
   ...
   public GetoSuguruEntity(EntityType<GetoSuguruEntity> type, Level world) {
      ...
      this.m_8061_(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.UNIFORM_GETO_LEGGINGS.get()));
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = GetoSuguruEntity.this.m_20185_();
            double y = GetoSuguruEntity.this.m_20186_();
            double z = GetoSuguruEntity.this.m_20189_();
            Entity entity = GetoSuguruEntity.this;
            Level world = GetoSuguruEntity.this.m_9236_();
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.GETO_SUGURU.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(GetoSuguruEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(GetoSuguruEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(GetoSuguruEntity.class, EntityDataSerializers.f_135030_);
   }
}
