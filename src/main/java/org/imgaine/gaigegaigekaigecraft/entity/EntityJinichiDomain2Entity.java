...
public class EntityJinichiDomain2Entity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "jinichi_domain");
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityJinichiDomain2Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityJinichiDomain2Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityJinichiDomain2Entity.class, EntityDataSerializers.STRING);
   }
}
