...
public class EntityJinichiDomain2Entity extends PathfinderMob implements GeoEntity {
   ...
   public EntityJinichiDomain2Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_JINICHI_DOMAIN_2.get(), world);
   }

   public EntityJinichiDomain2Entity(EntityType<EntityJinichiDomain2Entity> type, Level world) {
      super(type, world);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EntityJinichiDomain2Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EntityJinichiDomain2Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EntityJinichiDomain2Entity.class, EntityDataSerializers.f_135030_);
   }
}
