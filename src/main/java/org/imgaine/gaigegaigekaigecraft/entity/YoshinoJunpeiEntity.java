...
public class YoshinoJunpeiEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "yoshino_junpei");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = YoshinoJunpeiEntity.this.getX();
            double y = YoshinoJunpeiEntity.this.getY();
            double z = YoshinoJunpeiEntity.this.getZ();
            Entity entity = YoshinoJunpeiEntity.this;
            Level world = YoshinoJunpeiEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIYoshinoJunpeiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.YOSHINO_JUNPEI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(YoshinoJunpeiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(YoshinoJunpeiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(YoshinoJunpeiEntity.class, EntityDataSerializers.STRING);
   }
}
