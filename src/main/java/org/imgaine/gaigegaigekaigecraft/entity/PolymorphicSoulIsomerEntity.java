...
public class PolymorphicSoulIsomerEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "polymorphic_soul_isomer");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = PolymorphicSoulIsomerEntity.this.getX();
            double y = PolymorphicSoulIsomerEntity.this.getY();
            double z = PolymorphicSoulIsomerEntity.this.getZ();
            Entity entity = PolymorphicSoulIsomerEntity.this;
            Level world = PolymorphicSoulIsomerEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIPolymorphicSoulIsomerProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(PolymorphicSoulIsomerEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(PolymorphicSoulIsomerEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(PolymorphicSoulIsomerEntity.class, EntityDataSerializers.STRING);
   }
}
