...
public class MahoragaFrogEntity extends PathfinderMob {
   public MahoragaFrogEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.MAHORAGA_FROG.get(), world);
   }

   public MahoragaFrogEntity(EntityType<MahoragaFrogEntity> type, Level world) {
      super(type, world);
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
      ...
      MahoragaDogOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
      return retval;
   }

   public void baseTick() {
      super.baseTick();
      AIMahoragaDogFrogProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }
