...
public class NeedleEntity extends PathfinderMob implements GeoEntity {
   ...
   public NeedleEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.NEEDLE.get(), world);
   }

   public NeedleEntity(EntityType<NeedleEntity> type, Level world) {
      super(type, world);
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "tex_black");
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(NeedleEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(NeedleEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(NeedleEntity.class, EntityDataSerializers.STRING);
   }
}
