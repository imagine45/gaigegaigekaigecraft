...
public class NeedleEntity extends PathfinderMob implements GeoEntity {
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(NeedleEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(NeedleEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(NeedleEntity.class, EntityDataSerializers.f_135030_);
   }
}
