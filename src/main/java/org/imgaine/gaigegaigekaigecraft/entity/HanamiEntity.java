...
import org.imgaine.gaigegaigekaigecraft.procedures.AIHanamiProcedure;
...
public class HanamiEntity extends Monster implements GeoEntity {
   ...
   public HanamiEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.HANAMI.get(), world);
   }
   ...
   public HanamiEntity(EntityType<HanamiEntity> type, Level world) {
      ...
      this.m_21557_(false);
      this.m_274367_(0.6F);
      this.m_8061_(EquipmentSlot.OFFHAND, new ItemStack((ItemLike)JujutsucraftModItems.HANAMI_HAND.get()));
      this.m_8061_(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.HANAMI_EYE_HELMET.get()));
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "hanami_skin");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = HanamiEntity.this.m_20185_();
            double y = HanamiEntity.this.m_20186_();
            double z = HanamiEntity.this.m_20189_();
            Entity entity = HanamiEntity.this;
            Level world = HanamiEntity.this.m_9236_();
   ...
   public void m_6075_() {
      super.m_6075_();
      AIHanamiProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }

   public EntityDimensions m_6972_(Pose p_33597_) {
      return super.m_6972_(p_33597_).m_20388_(1.25F);
   }

   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.HANAMI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(HanamiEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(HanamiEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(HanamiEntity.class, EntityDataSerializers.f_135030_);
   }
}
