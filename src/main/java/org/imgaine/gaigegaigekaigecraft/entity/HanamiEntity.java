...
public class HanamiEntity extends Monster implements GeoEntity {
   ...
   public HanamiEntity(EntityType<HanamiEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack((ItemLike)JujutsucraftModItems.HANAMI_HAND.get()));
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.HANAMI_EYE_HELMET.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "hanami_skin");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = HanamiEntity.this.getX();
            double y = HanamiEntity.this.getY();
            double z = HanamiEntity.this.getZ();
            Entity entity = HanamiEntity.this;
            Level world = HanamiEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIHanamiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.HANAMI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(HanamiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(HanamiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(HanamiEntity.class, EntityDataSerializers.STRING);
   }
}
