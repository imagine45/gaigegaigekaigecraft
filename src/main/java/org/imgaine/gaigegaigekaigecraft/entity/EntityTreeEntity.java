...
public class EntityTreeEntity extends PathfinderMob implements GeoEntity {
   ...
   public EntityTreeEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_TREE.get(), world);
   }

   public EntityTreeEntity(EntityType<EntityTreeEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "pine_tree");
   }
   ...
   private PlayState movementPredicate(AnimationState event) {
      return this.animationprocedure.equals("empty") ? event.setAndContinue(RawAnimation.begin().thenLoop("free")) : PlayState.STOP;
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EntityTreeEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EntityTreeEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EntityTreeEntity.class, EntityDataSerializers.f_135030_);
   }
}
