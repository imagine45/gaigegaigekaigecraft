...
public class EntityTreeEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "pine_tree");
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityTreeEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityTreeEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityTreeEntity.class, EntityDataSerializers.STRING);
   }
}
