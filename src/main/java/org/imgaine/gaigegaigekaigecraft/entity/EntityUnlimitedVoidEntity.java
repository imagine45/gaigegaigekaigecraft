...
public class EntityUnlimitedVoidEntity extends PathfinderMob implements GeoEntity {
   ...
   public EntityUnlimitedVoidEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_UNLIMITED_VOID.get(), world);
   }

   public EntityUnlimitedVoidEntity(EntityType<EntityUnlimitedVoidEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "entity_unlimited_void");
   }
   ...
   public EntityDimensions m_6972_(Pose p_33597_) {
      return super.m_6972_(p_33597_).m_20388_(5.0F);
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EntityUnlimitedVoidEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EntityUnlimitedVoidEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EntityUnlimitedVoidEntity.class, EntityDataSerializers.f_135030_);
   }
}
