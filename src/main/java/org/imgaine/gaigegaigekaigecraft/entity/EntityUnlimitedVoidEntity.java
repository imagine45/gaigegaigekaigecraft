...
public class EntityUnlimitedVoidEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "entity_unlimited_void");
   }
   ...
   public EntityDimensions getDimensions(Pose p_33597_) {
      return super.getDimensions(p_33597_).scale(5.0F);
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityUnlimitedVoidEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityUnlimitedVoidEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityUnlimitedVoidEntity.class, EntityDataSerializers.STRING);
   }
}
