...
public class InoTakumaEntity extends Monster implements GeoEntity {
   ...
   public InoTakumaEntity(EntityType<InoTakumaEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_INO_TAKUMA_1_HELMET.get()));
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_INO_TAKUMA_1_CHESTPLATE.get()));
      this.setItemSlot(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_INO_TAKUMA_1_LEGGINGS.get()));
      this.setItemSlot(EquipmentSlot.FEET, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_INO_TAKUMA_1_BOOTS.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "ino_takuma");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = InoTakumaEntity.this.getX();
            double y = InoTakumaEntity.this.getY();
            double z = InoTakumaEntity.this.getZ();
            Entity entity = InoTakumaEntity.this;
            Level world = InoTakumaEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIInoTakumaProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.INO_TAKUMA.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(InoTakumaEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(InoTakumaEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(InoTakumaEntity.class, EntityDataSerializers.STRING);
   }
}
