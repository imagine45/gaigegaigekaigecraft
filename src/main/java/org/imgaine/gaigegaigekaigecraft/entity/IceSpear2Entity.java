...
public class IceSpear2Entity extends PathfinderMob implements GeoEntity {
   ...
   static {
      SHOOT = SynchedEntityData.defineId(IceSpear2Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(IceSpear2Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(IceSpear2Entity.class, EntityDataSerializers.STRING);
   }
}
