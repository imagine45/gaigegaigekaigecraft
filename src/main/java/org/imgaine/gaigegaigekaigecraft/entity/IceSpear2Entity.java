...
public class IceSpear2Entity extends PathfinderMob implements GeoEntity {
   ...
   public IceSpear2Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ICE_SPEAR_2.get(), world);
   }

   public IceSpear2Entity(EntityType<IceSpear2Entity> type, Level world) {
      super(type, world);
   ...
   public void m_6075_() {
      super.m_6075_();
      AIWoodenSpearProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(IceSpear2Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(IceSpear2Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(IceSpear2Entity.class, EntityDataSerializers.f_135030_);
   }
}
