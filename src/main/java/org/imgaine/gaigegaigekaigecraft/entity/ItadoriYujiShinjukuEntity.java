...
public class ItadoriYujiShinjukuEntity extends Monster implements GeoEntity {
   ...
   public ItadoriYujiShinjukuEntity(EntityType<ItadoriYujiShinjukuEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.ITADORI_ARM.get()));
      this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack((ItemLike)JujutsucraftModItems.ITADORI_ARM.get()));
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = ItadoriYujiShinjukuEntity.this.getX();
            double y = ItadoriYujiShinjukuEntity.this.getY();
            double z = ItadoriYujiShinjukuEntity.this.getZ();
            Entity entity = ItadoriYujiShinjukuEntity.this;
            Level world = ItadoriYujiShinjukuEntity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.ITADORI_YUJI_SHINJUKU.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(ItadoriYujiShinjukuEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(ItadoriYujiShinjukuEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(ItadoriYujiShinjukuEntity.class, EntityDataSerializers.STRING);
   }
}
