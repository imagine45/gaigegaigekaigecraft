...
public class ShikigamiHeterocephalusGlaberEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "shikigami_dhruvrakdawala1");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = ShikigamiHeterocephalusGlaberEntity.this.getX();
            double y = ShikigamiHeterocephalusGlaberEntity.this.getY();
            double z = ShikigamiHeterocephalusGlaberEntity.this.getZ();
            Entity entity = ShikigamiHeterocephalusGlaberEntity.this;
            Level world = ShikigamiHeterocephalusGlaberEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIShikigamiDhruvLakdawallaProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(ShikigamiHeterocephalusGlaberEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(ShikigamiHeterocephalusGlaberEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(ShikigamiHeterocephalusGlaberEntity.class, EntityDataSerializers.STRING);
   }
}
