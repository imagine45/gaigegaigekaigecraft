...
import org.imgaine.gaigegaigekaigecraft.procedures.AIShikigamiDhruvLakdawallaProcedure;
...
public class ShikigamiHeterocephalusGlaberEntity extends Monster implements GeoEntity {
   ...
   public ShikigamiHeterocephalusGlaberEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.SHIKIGAMI_HETEROCEPHALUS_GLABER.get(), world);
   }

   public ShikigamiHeterocephalusGlaberEntity(EntityType<ShikigamiHeterocephalusGlaberEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "shikigami_dhruvrakdawala1");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = ShikigamiHeterocephalusGlaberEntity.this.m_20185_();
            double y = ShikigamiHeterocephalusGlaberEntity.this.m_20186_();
            double z = ShikigamiHeterocephalusGlaberEntity.this.m_20189_();
            Entity entity = ShikigamiHeterocephalusGlaberEntity.this;
            Level world = ShikigamiHeterocephalusGlaberEntity.this.m_9236_();
   ...
   public void m_6075_() {
      super.m_6075_();
      AIShikigamiDhruvLakdawallaProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(ShikigamiHeterocephalusGlaberEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(ShikigamiHeterocephalusGlaberEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(ShikigamiHeterocephalusGlaberEntity.class, EntityDataSerializers.f_135030_);
   }
}
