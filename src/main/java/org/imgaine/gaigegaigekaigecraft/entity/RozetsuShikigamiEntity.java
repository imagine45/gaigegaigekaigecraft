...
public class RozetsuShikigamiEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "rozetsu_shikigami");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = RozetsuShikigamiEntity.this.getX();
            double y = RozetsuShikigamiEntity.this.getY();
            double z = RozetsuShikigamiEntity.this.getZ();
            Entity entity = RozetsuShikigamiEntity.this;
            Level world = RozetsuShikigamiEntity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.ROZETSU_SHIKIGAMI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(RozetsuShikigamiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(RozetsuShikigamiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(RozetsuShikigamiEntity.class, EntityDataSerializers.STRING);
   }
}
