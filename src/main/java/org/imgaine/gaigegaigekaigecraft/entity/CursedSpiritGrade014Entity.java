...
import org.imgaine.gaigegaigekaigecraft.procedures.AICursedSpirit014Procedure;
...
public class CursedSpiritGrade014Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade014Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_014.get(), world);
   }

   public CursedSpiritGrade014Entity(EntityType<CursedSpiritGrade014Entity> type, Level world) {
      super(type, world);
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "cursedspirit0_14");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade014Entity.this.getX();
            double y = CursedSpiritGrade014Entity.this.getY();
            double z = CursedSpiritGrade014Entity.this.getZ();
            Entity entity = CursedSpiritGrade014Entity.this;
            Level world = CursedSpiritGrade014Entity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AICursedSpirit014Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_014.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CursedSpiritGrade014Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CursedSpiritGrade014Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CursedSpiritGrade014Entity.class, EntityDataSerializers.STRING);
   }
}
