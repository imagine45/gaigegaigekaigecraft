...
import org.imgaine.gaigegaigekaigecraft.procedures.AIMoonDregsProcedure;
...
public class MoonDregsEntity extends Monster implements GeoEntity {
   ...
   public MoonDregsEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.MOON_DREGS.get(), world);
   }

   public MoonDregsEntity(EntityType<MoonDregsEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "moon_dregs");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = MoonDregsEntity.this.m_20185_();
            double y = MoonDregsEntity.this.m_20186_();
            double z = MoonDregsEntity.this.m_20189_();
            Entity entity = MoonDregsEntity.this;
            Level world = MoonDregsEntity.this.m_9236_();
   ...
   public void m_6075_() {
      super.m_6075_();
      AIMoonDregsProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(MoonDregsEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(MoonDregsEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(MoonDregsEntity.class, EntityDataSerializers.f_135030_);
   }
}
