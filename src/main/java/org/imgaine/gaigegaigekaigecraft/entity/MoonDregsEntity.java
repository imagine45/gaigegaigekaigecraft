...
public class MoonDregsEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "moon_dregs");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = MoonDregsEntity.this.getX();
            double y = MoonDregsEntity.this.getY();
            double z = MoonDregsEntity.this.getZ();
            Entity entity = MoonDregsEntity.this;
            Level world = MoonDregsEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIMoonDregsProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(MoonDregsEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(MoonDregsEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(MoonDregsEntity.class, EntityDataSerializers.STRING);
   }
}
