...
import org.imgaine.gaigegaigekaigecraft.procedures.AITeketekeProcedure;
...
public class CursedSpiritGrade14Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade14Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_14.get(), world);
   }

   public CursedSpiritGrade14Entity(EntityType<CursedSpiritGrade14Entity> type, Level world) {
      super(type, world);
      ...
      this.m_21557_(false);
      this.m_274367_(0.6F);
      this.m_8061_(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.MAHITO_HAND_2.get()));
      this.m_8061_(EquipmentSlot.OFFHAND, new ItemStack((ItemLike)JujutsucraftModItems.MAHITO_HAND_2.get()));
   }
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "teketeke");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 2.0, true) {
         ...
         public boolean m_8036_() {
            double x = CursedSpiritGrade14Entity.this.m_20185_();
            double y = CursedSpiritGrade14Entity.this.m_20186_();
            double z = CursedSpiritGrade14Entity.this.m_20189_();
            Entity entity = CursedSpiritGrade14Entity.this;
            Level world = CursedSpiritGrade14Entity.this.m_9236_();
   ...
   public void m_7355_(BlockPos pos, BlockState blockIn) {
      this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.skeleton.step")), 0.15F, 1.0F);
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      AITeketekeProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_14.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(CursedSpiritGrade14Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(CursedSpiritGrade14Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(CursedSpiritGrade14Entity.class, EntityDataSerializers.f_135030_);
   }
}
