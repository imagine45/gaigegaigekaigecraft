...
public class CursedSpiritGrade14Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade14Entity(EntityType<CursedSpiritGrade14Entity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.MAHITO_HAND_2.get()));
      this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack((ItemLike)JujutsucraftModItems.MAHITO_HAND_2.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "teketeke");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 2.0, true) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade14Entity.this.getX();
            double y = CursedSpiritGrade14Entity.this.getY();
            double z = CursedSpiritGrade14Entity.this.getZ();
            Entity entity = CursedSpiritGrade14Entity.this;
            Level world = CursedSpiritGrade14Entity.this.level();
   ...
   public void playStepSound(BlockPos pos, BlockState blockIn) {
      this.playSound((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.skeleton.step")), 0.15F, 1.0F);
   }
   ...
   public void baseTick() {
      super.baseTick();
      AITeketekeProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_14.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CursedSpiritGrade14Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CursedSpiritGrade14Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CursedSpiritGrade14Entity.class, EntityDataSerializers.STRING);
   }
}
