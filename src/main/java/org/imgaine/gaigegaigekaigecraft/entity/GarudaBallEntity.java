...
public class GarudaBallEntity extends PathfinderMob {
   public GarudaBallEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.GARUDA_BALL.get(), world);
   }

   public GarudaBallEntity(EntityType<GarudaBallEntity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 0;
      this.m_21557_(false);
