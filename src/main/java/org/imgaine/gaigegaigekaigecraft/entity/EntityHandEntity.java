...
import org.imgaine.gaigegaigekaigecraft.procedures.AIChojuroHandProcedure;
...
public class EntityHandEntity extends PathfinderMob implements GeoEntity {
   ...
   public EntityHandEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_HAND.get(), world);
   }

   public EntityHandEntity(EntityType<EntityHandEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "hand");
      this.f_19804_.m_135372_(DATA_Magma, false);
   }
   ...
   public void m_7380_(CompoundTag compound) {
      ...
      compound.m_128379_("DataMagma", (Boolean)this.f_19804_.m_135370_(DATA_Magma));
   }
   ...
   public void m_7378_(CompoundTag compound) {
      ...
      if (compound.m_128441_("DataMagma")) {
         this.f_19804_.m_135381_(DATA_Magma, compound.m_128471_("DataMagma"));
      }
   ...
   public void m_6075_() {
      super.m_6075_();
      AIChojuroHandProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EntityHandEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EntityHandEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EntityHandEntity.class, EntityDataSerializers.f_135030_);
      DATA_Magma = SynchedEntityData.m_135353_(EntityHandEntity.class, EntityDataSerializers.f_135035_);
   }
}
