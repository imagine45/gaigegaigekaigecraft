...
public class ZeninMakiEntity extends Monster implements GeoEntity {
   ...
   public ZeninMakiEntity(EntityType<ZeninMakiEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.NAGINATA.get()));
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.GLASSES_MAKI_HELMET.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "zenin_maki");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = ZeninMakiEntity.this.getX();
            double y = ZeninMakiEntity.this.getY();
            double z = ZeninMakiEntity.this.getZ();
            Entity entity = ZeninMakiEntity.this;
            Level world = ZeninMakiEntity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.ZENIN_MAKI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(ZeninMakiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(ZeninMakiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(ZeninMakiEntity.class, EntityDataSerializers.STRING);
   }
}
