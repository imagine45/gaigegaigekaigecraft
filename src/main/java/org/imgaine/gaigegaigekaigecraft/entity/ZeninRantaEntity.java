...
import org.imgaine.gaigegaigekaigecraft.procedures.AIZeninRantaProcedure;
...
public class ZeninRantaEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT;
   public static final EntityDataAccessor<String> ANIMATION;
   public static final EntityDataAccessor<String> TEXTURE;
   public static final EntityDataAccessor<Boolean> DATA_damaged;
   ...
   public ZeninRantaEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ZENIN_RANTA.get(), world);
   }

   public ZeninRantaEntity(EntityType<ZeninRantaEntity> type, Level world) {
      super(type, world);
      ...
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_ZENIN_2_CHESTPLATE.get()));
      this.setItemSlot(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_ZENIN_2_LEGGINGS.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "zenin_ranta");
      this.entityData.define(DATA_damaged, false);
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = ZeninRantaEntity.this.getX();
            double y = ZeninRantaEntity.this.getY();
            double z = ZeninRantaEntity.this.getZ();
            Entity entity = ZeninRantaEntity.this;
            Level world = ZeninRantaEntity.this.level();
   ...
   public void addAdditionalSaveData(CompoundTag compound) {
      ...
      compound.putBoolean("Datadamaged", (Boolean)this.entityData.get(DATA_damaged));
   }
   ...
   public void readAdditionalSaveData(CompoundTag compound) {
      ...
      if (compound.contains("Datadamaged")) {
         this.entityData.set(DATA_damaged, compound.getBoolean("Datadamaged"));
      }
   ...
   public void baseTick() {
      super.baseTick();
      AIZeninRantaProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.ZENIN_RANTA.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(ZeninRantaEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(ZeninRantaEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(ZeninRantaEntity.class, EntityDataSerializers.STRING);
      DATA_damaged = SynchedEntityData.defineId(ZeninRantaEntity.class, EntityDataSerializers.BOOLEAN);
   }
}
