...
public class ZeninNaobitoEntity extends Monster implements GeoEntity {
   ...
   public ZeninNaobitoEntity(EntityType<ZeninNaobitoEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_ZENIN_NAOBITO_CHESTPLATE.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "zenin_naobito");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = ZeninNaobitoEntity.this.getX();
            double y = ZeninNaobitoEntity.this.getY();
            double z = ZeninNaobitoEntity.this.getZ();
            Entity entity = ZeninNaobitoEntity.this;
            Level world = ZeninNaobitoEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIZeninNaoyaProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.ZENIN_NAOBITO.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(ZeninNaobitoEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(ZeninNaobitoEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(ZeninNaobitoEntity.class, EntityDataSerializers.STRING);
   }
}
