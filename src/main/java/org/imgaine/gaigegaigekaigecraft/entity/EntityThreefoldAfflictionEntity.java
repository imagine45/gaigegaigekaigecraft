...
public class EntityThreefoldAfflictionEntity extends PathfinderMob implements GeoEntity {
   ...
   public EntityThreefoldAfflictionEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_THREEFOLD_AFFLICTION.get(), world);
   }

   public EntityThreefoldAfflictionEntity(EntityType<EntityThreefoldAfflictionEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "threefoldaffliction");
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EntityThreefoldAfflictionEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EntityThreefoldAfflictionEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EntityThreefoldAfflictionEntity.class, EntityDataSerializers.f_135030_);
   }
}
