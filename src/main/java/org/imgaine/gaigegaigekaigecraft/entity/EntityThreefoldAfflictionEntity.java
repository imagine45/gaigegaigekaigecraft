...
public class EntityThreefoldAfflictionEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "threefoldaffliction");
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityThreefoldAfflictionEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityThreefoldAfflictionEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityThreefoldAfflictionEntity.class, EntityDataSerializers.STRING);
   }
}
