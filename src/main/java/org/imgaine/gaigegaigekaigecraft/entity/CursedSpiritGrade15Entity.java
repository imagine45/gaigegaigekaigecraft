...
import org.imgaine.gaigegaigekaigecraft.procedures.AICursedSpirit15Procedure;
...
public class CursedSpiritGrade15Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade15Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_15.get(), world);
   }

   public CursedSpiritGrade15Entity(EntityType<CursedSpiritGrade15Entity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "cursedspirit1_5");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.0, true) {
         ...
         public boolean m_8036_() {
            double x = CursedSpiritGrade15Entity.this.m_20185_();
            double y = CursedSpiritGrade15Entity.this.m_20186_();
            double z = CursedSpiritGrade15Entity.this.m_20189_();
            Entity entity = CursedSpiritGrade15Entity.this;
            Level world = CursedSpiritGrade15Entity.this.m_9236_();
   ...
   public void m_6075_() {
      super.m_6075_();
      AICursedSpirit15Procedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_15.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   private PlayState movementPredicate(AnimationState event) {
      if (!this.animationprocedure.equals("empty")) {
         ...
         return this.m_5912_() && event.isMoving() ? event.setAndContinue(RawAnimation.begin().thenLoop("walk")) : event.setAndContinue(RawAnimation.begin().thenLoop("idle"));
      }
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(CursedSpiritGrade15Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(CursedSpiritGrade15Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(CursedSpiritGrade15Entity.class, EntityDataSerializers.f_135030_);
   }
}
