...
import org.imgaine.gaigegaigekaigecraft.procedures.AIEightHandledSwrodDivergentSilaDivineGeneralMahoragaProcedure;
...
public class EightHandledSwrodDivergentSilaDivineGeneralMahoragaEntity extends Monster implements GeoEntity {
   ...
   public EightHandledSwrodDivergentSilaDivineGeneralMahoragaEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.EIGHT_HANDLED_SWROD_DIVERGENT_SILA_DIVINE_GENERAL_MAHORAGA.get(), world);
   }

   public EightHandledSwrodDivergentSilaDivineGeneralMahoragaEntity(EntityType<EightHandledSwrodDivergentSilaDivineGeneralMahoragaEntity> type, Level world) {
      super(type, world);
      ...
      this.m_274367_(1.6F);
      this.m_21530_();
      this.m_8061_(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.SWORD_OF_EXTERMINATION.get()));
      this.m_8061_(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.MAHORAGA_BODY_HELMET.get()));
      this.m_8061_(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.MAHORAGA_BODY_CHESTPLATE.get()));
      this.m_8061_(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.MAHORAGA_BODY_LEGGINGS.get()));
   }
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "mahoraga");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.4, true) {
         ...
         public boolean m_8036_() {
            double x = EightHandledSwrodDivergentSilaDivineGeneralMahoragaEntity.this.m_20185_();
            double y = EightHandledSwrodDivergentSilaDivineGeneralMahoragaEntity.this.m_20186_();
            double z = EightHandledSwrodDivergentSilaDivineGeneralMahoragaEntity.this.m_20189_();
            Entity entity = EightHandledSwrodDivergentSilaDivineGeneralMahoragaEntity.this;
            Level world = EightHandledSwrodDivergentSilaDivineGeneralMahoragaEntity.this.m_9236_();
   ...
   public void m_6075_() {
      super.m_6075_();
      AIEightHandledSwrodDivergentSilaDivineGeneralMahoragaProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22276_, 480.0);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EightHandledSwrodDivergentSilaDivineGeneralMahoragaEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EightHandledSwrodDivergentSilaDivineGeneralMahoragaEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EightHandledSwrodDivergentSilaDivineGeneralMahoragaEntity.class, EntityDataSerializers.f_135030_);
   }
}
