...
public class EntityScissorsEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "scissors");
   }
   ...
   public void baseTick() {
      super.baseTick();
      AIScissorProcedure.execute(this.level(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityScissorsEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityScissorsEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityScissorsEntity.class, EntityDataSerializers.STRING);
   }
}
