...
public class CursedSpiritGrade12Entity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "cursedspirit1_2");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.0, true) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade12Entity.this.getX();
            double y = CursedSpiritGrade12Entity.this.getY();
            double z = CursedSpiritGrade12Entity.this.getZ();
            Entity entity = CursedSpiritGrade12Entity.this;
            Level world = CursedSpiritGrade12Entity.this.level();
      ...
      this.goalSelector.addGoal(5, new RandomStrollGoal(this, 0.1));
   ...
   public void baseTick() {
      super.baseTick();
      AICursedSpirit12Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_12.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CursedSpiritGrade12Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CursedSpiritGrade12Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CursedSpiritGrade12Entity.class, EntityDataSerializers.STRING);
   }
}
