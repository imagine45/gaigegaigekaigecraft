...
import org.imgaine.gaigegaigekaigecraft.procedures.AICursedSpirit12Procedure;
...
public class CursedSpiritGrade12Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade12Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_12.get(), world);
   }

   public CursedSpiritGrade12Entity(EntityType<CursedSpiritGrade12Entity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "cursedspirit1_2");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 0.1, true) {
         ...
         public boolean m_8036_() {
            double x = CursedSpiritGrade12Entity.this.m_20185_();
            double y = CursedSpiritGrade12Entity.this.m_20186_();
            double z = CursedSpiritGrade12Entity.this.m_20189_();
            Entity entity = CursedSpiritGrade12Entity.this;
            Level world = CursedSpiritGrade12Entity.this.m_9236_();
   ...
   public void m_6075_() {
      super.m_6075_();
      AICursedSpirit12Procedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_12.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(CursedSpiritGrade12Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(CursedSpiritGrade12Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(CursedSpiritGrade12Entity.class, EntityDataSerializers.f_135030_);
   }
}
