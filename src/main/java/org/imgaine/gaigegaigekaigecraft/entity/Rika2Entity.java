...
public class Rika2Entity extends Monster implements GeoEntity {
   ...
   public Rika2Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.RIKA_2.get(), world);
   }

   public Rika2Entity(EntityType<Rika2Entity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "rika2");
   }
   ...
   protected void m_8099_() {
      super.m_8099_();
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.5, false) {
         protected double m_6639_(LivingEntity entity) {
            return 0.0;
         }

         public boolean m_8036_() {
            double x = Rika2Entity.this.m_20185_();
            double y = Rika2Entity.this.m_20186_();
            double z = Rika2Entity.this.m_20189_();
            Entity entity = Rika2Entity.this;
            Level world = Rika2Entity.this.m_9236_();
      ...
      this.f_21345_.m_25352_(6, new RandomStrollGoal(this, 1.5) {
         public boolean m_8036_() {
            double x = Rika2Entity.this.m_20185_();
            double y = Rika2Entity.this.m_20186_();
            double z = Rika2Entity.this.m_20189_();
   ...
   public void m_6075_() {
      super.m_6075_();
      AIRikaProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(Rika2Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(Rika2Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(Rika2Entity.class, EntityDataSerializers.f_135030_);
   }
}
