...
public class Rika2Entity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "rika2");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.5, false) {
         ...
         public boolean canUse() {
            double x = Rika2Entity.this.getX();
            double y = Rika2Entity.this.getY();
            double z = Rika2Entity.this.getZ();
            Entity entity = Rika2Entity.this;
            Level world = Rika2Entity.this.level();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(Rika2Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(Rika2Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(Rika2Entity.class, EntityDataSerializers.STRING);
   }
}
