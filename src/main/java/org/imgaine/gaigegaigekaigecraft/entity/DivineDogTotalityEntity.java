...
public class DivineDogTotalityEntity extends Monster implements GeoEntity {
   ...
   public DivineDogTotalityEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.DIVINE_DOG_TOTALITY.get(), world);
   }

   public DivineDogTotalityEntity(EntityType<DivineDogTotalityEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "divinedogtotality");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.4, true) {
         ...
         public boolean m_8036_() {
            double x = DivineDogTotalityEntity.this.m_20185_();
            double y = DivineDogTotalityEntity.this.m_20186_();
            double z = DivineDogTotalityEntity.this.m_20189_();
            Entity entity = DivineDogTotalityEntity.this;
            Level world = DivineDogTotalityEntity.this.m_9236_();
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(DivineDogTotalityEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(DivineDogTotalityEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(DivineDogTotalityEntity.class, EntityDataSerializers.f_135030_);
   }
}
