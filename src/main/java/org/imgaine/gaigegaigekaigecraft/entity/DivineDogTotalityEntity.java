...
public class DivineDogTotalityEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "divinedogtotality");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.4, true) {
         ...
         public boolean canUse() {
            double x = DivineDogTotalityEntity.this.getX();
            double y = DivineDogTotalityEntity.this.getY();
            double z = DivineDogTotalityEntity.this.getZ();
            Entity entity = DivineDogTotalityEntity.this;
            Level world = DivineDogTotalityEntity.this.level();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(DivineDogTotalityEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(DivineDogTotalityEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(DivineDogTotalityEntity.class, EntityDataSerializers.STRING);
   }
}
