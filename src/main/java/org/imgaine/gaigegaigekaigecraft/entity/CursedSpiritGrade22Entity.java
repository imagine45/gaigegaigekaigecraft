...
public class CursedSpiritGrade22Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade22Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_22.get(), world);
   }

   public CursedSpiritGrade22Entity(EntityType<CursedSpiritGrade22Entity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "kouguy");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, false) {
         ...
         public boolean m_8036_() {
            double x = CursedSpiritGrade22Entity.this.m_20185_();
            double y = CursedSpiritGrade22Entity.this.m_20186_();
            double z = CursedSpiritGrade22Entity.this.m_20189_();
            Entity entity = CursedSpiritGrade22Entity.this;
            Level world = CursedSpiritGrade22Entity.this.m_9236_();
   ...
   public EntityDimensions m_6972_(Pose p_33597_) {
      return super.m_6972_(p_33597_).m_20388_(1.3F);
   }

   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_22.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(CursedSpiritGrade22Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(CursedSpiritGrade22Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(CursedSpiritGrade22Entity.class, EntityDataSerializers.f_135030_);
   }
}
