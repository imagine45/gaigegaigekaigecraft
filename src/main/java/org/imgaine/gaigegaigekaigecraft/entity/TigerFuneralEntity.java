...
import org.imgaine.gaigegaigekaigecraft.procedures.AITigerFuneralProcedure;
...
public class TigerFuneralEntity extends Monster implements GeoEntity {
   ...
   public TigerFuneralEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.TIGER_FUNERAL.get(), world);
   }

   public TigerFuneralEntity(EntityType<TigerFuneralEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "tigerfuneral");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.4, true) {
         ...
         public boolean m_8036_() {
            double x = TigerFuneralEntity.this.m_20185_();
            double y = TigerFuneralEntity.this.m_20186_();
            double z = TigerFuneralEntity.this.m_20189_();
            Entity entity = TigerFuneralEntity.this;
            Level world = TigerFuneralEntity.this.m_9236_();
   ...
   public void m_6075_() {
      super.m_6075_();
      AITigerFuneralProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(TigerFuneralEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(TigerFuneralEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(TigerFuneralEntity.class, EntityDataSerializers.f_135030_);
   }
}
