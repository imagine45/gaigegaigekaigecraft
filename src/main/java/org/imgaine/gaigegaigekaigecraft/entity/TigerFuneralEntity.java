...
public class TigerFuneralEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "tigerfuneral");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.4, true) {
         ...
         public boolean canUse() {
            double x = TigerFuneralEntity.this.getX();
            double y = TigerFuneralEntity.this.getY();
            double z = TigerFuneralEntity.this.getZ();
            Entity entity = TigerFuneralEntity.this;
            Level world = TigerFuneralEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AITigerFuneralProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(TigerFuneralEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(TigerFuneralEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(TigerFuneralEntity.class, EntityDataSerializers.STRING);
   }
}
