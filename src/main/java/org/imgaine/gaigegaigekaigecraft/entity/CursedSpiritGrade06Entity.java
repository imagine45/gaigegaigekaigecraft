...
import org.imgaine.gaigegaigekaigecraft.procedures.AIAkurooOtakeProcedure;
...
public class CursedSpiritGrade06Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade06Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_06.get(), world);
   }

   public CursedSpiritGrade06Entity(EntityType<CursedSpiritGrade06Entity> type, Level world) {
      super(type, world);
      ...
      this.m_21557_(false);
      this.m_274367_(0.6F);
      this.m_8061_(EquipmentSlot.MAINHAND, new ItemStack(Items.f_42396_));
   }
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "cursedspirit0_6");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.0, true) {
         ...
         public boolean m_8036_() {
            double x = CursedSpiritGrade06Entity.this.m_20185_();
            double y = CursedSpiritGrade06Entity.this.m_20186_();
            double z = CursedSpiritGrade06Entity.this.m_20189_();
            Entity entity = CursedSpiritGrade06Entity.this;
            Level world = CursedSpiritGrade06Entity.this.m_9236_();
   ...
   public boolean m_6469_(DamageSource source, float amount) {
      if (source.m_276093_(DamageTypes.f_268631_)) {
         ...
         return source.m_276093_(DamageTypes.f_268714_) ? false : super.m_6469_(source, amount);
      }
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      AIAkurooOtakeProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_06.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22278_, 2.5);
      builder = builder.m_22268_(Attributes.f_22282_, 1.8);
      return builder;
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(CursedSpiritGrade06Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(CursedSpiritGrade06Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(CursedSpiritGrade06Entity.class, EntityDataSerializers.f_135030_);
   }
}
