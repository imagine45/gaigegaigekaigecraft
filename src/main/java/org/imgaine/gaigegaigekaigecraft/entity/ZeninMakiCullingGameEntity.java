...
public class ZeninMakiCullingGameEntity extends Monster implements GeoEntity {
   ...
   public ZeninMakiCullingGameEntity(EntityType<ZeninMakiCullingGameEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.SPLIT_SOUL_KATANA.get()));
      this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack((ItemLike)JujutsucraftModItems.DRAGON_BONE.get()));
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.GLASSES_MAKI_CHESTPLATE.get()));
      this.setItemSlot(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.GLASSES_MAKI_LEGGINGS.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "zenin_maki_awaked");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = ZeninMakiCullingGameEntity.this.getX();
            double y = ZeninMakiCullingGameEntity.this.getY();
            double z = ZeninMakiCullingGameEntity.this.getZ();
            Entity entity = ZeninMakiCullingGameEntity.this;
            Level world = ZeninMakiCullingGameEntity.this.level();
            return super.canUse() && LogicAttackTargetProcedure.execute(entity);
         }
      });
      this.targetSelector.addGoal(2, new HurtByTargetGoal(this, new Class[0]));
      this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, KukuruEntity.class, false, false));
      this.targetSelector.addGoal(4, new NearestAttackableTargetGoal(this, ZeninOgiEntity.class, false, false));
      this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, ZeninNobuakiEntity.class, false, false));
      this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, ZeninChojuroEntity.class, false, false));
      this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, ZeninJinichiEntity.class, false, false));
      this.targetSelector.addGoal(8, new NearestAttackableTargetGoal(this, ZeninRantaEntity.class, false, false));
      this.targetSelector.addGoal(9, new NearestAttackableTargetGoal(this, ZeninNaoyaEntity.class, false, false));
   ...
   public void baseTick() {
      super.baseTick();
      AIZeninMakiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.ZENIN_MAKI_CULLING_GAME.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(ZeninMakiCullingGameEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(ZeninMakiCullingGameEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(ZeninMakiCullingGameEntity.class, EntityDataSerializers.STRING);
   }
}
