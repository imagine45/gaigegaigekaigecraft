...
public class DagonEntity extends Monster implements GeoEntity {
   ...
   public DagonEntity(EntityType<DagonEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_DAGON_HELMET.get()));
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_DAGON_CHESTPLATE.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "dagon1");
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.0, true) {
         ...
         public boolean canUse() {
            double x = DagonEntity.this.getX();
            double y = DagonEntity.this.getY();
            double z = DagonEntity.this.getZ();
            Entity entity = DagonEntity.this;
            Level world = DagonEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIDagonProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.DAGON.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(DagonEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(DagonEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(DagonEntity.class, EntityDataSerializers.STRING);
      DATA_form = SynchedEntityData.defineId(DagonEntity.class, EntityDataSerializers.INT);
   }
}
