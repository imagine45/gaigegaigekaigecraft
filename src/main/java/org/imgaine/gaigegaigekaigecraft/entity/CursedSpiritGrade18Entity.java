...
public class CursedSpiritGrade18Entity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "cursedspirit1_8");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.0, true) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade18Entity.this.getX();
            double y = CursedSpiritGrade18Entity.this.getY();
            double z = CursedSpiritGrade18Entity.this.getZ();
            Entity entity = CursedSpiritGrade18Entity.this;
            Level world = CursedSpiritGrade18Entity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AICursedSpirit18Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_18.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   private PlayState movementPredicate(AnimationState event) {
      if (!this.animationprocedure.equals("empty")) {
         ...
         return this.isSprinting() ? event.setAndContinue(RawAnimation.begin().thenLoop("sprint")) : event.setAndContinue(RawAnimation.begin().thenLoop("idle"));
      }
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CursedSpiritGrade18Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CursedSpiritGrade18Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CursedSpiritGrade18Entity.class, EntityDataSerializers.STRING);
   }
}
