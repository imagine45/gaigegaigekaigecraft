...
import org.imgaine.gaigegaigekaigecraft.procedures.AIZeninNobuakiProcedure;
...
public class ZeninNobuakiEntity extends Monster implements GeoEntity {
   ...
   public ZeninNobuakiEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ZENIN_NOBUAKI.get(), world);
   }

   public ZeninNobuakiEntity(EntityType<ZeninNobuakiEntity> type, Level world) {
      super(type, world);
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "zenin_nobuaki");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = ZeninNobuakiEntity.this.getX();
            double y = ZeninNobuakiEntity.this.getY();
            double z = ZeninNobuakiEntity.this.getZ();
            Entity entity = ZeninNobuakiEntity.this;
            Level world = ZeninNobuakiEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIZeninNobuakiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.ZENIN_NOBUAKI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(ZeninNobuakiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(ZeninNobuakiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(ZeninNobuakiEntity.class, EntityDataSerializers.STRING);
   }
}
