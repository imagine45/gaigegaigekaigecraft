...
public class CursedSpiritGrade04Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade04Entity(EntityType<CursedSpiritGrade04Entity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.FESTER_LIFE_BLADE.get()));
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.KUROURUSHI_BODY_HELMET.get()));
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.KUROURUSHI_BODY_CHESTPLATE.get()));
      this.setItemSlot(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.KUROURUSHI_BODY_LEGGINGS.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "kurourushi_animated");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.0, true) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade04Entity.this.getX();
            double y = CursedSpiritGrade04Entity.this.getY();
            double z = CursedSpiritGrade04Entity.this.getZ();
            Entity entity = CursedSpiritGrade04Entity.this;
            Level world = CursedSpiritGrade04Entity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIKurourushiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_04.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CursedSpiritGrade04Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CursedSpiritGrade04Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CursedSpiritGrade04Entity.class, EntityDataSerializers.STRING);
   }
}
