...
import org.imgaine.gaigegaigekaigecraft.procedures.AIKurourushiProcedure;
...
public class CursedSpiritGrade04Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade04Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_04.get(), world);
   }

   public CursedSpiritGrade04Entity(EntityType<CursedSpiritGrade04Entity> type, Level world) {
      super(type, world);
      ...
      this.m_21557_(false);
      this.m_274367_(0.6F);
      this.m_8061_(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.FESTER_LIFE_BLADE.get()));
      this.m_8061_(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.KUROURUSHI_BODY_HELMET.get()));
      this.m_8061_(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.KUROURUSHI_BODY_CHESTPLATE.get()));
      this.m_8061_(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.KUROURUSHI_BODY_LEGGINGS.get()));
   }
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "kurourushi_animated");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.0, true) {
         ...
         public boolean m_8036_() {
            double x = CursedSpiritGrade04Entity.this.m_20185_();
            double y = CursedSpiritGrade04Entity.this.m_20186_();
            double z = CursedSpiritGrade04Entity.this.m_20189_();
            Entity entity = CursedSpiritGrade04Entity.this;
            Level world = CursedSpiritGrade04Entity.this.m_9236_();
   ...
   public void m_6075_() {
      super.m_6075_();
      AIKurourushiProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_04.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   private PlayState attackingPredicate(AnimationState event) {
      ...
      if (this.swinging && event.getController().getAnimationState() == State.STOPPED) {
         ...
         return event.setAndContinue(RawAnimation.begin().thenPlay("sword_to_left"));
      } else {
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(CursedSpiritGrade04Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(CursedSpiritGrade04Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(CursedSpiritGrade04Entity.class, EntityDataSerializers.f_135030_);
   }
}
