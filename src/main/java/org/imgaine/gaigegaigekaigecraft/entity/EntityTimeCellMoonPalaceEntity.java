...
public class EntityTimeCellMoonPalaceEntity extends PathfinderMob {
   public EntityTimeCellMoonPalaceEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_TIME_CELL_MOON_PALACE.get(), world);
   }

   public EntityTimeCellMoonPalaceEntity(EntityType<EntityTimeCellMoonPalaceEntity> type, Level world) {
      super(type, world);
