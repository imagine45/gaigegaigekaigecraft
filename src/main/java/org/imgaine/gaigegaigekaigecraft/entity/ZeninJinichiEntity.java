...
public class ZeninJinichiEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "zenin_jinichi");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = ZeninJinichiEntity.this.getX();
            double y = ZeninJinichiEntity.this.getY();
            double z = ZeninJinichiEntity.this.getZ();
            Entity entity = ZeninJinichiEntity.this;
            Level world = ZeninJinichiEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIZeninJinichiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.ZENIN_JINICHI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(ZeninJinichiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(ZeninJinichiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(ZeninJinichiEntity.class, EntityDataSerializers.STRING);
   }
}
