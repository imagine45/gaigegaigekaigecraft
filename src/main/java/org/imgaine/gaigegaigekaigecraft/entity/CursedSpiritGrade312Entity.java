...
public class CursedSpiritGrade312Entity extends Monster {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.0, false) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade312Entity.this.getX();
            double y = CursedSpiritGrade312Entity.this.getY();
            double z = CursedSpiritGrade312Entity.this.getZ();
            Entity entity = CursedSpiritGrade312Entity.this;
            Level world = CursedSpiritGrade312Entity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_312.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.add(Attributes.MAX_HEALTH, 78.0);
