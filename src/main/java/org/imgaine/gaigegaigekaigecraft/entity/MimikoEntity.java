...
public class MimikoEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "mimiko");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = MimikoEntity.this.getX();
            double y = MimikoEntity.this.getY();
            double z = MimikoEntity.this.getZ();
            Entity entity = MimikoEntity.this;
            Level world = MimikoEntity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.MIMIKO.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(MimikoEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(MimikoEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(MimikoEntity.class, EntityDataSerializers.STRING);
   }
}
