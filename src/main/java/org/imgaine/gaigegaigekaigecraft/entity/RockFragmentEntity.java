...
public class RockFragmentEntity extends PathfinderMob {
   ...
   public SoundEvent m_5592_() {
      return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("jujutsucraft:stone_crash"));
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      AIRockFragmentProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   static {
      DATA_Magma = SynchedEntityData.m_135353_(RockFragmentEntity.class, EntityDataSerializers.f_135035_);
   }
}
