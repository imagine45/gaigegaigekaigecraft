...
public class HakariKinjiEntity extends Monster implements GeoEntity {
   ...
   public HakariKinjiEntity(EntityType<HakariKinjiEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_HAKARI_KINJI_HELMET.get()));
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_HAKARI_KINJI_CHESTPLATE.get()));
      this.setItemSlot(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_HAKARI_KINJI_LEGGINGS.get()));
      this.setItemSlot(EquipmentSlot.FEET, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_HAKARI_KINJI_BOOTS.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "hakari_kinji");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = HakariKinjiEntity.this.getX();
            double y = HakariKinjiEntity.this.getY();
            double z = HakariKinjiEntity.this.getZ();
            Entity entity = HakariKinjiEntity.this;
            Level world = HakariKinjiEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIHakariProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.HAKARI_KINJI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(HakariKinjiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(HakariKinjiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(HakariKinjiEntity.class, EntityDataSerializers.STRING);
   }
}
