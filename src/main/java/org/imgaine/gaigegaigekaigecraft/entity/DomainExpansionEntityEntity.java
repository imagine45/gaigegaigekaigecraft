...
import org.imgaine.gaigegaigekaigecraft.procedures.AIDomainExpansionEntityProcedure;
import org.imgaine.gaigegaigekaigecraft.procedures.DomainExpansionEntityOnInitialEntitySpawnProcedure;
...
public class DomainExpansionEntityEntity extends PathfinderMob {
   public DomainExpansionEntityEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.DOMAIN_EXPANSION_ENTITY.get(), world);
   }

   public DomainExpansionEntityEntity(EntityType<DomainExpansionEntityEntity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 0;
      this.m_21557_(true);
   ...
   public SpawnGroupData m_6518_(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
      ...
      DomainExpansionEntityOnInitialEntitySpawnProcedure.execute(this);
      return retval;
   }

   public void m_6075_() {
      super.m_6075_();
      AIDomainExpansionEntityProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
   }
