...
public class EntitySlashEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "slash_blue");
   }
   ...
   public void baseTick() {
      super.baseTick();
      AISlashProcedure.execute(this.level(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntitySlashEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntitySlashEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntitySlashEntity.class, EntityDataSerializers.STRING);
   }
}
