...
import org.imgaine.gaigegaigekaigecraft.procedures.AISlashProcedure;
...
public class EntitySlashEntity extends PathfinderMob implements GeoEntity {
   ...
   public EntitySlashEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_SLASH.get(), world);
   }

   public EntitySlashEntity(EntityType<EntitySlashEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "slash_blue");
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      AISlashProcedure.execute(this.m_9236_(), this);
      this.m_6210_();
   }
   ...
   private PlayState movementPredicate(AnimationState event) {
      return this.animationprocedure.equals("empty") ? event.setAndContinue(RawAnimation.begin().thenLoop("vertical")) : PlayState.STOP;
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EntitySlashEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EntitySlashEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EntitySlashEntity.class, EntityDataSerializers.f_135030_);
   }
}
