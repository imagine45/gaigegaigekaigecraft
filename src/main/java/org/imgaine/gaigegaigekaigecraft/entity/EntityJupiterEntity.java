...
public class EntityJupiterEntity extends PathfinderMob {
   public EntityJupiterEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_JUPITER.get(), world);
   }

   public EntityJupiterEntity(EntityType<EntityJupiterEntity> type, Level world) {
      super(type, world);
   ...
   public EntityDimensions getDimensions(Pose pose) {
      return super.getDimensions(pose).scale(24.0F);
   }
