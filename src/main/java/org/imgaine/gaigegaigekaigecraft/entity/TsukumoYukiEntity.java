...
public class TsukumoYukiEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "tsukumo_yuki");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = TsukumoYukiEntity.this.getX();
            double y = TsukumoYukiEntity.this.getY();
            double z = TsukumoYukiEntity.this.getZ();
            Entity entity = TsukumoYukiEntity.this;
            Level world = TsukumoYukiEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AITsukumoYukiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.TSUKUMO_YUKI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(TsukumoYukiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(TsukumoYukiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(TsukumoYukiEntity.class, EntityDataSerializers.STRING);
   }
}
