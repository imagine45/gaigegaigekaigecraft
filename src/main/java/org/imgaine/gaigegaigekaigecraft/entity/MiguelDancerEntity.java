...
public class MiguelDancerEntity extends Monster implements GeoEntity {
   ...
   public MiguelDancerEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.MIGUEL_DANCER.get(), world);
   }

   public MiguelDancerEntity(EntityType<MiguelDancerEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = MiguelDancerEntity.this.m_20185_();
            double y = MiguelDancerEntity.this.m_20186_();
            double z = MiguelDancerEntity.this.m_20189_();
            Entity entity = MiguelDancerEntity.this;
            Level world = MiguelDancerEntity.this.m_9236_();
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.MIGUEL_DANCER.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(MiguelDancerEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(MiguelDancerEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(MiguelDancerEntity.class, EntityDataSerializers.f_135030_);
   }
}
