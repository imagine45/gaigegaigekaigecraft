...
public class MiguelDancerEntity extends Monster implements GeoEntity {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = MiguelDancerEntity.this.getX();
            double y = MiguelDancerEntity.this.getY();
            double z = MiguelDancerEntity.this.getZ();
            Entity entity = MiguelDancerEntity.this;
            Level world = MiguelDancerEntity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.MIGUEL_DANCER.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(MiguelDancerEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(MiguelDancerEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(MiguelDancerEntity.class, EntityDataSerializers.STRING);
   }
}
