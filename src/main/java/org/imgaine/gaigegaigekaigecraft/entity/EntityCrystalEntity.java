...
public class EntityCrystalEntity extends PathfinderMob implements GeoEntity {
   ...
   public EntityCrystalEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_CRYSTAL.get(), world);
   }

   public EntityCrystalEntity(EntityType<EntityCrystalEntity> type, Level world) {
      super(type, world);
   ...
   public SoundEvent getDeathSound() {
      return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.amethyst_block.break"));
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityCrystalEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityCrystalEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityCrystalEntity.class, EntityDataSerializers.STRING);
      DATA_mode = SynchedEntityData.defineId(EntityCrystalEntity.class, EntityDataSerializers.INT);
   }
}
