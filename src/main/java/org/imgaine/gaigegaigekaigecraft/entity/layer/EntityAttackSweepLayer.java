...
public class EntityAttackSweepLayer extends GeoRenderLayer<EntityAttackSweepEntity> {
   private static final ResourceLocation LAYER = new ResourceLocation("jujutsucraft", "textures/entities/clear.png");

   public EntityAttackSweepLayer(GeoRenderer<EntityAttackSweepEntity> entityRenderer) {
      super(entityRenderer);
   }

   public void render(PoseStack poseStack, EntityAttackSweepEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
