...
public class EntityAttackStrikeLayer extends GeoRenderLayer<EntityAttackStrikeEntity> {
   private static final ResourceLocation LAYER = new ResourceLocation("gaigegaigekaigecraft", "textures/entities/clear.png");

   public EntityAttackStrikeLayer(GeoRenderer<EntityAttackStrikeEntity> entityRenderer) {
      super(entityRenderer);
   }

   public void render(PoseStack poseStack, EntityAttackStrikeEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
