...
import org.imgaine.gaigegaigekaigecraft.procedures.AICursedSpirit112Procedure;
...
public class CursedSpiritGrade112Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade112Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_112.get(), world);
   }

   public CursedSpiritGrade112Entity(EntityType<CursedSpiritGrade112Entity> type, Level world) {
      super(type, world);
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "cursedspirit1_12");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.0, true) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade112Entity.this.getX();
            double y = CursedSpiritGrade112Entity.this.getY();
            double z = CursedSpiritGrade112Entity.this.getZ();
            Entity entity = CursedSpiritGrade112Entity.this;
            Level world = CursedSpiritGrade112Entity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AICursedSpirit112Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_112.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.add(Attributes.MAX_HEALTH, 175.0);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CursedSpiritGrade112Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CursedSpiritGrade112Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CursedSpiritGrade112Entity.class, EntityDataSerializers.STRING);
   }
}
