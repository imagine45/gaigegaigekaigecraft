...
public class MaxElephantEntity extends Monster {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.0, true) {
         ...
         public boolean canUse() {
            double x = MaxElephantEntity.this.getX();
            double y = MaxElephantEntity.this.getY();
            double z = MaxElephantEntity.this.getZ();
            Entity entity = MaxElephantEntity.this;
            Level world = MaxElephantEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIMaxElephantProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }
