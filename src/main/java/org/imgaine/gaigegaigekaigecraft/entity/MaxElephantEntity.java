...
import org.imgaine.gaigegaigekaigecraft.procedures.AIMaxElephantProcedure;
...
public class MaxElephantEntity extends Monster {
   public MaxElephantEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.MAX_ELEPHANT.get(), world);
   }

   public MaxElephantEntity(EntityType<MaxElephantEntity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 0;
      this.m_21557_(false);
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.0, true) {
         ...
         public boolean m_8036_() {
            double x = MaxElephantEntity.this.m_20185_();
            double y = MaxElephantEntity.this.m_20186_();
            double z = MaxElephantEntity.this.m_20189_();
            Entity entity = MaxElephantEntity.this;
            Level world = MaxElephantEntity.this.m_9236_();
   ...
   public void m_6075_() {
      super.m_6075_();
      AIMaxElephantProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
   }
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22279_, 0.16);
