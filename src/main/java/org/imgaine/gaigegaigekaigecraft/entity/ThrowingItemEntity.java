...
import org.imgaine.gaigegaigekaigecraft.procedures.ThrowingItemOnEntityTickUpdateProcedure;
...
public class ThrowingItemEntity extends PathfinderMob implements GeoEntity {
   ...
   public ThrowingItemEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.THROWING_ITEM.get(), world);
   }

   public ThrowingItemEntity(EntityType<ThrowingItemEntity> type, Level world) {
      super(type, world);
   ...
   public void baseTick() {
      super.baseTick();
      ThrowingItemOnEntityTickUpdateProcedure.execute(this.level(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(ThrowingItemEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(ThrowingItemEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(ThrowingItemEntity.class, EntityDataSerializers.STRING);
   }
}
