...
public class CursedSpiritGrade03Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade03Entity(EntityType<CursedSpiritGrade03Entity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.CLAWS.get()));
      this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack((ItemLike)JujutsucraftModItems.CLAWS.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "tamamonomae");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.0, true) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade03Entity.this.getX();
            double y = CursedSpiritGrade03Entity.this.getY();
            double z = CursedSpiritGrade03Entity.this.getZ();
            Entity entity = CursedSpiritGrade03Entity.this;
            Level world = CursedSpiritGrade03Entity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AITamamonoMaeProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_03.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CursedSpiritGrade03Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CursedSpiritGrade03Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CursedSpiritGrade03Entity.class, EntityDataSerializers.STRING);
   }
}
