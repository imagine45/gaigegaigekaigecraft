...
public class BulletPistolEntity extends AbstractArrow implements ItemSupplier {
   ...
   public static BulletPistolEntity shoot(LivingEntity entity, LivingEntity target) {
      BulletPistolEntity entityarrow = new BulletPistolEntity((EntityType)JujutsucraftModEntities.BULLET_PISTOL.get(), entity, entity.level());
   ...
   static {
      PROJECTILE_ITEM = new ItemStack((ItemLike)JujutsucraftModItems.ITEM_BULLET.get());
   }
}
