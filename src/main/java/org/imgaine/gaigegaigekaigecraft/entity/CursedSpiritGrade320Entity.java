...
public class CursedSpiritGrade320Entity extends Monster {
   public CursedSpiritGrade320Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_320.get(), world);
   }

   public CursedSpiritGrade320Entity(EntityType<CursedSpiritGrade320Entity> type, Level world) {
      super(type, world);
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, false) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade320Entity.this.getX();
            double y = CursedSpiritGrade320Entity.this.getY();
            double z = CursedSpiritGrade320Entity.this.getZ();
            Entity entity = CursedSpiritGrade320Entity.this;
            Level world = CursedSpiritGrade320Entity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_320.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
