...
public class MergedBeastAgitoEntity extends Monster implements GeoEntity {
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "mergedbeastagito");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.4, true) {
         ...
         public boolean m_8036_() {
            double x = MergedBeastAgitoEntity.this.m_20185_();
            double y = MergedBeastAgitoEntity.this.m_20186_();
            double z = MergedBeastAgitoEntity.this.m_20189_();
            Entity entity = MergedBeastAgitoEntity.this;
            Level world = MergedBeastAgitoEntity.this.m_9236_();
   ...
   public void m_6075_() {
      super.m_6075_();
      AIMergedBeastAgitoProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(MergedBeastAgitoEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(MergedBeastAgitoEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(MergedBeastAgitoEntity.class, EntityDataSerializers.f_135030_);
   }
}
