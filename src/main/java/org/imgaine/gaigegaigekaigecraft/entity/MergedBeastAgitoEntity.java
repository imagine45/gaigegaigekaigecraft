...
import org.imgaine.gaigegaigekaigecraft.procedures.AIMergedBeastAgitoProcedure;
...
public class MergedBeastAgitoEntity extends Monster implements GeoEntity {
   ...
   public MergedBeastAgitoEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.MERGED_BEAST_AGITO.get(), world);
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "mergedbeastagito");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.4, true) {
         ...
         public boolean canUse() {
            double x = MergedBeastAgitoEntity.this.getX();
            double y = MergedBeastAgitoEntity.this.getY();
            double z = MergedBeastAgitoEntity.this.getZ();
            Entity entity = MergedBeastAgitoEntity.this;
            Level world = MergedBeastAgitoEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIMergedBeastAgitoProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.add(Attributes.MAX_HEALTH, 280.0);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(MergedBeastAgitoEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(MergedBeastAgitoEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(MergedBeastAgitoEntity.class, EntityDataSerializers.STRING);
   }
}
