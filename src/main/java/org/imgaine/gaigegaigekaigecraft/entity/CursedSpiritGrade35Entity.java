...
public class CursedSpiritGrade35Entity extends Monster {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, false) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade35Entity.this.getX();
            double y = CursedSpiritGrade35Entity.this.getY();
            double z = CursedSpiritGrade35Entity.this.getZ();
            Entity entity = CursedSpiritGrade35Entity.this;
            Level world = CursedSpiritGrade35Entity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_35.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
