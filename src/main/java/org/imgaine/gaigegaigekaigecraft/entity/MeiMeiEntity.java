...
public class MeiMeiEntity extends Monster implements GeoEntity {
   ...
   public MeiMeiEntity(EntityType<MeiMeiEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.MEI_MEI_AXE.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "meimei");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = MeiMeiEntity.this.getX();
            double y = MeiMeiEntity.this.getY();
            double z = MeiMeiEntity.this.getZ();
            Entity entity = MeiMeiEntity.this;
            Level world = MeiMeiEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIMeiMeiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.MEI_MEI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(MeiMeiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(MeiMeiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(MeiMeiEntity.class, EntityDataSerializers.STRING);
   }
}
