...
public class CursedSpiritGrade24Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade24Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_24.get(), world);
   }

   public CursedSpiritGrade24Entity(EntityType<CursedSpiritGrade24Entity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "cursedspirit2_4");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = CursedSpiritGrade24Entity.this.m_20185_();
            double y = CursedSpiritGrade24Entity.this.m_20186_();
            double z = CursedSpiritGrade24Entity.this.m_20189_();
            Entity entity = CursedSpiritGrade24Entity.this;
            Level world = CursedSpiritGrade24Entity.this.m_9236_();
   ...
   public void m_7355_(BlockPos pos, BlockState blockIn) {
      this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.slime.jump_small")), 0.15F, 1.0F);
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      AIKouGUYProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_24.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   private PlayState attackingPredicate(AnimationState event) {
      ...
      if (this.swinging && event.getController().getAnimationState() == State.STOPPED) {
         ...
         return event.setAndContinue(RawAnimation.begin().thenPlay("punch_right_rush"));
      } else {
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(CursedSpiritGrade24Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(CursedSpiritGrade24Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(CursedSpiritGrade24Entity.class, EntityDataSerializers.f_135030_);
   }
}
