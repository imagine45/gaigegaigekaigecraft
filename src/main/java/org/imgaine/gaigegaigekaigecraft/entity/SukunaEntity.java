...
public class SukunaEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "sukuna");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = SukunaEntity.this.getX();
            double y = SukunaEntity.this.getY();
            double z = SukunaEntity.this.getZ();
            Entity entity = SukunaEntity.this;
            Level world = SukunaEntity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.SUKUNA.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.add(Attributes.MAX_HEALTH, 800.0);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(SukunaEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(SukunaEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(SukunaEntity.class, EntityDataSerializers.STRING);
   }
}
