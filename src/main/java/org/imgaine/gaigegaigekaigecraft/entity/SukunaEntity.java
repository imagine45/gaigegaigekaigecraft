...
public class SukunaEntity extends Monster implements GeoEntity {
   ...
   public SukunaEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.SUKUNA.get(), world);
   }
   ...
   public SukunaEntity(EntityType<SukunaEntity> type, Level world) {
      ...
      this.m_21557_(false);
      this.m_274367_(0.6F);
      this.m_8061_(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.UNIFORM_ITADORI_CHESTPLATE.get()));
      this.m_8061_(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.UNIFORM_ITADORI_LEGGINGS.get()));
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "sukuna");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = SukunaEntity.this.m_20185_();
            double y = SukunaEntity.this.m_20186_();
            double z = SukunaEntity.this.m_20189_();
            Entity entity = SukunaEntity.this;
            Level world = SukunaEntity.this.m_9236_();
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.SUKUNA.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22276_, 800.0);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(SukunaEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(SukunaEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(SukunaEntity.class, EntityDataSerializers.f_135030_);
   }
}
