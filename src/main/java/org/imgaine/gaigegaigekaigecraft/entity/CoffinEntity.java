...
import org.imgaine.gaigegaigekaigecraft.procedures.AICoffinProcedure;
...
public class CoffinEntity extends PathfinderMob {
   public CoffinEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.COFFIN.get(), world);
   }

   public CoffinEntity(EntityType<CoffinEntity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 0;
      this.m_21557_(false);
   ...
   public void m_6075_() {
      super.m_6075_();
      AICoffinProcedure.execute(this.m_9236_(), this);
   }
