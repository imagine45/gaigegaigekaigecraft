...
public class GojoSatoruEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT;
   public static final EntityDataAccessor<String> ANIMATION;
   public static final EntityDataAccessor<String> TEXTURE;
   public static final EntityDataAccessor<Boolean> DATA_ghost;
   ...
   public GojoSatoruEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.GOJO_SATORU.get(), world);
   }

   public GojoSatoruEntity(EntityType<GojoSatoruEntity> type, Level world) {
      super(type, world);
      ...
      this.m_21557_(false);
      this.m_274367_(0.6F);
      this.m_8061_(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.UNIFORM_GOJO_HELMET.get()));
      this.m_8061_(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.UNIFORM_GOJO_CHESTPLATE.get()));
      this.m_8061_(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.UNIFORM_GOJO_LEGGINGS.get()));
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "gojo_satoru");
      this.f_19804_.m_135372_(DATA_ghost, false);
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = GojoSatoruEntity.this.m_20185_();
            double y = GojoSatoruEntity.this.m_20186_();
            double z = GojoSatoruEntity.this.m_20189_();
            Entity entity = GojoSatoruEntity.this;
            Level world = GojoSatoruEntity.this.m_9236_();
   ...
   public void m_7380_(CompoundTag compound) {
      ...
      compound.m_128379_("Dataghost", (Boolean)this.f_19804_.m_135370_(DATA_ghost));
   }
   ...
   public void m_7378_(CompoundTag compound) {
      ...
      if (compound.m_128441_("Dataghost")) {
         this.f_19804_.m_135381_(DATA_ghost, compound.m_128471_("Dataghost"));
      }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.GOJO_SATORU.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(GojoSatoruEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(GojoSatoruEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(GojoSatoruEntity.class, EntityDataSerializers.f_135030_);
      DATA_ghost = SynchedEntityData.m_135353_(GojoSatoruEntity.class, EntityDataSerializers.f_135035_);
   }
}
