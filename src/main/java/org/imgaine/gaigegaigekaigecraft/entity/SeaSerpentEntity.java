...
public class SeaSerpentEntity extends PathfinderMob implements GeoEntity {
   ...
   public SeaSerpentEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.SEA_SERPENT.get(), world);
   }

   public SeaSerpentEntity(EntityType<SeaSerpentEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "dagon_fish1");
   }
   ...
   private PlayState movementPredicate(AnimationState event) {
      if (!this.animationprocedure.equals("empty")) {
      ...
      } else if ((event.isMoving() || !(event.getLimbSwingAmount() > -0.15F) || !(event.getLimbSwingAmount() < 0.15F)) && this.m_20096_() && !this.m_5912_() && !this.m_20142_()) {
         ...
         return this.m_5912_() && event.isMoving() ? event.setAndContinue(RawAnimation.begin().thenLoop("swim")) : event.setAndContinue(RawAnimation.begin().thenLoop("swim"));
      }
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(SeaSerpentEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(SeaSerpentEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(SeaSerpentEntity.class, EntityDataSerializers.f_135030_);
   }
}
