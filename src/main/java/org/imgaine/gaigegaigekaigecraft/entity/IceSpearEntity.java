...
public class IceSpearEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "tex_ice");
   }
   ...
   public void die(DamageSource source) {
      super.die(source);
      IceSpearEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }
   ...
   public void baseTick() {
      super.baseTick();
      AIStandIceSpearProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(IceSpearEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(IceSpearEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(IceSpearEntity.class, EntityDataSerializers.STRING);
   }
}
