...
import org.imgaine.gaigegaigekaigecraft.procedures.AIStandIceSpearProcedure;
import org.imgaine.gaigegaigekaigecraft.procedures.AlwayTrueProcedure;
import org.imgaine.gaigegaigekaigecraft.procedures.IceSpearEntityDiesProcedure;
...
public class IceSpearEntity extends PathfinderMob implements GeoEntity {
   ...
   public IceSpearEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ICE_SPEAR.get(), world);
   }

   public IceSpearEntity(EntityType<IceSpearEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "tex_ice");
   }
   ...
   public SoundEvent m_7975_(DamageSource ds) {
      return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.glass.break"));
   }
   ...
   public void m_6667_(DamageSource source) {
      ...
      IceSpearEntityDiesProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      AIStandIceSpearProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(IceSpearEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(IceSpearEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(IceSpearEntity.class, EntityDataSerializers.f_135030_);
   }
}
