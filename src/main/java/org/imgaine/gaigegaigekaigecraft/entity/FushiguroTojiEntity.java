...
public class FushiguroTojiEntity extends Monster implements GeoEntity {
   ...
   public FushiguroTojiEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.FUSHIGURO_TOJI.get(), world);
   }

   public FushiguroTojiEntity(EntityType<FushiguroTojiEntity> type, Level world) {
      super(type, world);
      ...
      this.m_21557_(false);
      this.m_274367_(0.6F);
      this.m_8061_(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_FUSHIGURO_TOJI_CHESTPLATE.get()));
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "fushiguro_toji");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = FushiguroTojiEntity.this.m_20185_();
            double y = FushiguroTojiEntity.this.m_20186_();
            double z = FushiguroTojiEntity.this.m_20189_();
            Entity entity = FushiguroTojiEntity.this;
            Level world = FushiguroTojiEntity.this.m_9236_();
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.FUSHIGURO_TOJI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(FushiguroTojiEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(FushiguroTojiEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(FushiguroTojiEntity.class, EntityDataSerializers.f_135030_);
   }
}
