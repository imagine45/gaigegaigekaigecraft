...
public class FushiguroTojiEntity extends Monster implements GeoEntity {
   ...
   public FushiguroTojiEntity(EntityType<FushiguroTojiEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_FUSHIGURO_TOJI_CHESTPLATE.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "fushiguro_toji");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = FushiguroTojiEntity.this.getX();
            double y = FushiguroTojiEntity.this.getY();
            double z = FushiguroTojiEntity.this.getZ();
            Entity entity = FushiguroTojiEntity.this;
            Level world = FushiguroTojiEntity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.FUSHIGURO_TOJI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(FushiguroTojiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(FushiguroTojiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(FushiguroTojiEntity.class, EntityDataSerializers.STRING);
   }
}
