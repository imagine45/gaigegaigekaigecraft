...
public class TakabaFumihikoEntity extends Monster implements GeoEntity {
   ...
   public TakabaFumihikoEntity(EntityType<TakabaFumihikoEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.COSTUME_TAKABA_CHESTPLATE.get()));
      this.setItemSlot(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.COSTUME_TAKABA_LEGGINGS.get()));
      this.setItemSlot(EquipmentSlot.FEET, new ItemStack((ItemLike)JujutsucraftModItems.COSTUME_TAKABA_BOOTS.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "takaba_fumihiko");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = TakabaFumihikoEntity.this.getX();
            double y = TakabaFumihikoEntity.this.getY();
            double z = TakabaFumihikoEntity.this.getZ();
            Entity entity = TakabaFumihikoEntity.this;
            Level world = TakabaFumihikoEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AITakabaFumihikoProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.TAKABA_FUMIHIKO.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(TakabaFumihikoEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(TakabaFumihikoEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(TakabaFumihikoEntity.class, EntityDataSerializers.STRING);
   }
}
