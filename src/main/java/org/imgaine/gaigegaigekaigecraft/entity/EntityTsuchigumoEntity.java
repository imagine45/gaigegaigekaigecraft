...
public class EntityTsuchigumoEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT;
   public static final EntityDataAccessor<String> ANIMATION;
   public static final EntityDataAccessor<String> TEXTURE;
   public static final EntityDataAccessor<Integer> DATA_model;
   ...
   public EntityTsuchigumoEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_TSUCHIGUMO.get(), world);
   }

   public EntityTsuchigumoEntity(EntityType<EntityTsuchigumoEntity> type, Level world) {
      super(type, world);
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "cursedspirit_tsuchigumo_mini_1");
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = EntityTsuchigumoEntity.this.getX();
            double y = EntityTsuchigumoEntity.this.getY();
            double z = EntityTsuchigumoEntity.this.getZ();
            Entity entity = EntityTsuchigumoEntity.this;
            Level world = EntityTsuchigumoEntity.this.level();
   ...
   public void addAdditionalSaveData(CompoundTag compound) {
      ...
      compound.putInt("Datamodel", (Integer)this.entityData.get(DATA_model));
   }
   ...
   public void baseTick() {
      super.baseTick();
      AIRatProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityTsuchigumoEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityTsuchigumoEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityTsuchigumoEntity.class, EntityDataSerializers.STRING);
      DATA_model = SynchedEntityData.defineId(EntityTsuchigumoEntity.class, EntityDataSerializers.INT);
   }
}
