...
public class EntityDomainInumakiEntity extends PathfinderMob implements GeoEntity {
   ...
   public EntityDomainInumakiEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_DOMAIN_INUMAKI.get(), world);
   }

   public EntityDomainInumakiEntity(EntityType<EntityDomainInumakiEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "inumaki_domain");
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EntityDomainInumakiEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EntityDomainInumakiEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EntityDomainInumakiEntity.class, EntityDataSerializers.f_135030_);
   }
}
