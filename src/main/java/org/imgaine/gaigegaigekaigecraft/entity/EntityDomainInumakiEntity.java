...
public class EntityDomainInumakiEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "inumaki_domain");
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityDomainInumakiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityDomainInumakiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityDomainInumakiEntity.class, EntityDataSerializers.STRING);
   }
}
