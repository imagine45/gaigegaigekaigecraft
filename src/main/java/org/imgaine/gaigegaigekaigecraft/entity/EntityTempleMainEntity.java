...
public class EntityTempleMainEntity extends PathfinderMob implements GeoEntity {
   ...
   public EntityTempleMainEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_TEMPLE_MAIN.get(), world);
   }

   public EntityTempleMainEntity(EntityType<EntityTempleMainEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "entity_temple");
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EntityTempleMainEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EntityTempleMainEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EntityTempleMainEntity.class, EntityDataSerializers.f_135030_);
   }
}
