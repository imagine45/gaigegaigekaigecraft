...
public class EntityTempleMainEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "entity_temple");
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityTempleMainEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityTempleMainEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityTempleMainEntity.class, EntityDataSerializers.STRING);
   }
}
