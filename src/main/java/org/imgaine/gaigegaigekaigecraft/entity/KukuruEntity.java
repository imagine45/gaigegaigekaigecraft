...
public class KukuruEntity extends Monster implements GeoEntity {
   ...
   public KukuruEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.KUKURU.get(), world);
   }

   public KukuruEntity(EntityType<KukuruEntity> type, Level world) {
      super(type, world);
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "kukuru_unit");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = KukuruEntity.this.getX();
            double y = KukuruEntity.this.getY();
            double z = KukuruEntity.this.getZ();
            Entity entity = KukuruEntity.this;
            Level world = KukuruEntity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.KUKURU.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(KukuruEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(KukuruEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(KukuruEntity.class, EntityDataSerializers.STRING);
   }
}
