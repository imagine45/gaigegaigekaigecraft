...
public class EntityTreeHanamiEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "tree_hanami");
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityTreeHanamiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityTreeHanamiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityTreeHanamiEntity.class, EntityDataSerializers.STRING);
   }
}
