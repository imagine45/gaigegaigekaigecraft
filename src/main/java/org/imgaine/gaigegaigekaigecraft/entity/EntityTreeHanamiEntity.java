...
public class EntityTreeHanamiEntity extends PathfinderMob implements GeoEntity {
   ...
   public EntityTreeHanamiEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_TREE_HANAMI.get(), world);
   }

   public EntityTreeHanamiEntity(EntityType<EntityTreeHanamiEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "tree_hanami");
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EntityTreeHanamiEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EntityTreeHanamiEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EntityTreeHanamiEntity.class, EntityDataSerializers.f_135030_);
   }
}
