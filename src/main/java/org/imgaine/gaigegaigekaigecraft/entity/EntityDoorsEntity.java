...
import org.imgaine.gaigegaigekaigecraft.procedures.AIDoorsProcedure;
...
public class EntityDoorsEntity extends PathfinderMob implements GeoEntity {
   ...
   public EntityDoorsEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_DOORS.get(), world);
   }

   public EntityDoorsEntity(EntityType<EntityDoorsEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "door_green");
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      AIDoorsProcedure.execute(this.m_9236_(), this);
      this.m_6210_();
   }
   ...
   private PlayState attackingPredicate(AnimationState event) {
      ...
      if (this.swinging && event.getController().getAnimationState() == State.STOPPED) {
         ...
         return event.setAndContinue(RawAnimation.begin().thenPlay("close"));
      } else {
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EntityDoorsEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EntityDoorsEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EntityDoorsEntity.class, EntityDataSerializers.f_135030_);
   }
}
