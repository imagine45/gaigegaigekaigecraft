...
import org.imgaine.gaigegaigekaigecraft.procedures.AIEntitySlashProcedure;
...
public class EntityAttackSweepEntity extends PathfinderMob implements GeoEntity {
   ...
   public EntityAttackSweepEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_ATTACK_SWEEP.get(), world);
   }

   public EntityAttackSweepEntity(EntityType<EntityAttackSweepEntity> type, Level world) {
      super(type, world);
   ...
   public void m_6075_() {
      super.m_6075_();
      AIEntitySlashProcedure.execute(this.m_9236_(), this);
      this.m_6210_();
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EntityAttackSweepEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EntityAttackSweepEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EntityAttackSweepEntity.class, EntityDataSerializers.f_135030_);
   }
}
