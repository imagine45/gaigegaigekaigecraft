...
public class EntityAttackSweepEntity extends PathfinderMob implements GeoEntity {
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityAttackSweepEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityAttackSweepEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityAttackSweepEntity.class, EntityDataSerializers.STRING);
   }
}
