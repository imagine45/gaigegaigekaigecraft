...
public class CurseUser1Entity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "curseuser1");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = CurseUser1Entity.this.getX();
            double y = CurseUser1Entity.this.getY();
            double z = CurseUser1Entity.this.getZ();
            Entity entity = CurseUser1Entity.this;
            Level world = CurseUser1Entity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSE_USER_1.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CurseUser1Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CurseUser1Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CurseUser1Entity.class, EntityDataSerializers.STRING);
   }
}
