...
import org.imgaine.gaigegaigekaigecraft.procedures.AICursedSpiritZonbaProcedure;
...
public class CursedSpiritGrade11Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade11Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_11.get(), world);
   }

   public CursedSpiritGrade11Entity(EntityType<CursedSpiritGrade11Entity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "cursedspirit1_1");
   }
   ...
   protected void m_8099_() {
      super.m_8099_();
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 0.1, true) {
         protected double m_6639_(LivingEntity entity) {
            return 0.0;
         }

         public boolean m_8036_() {
            double x = CursedSpiritGrade11Entity.this.m_20185_();
            double y = CursedSpiritGrade11Entity.this.m_20186_();
            double z = CursedSpiritGrade11Entity.this.m_20189_();
            Entity entity = CursedSpiritGrade11Entity.this;
            Level world = CursedSpiritGrade11Entity.this.m_9236_();
      ...
      this.f_21345_.m_25352_(5, new RandomStrollGoal(this, 0.1));
   ...
   public void m_6075_() {
      super.m_6075_();
      AICursedSpiritZonbaProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_11.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22284_, 14.0);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(CursedSpiritGrade11Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(CursedSpiritGrade11Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(CursedSpiritGrade11Entity.class, EntityDataSerializers.f_135030_);
   }
}
