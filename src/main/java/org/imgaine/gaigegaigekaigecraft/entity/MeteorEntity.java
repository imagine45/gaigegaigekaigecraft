...
import org.imgaine.gaigegaigekaigecraft.procedures.AIMeteorProcedure;
...
public class MeteorEntity extends PathfinderMob implements GeoEntity {
   ...
   public MeteorEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.METEOR.get(), world);
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "ball_maximum");
   ...
   public void baseTick() {
      super.baseTick();
      AIMeteorProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(MeteorEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(MeteorEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(MeteorEntity.class, EntityDataSerializers.STRING);
      DATA_mode = SynchedEntityData.defineId(MeteorEntity.class, EntityDataSerializers.INT);
   }
}
