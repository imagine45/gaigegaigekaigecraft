...
public class MeteorEntity extends PathfinderMob {
   ...
   public void m_6075_() {
      super.m_6075_();
      AIMeteorProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
   }
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22278_, 25.0);
      return builder;
   }
}
