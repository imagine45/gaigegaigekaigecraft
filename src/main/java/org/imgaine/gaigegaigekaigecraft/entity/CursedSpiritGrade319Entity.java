...
public class CursedSpiritGrade319Entity extends Monster {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, false) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade319Entity.this.getX();
            double y = CursedSpiritGrade319Entity.this.getY();
            double z = CursedSpiritGrade319Entity.this.getZ();
            Entity entity = CursedSpiritGrade319Entity.this;
            Level world = CursedSpiritGrade319Entity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_319.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
