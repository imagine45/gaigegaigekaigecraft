...
import org.imgaine.gaigegaigekaigecraft.procedures.AICursedSpirit010Procedure;
...
public class CursedSpiritGrade010Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade010Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_010.get(), world);
   }

   public CursedSpiritGrade010Entity(EntityType<CursedSpiritGrade010Entity> type, Level world) {
      super(type, world);
      ...
      this.m_21557_(false);
      this.m_274367_(2.2F);
      this.m_8061_(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.MAHORAGA_WHEEL_HELMET.get()));
      this.m_8061_(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.HITEN.get()));
   }
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "yamata_no_orochi");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = CursedSpiritGrade010Entity.this.m_20185_();
            double y = CursedSpiritGrade010Entity.this.m_20186_();
            double z = CursedSpiritGrade010Entity.this.m_20189_();
            Entity entity = CursedSpiritGrade010Entity.this;
            Level world = CursedSpiritGrade010Entity.this.m_9236_();
   ...
   public void m_6075_() {
      super.m_6075_();
      AICursedSpirit010Procedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_010.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22278_, 4.0);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(CursedSpiritGrade010Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(CursedSpiritGrade010Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(CursedSpiritGrade010Entity.class, EntityDataSerializers.f_135030_);
   }
}
