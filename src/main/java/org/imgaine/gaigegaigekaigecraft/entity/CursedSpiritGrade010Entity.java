...
public class CursedSpiritGrade010Entity extends Monster implements GeoEntity {
   ...
   public CursedSpiritGrade010Entity(EntityType<CursedSpiritGrade010Entity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.MAHORAGA_WHEEL_HELMET.get()));
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.HITEN.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "yamata_no_orochi");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade010Entity.this.getX();
            double y = CursedSpiritGrade010Entity.this.getY();
            double z = CursedSpiritGrade010Entity.this.getZ();
            Entity entity = CursedSpiritGrade010Entity.this;
            Level world = CursedSpiritGrade010Entity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AICursedSpirit010Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_010.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CursedSpiritGrade010Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CursedSpiritGrade010Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CursedSpiritGrade010Entity.class, EntityDataSerializers.STRING);
   }
}
