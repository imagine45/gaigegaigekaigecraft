...
public class SlotEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "slot_machine");
      this.f_19804_.m_135372_(DATA_SLOT_MODE, 0);
      this.f_19804_.m_135372_(DATA_SLOT_NUM, 0);
      this.f_19804_.m_135372_(DATA_ANIMATION_NAME, "");
   }
   ...
   public void m_7380_(CompoundTag compound) {
      ...
      compound.m_128405_("DataSLOT_MODE", (Integer)this.f_19804_.m_135370_(DATA_SLOT_MODE));
      compound.m_128405_("DataSLOT_NUM", (Integer)this.f_19804_.m_135370_(DATA_SLOT_NUM));
      compound.m_128359_("DataANIMATION_NAME", (String)this.f_19804_.m_135370_(DATA_ANIMATION_NAME));
   }
   ...
   public void m_7378_(CompoundTag compound) {
      ...
      if (compound.m_128441_("DataSLOT_MODE")) {
         this.f_19804_.m_135381_(DATA_SLOT_MODE, compound.m_128451_("DataSLOT_MODE"));
      }

      if (compound.m_128441_("DataSLOT_NUM")) {
         this.f_19804_.m_135381_(DATA_SLOT_NUM, compound.m_128451_("DataSLOT_NUM"));
      }

      if (compound.m_128441_("DataANIMATION_NAME")) {
         this.f_19804_.m_135381_(DATA_ANIMATION_NAME, compound.m_128461_("DataANIMATION_NAME"));
      }
   ...
   public void m_6075_() {
      super.m_6075_();
      AISLOTProcedure.execute(this.m_9236_(), this);
      this.m_6210_();
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(SlotEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(SlotEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(SlotEntity.class, EntityDataSerializers.f_135030_);
      DATA_SLOT_MODE = SynchedEntityData.m_135353_(SlotEntity.class, EntityDataSerializers.f_135028_);
      DATA_SLOT_NUM = SynchedEntityData.m_135353_(SlotEntity.class, EntityDataSerializers.f_135028_);
      DATA_ANIMATION_NAME = SynchedEntityData.m_135353_(SlotEntity.class, EntityDataSerializers.f_135030_);
   }
}
