...
public class RozetsuShikigamiVessel2Entity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "rozetsu_shikigami_tenshadows_reinforce");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.4, true) {
         ...
         public boolean canUse() {
            double x = RozetsuShikigamiVessel2Entity.this.getX();
            double y = RozetsuShikigamiVessel2Entity.this.getY();
            double z = RozetsuShikigamiVessel2Entity.this.getZ();
            Entity entity = RozetsuShikigamiVessel2Entity.this;
            Level world = RozetsuShikigamiVessel2Entity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIShikigamiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.ROZETSU_SHIKIGAMI_VESSEL_2.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(RozetsuShikigamiVessel2Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(RozetsuShikigamiVessel2Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(RozetsuShikigamiVessel2Entity.class, EntityDataSerializers.STRING);
   }
}
