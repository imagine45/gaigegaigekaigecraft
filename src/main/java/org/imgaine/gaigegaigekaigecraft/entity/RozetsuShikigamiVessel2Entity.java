...
import org.imgaine.gaigegaigekaigecraft.procedures.AIShikigamiProcedure;
...
public class RozetsuShikigamiVessel2Entity extends Monster implements GeoEntity {
   ...
   public RozetsuShikigamiVessel2Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ROZETSU_SHIKIGAMI_VESSEL_2.get(), world);
   }

   public RozetsuShikigamiVessel2Entity(EntityType<RozetsuShikigamiVessel2Entity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "rozetsu_shikigami_tenshadows_reinforce");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.4, true) {
         ...
         public boolean m_8036_() {
            double x = RozetsuShikigamiVessel2Entity.this.m_20185_();
            double y = RozetsuShikigamiVessel2Entity.this.m_20186_();
            double z = RozetsuShikigamiVessel2Entity.this.m_20189_();
            Entity entity = RozetsuShikigamiVessel2Entity.this;
            Level world = RozetsuShikigamiVessel2Entity.this.m_9236_();
   ...
   public void m_6075_() {
      super.m_6075_();
      AIShikigamiProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.ROZETSU_SHIKIGAMI_VESSEL_2.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(RozetsuShikigamiVessel2Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(RozetsuShikigamiVessel2Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(RozetsuShikigamiVessel2Entity.class, EntityDataSerializers.f_135030_);
   }
}
