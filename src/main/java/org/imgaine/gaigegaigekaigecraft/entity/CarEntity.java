...
public class CarEntity extends PathfinderMob implements GeoEntity {
   ...
   public CarEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CAR.get(), world);
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "car1");
   }
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CAR.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> world.getDifficulty() != Difficulty.PEACEFUL && Monster.isDarkEnoughToSpawn(world, pos, random) && Mob.checkMobSpawnRules(entityType, world, reason, pos, random));
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CarEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CarEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CarEntity.class, EntityDataSerializers.STRING);
   }
}
