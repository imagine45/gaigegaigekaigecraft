...
import org.imgaine.gaigegaigekaigecraft.procedures.AIChosoProcedure;
...
public class KamoNoritoshiEntity extends Monster implements GeoEntity {
   ...
   public KamoNoritoshiEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.KAMO_NORITOSHI.get(), world);
   }

   public KamoNoritoshiEntity(EntityType<KamoNoritoshiEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "kamo_noritoshi");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = KamoNoritoshiEntity.this.m_20185_();
            double y = KamoNoritoshiEntity.this.m_20186_();
            double z = KamoNoritoshiEntity.this.m_20189_();
            Entity entity = KamoNoritoshiEntity.this;
            Level world = KamoNoritoshiEntity.this.m_9236_();
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.KAMO_NORITOSHI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(KamoNoritoshiEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(KamoNoritoshiEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(KamoNoritoshiEntity.class, EntityDataSerializers.f_135030_);
   }
}
