...
public class KamoNoritoshiEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "kamo_noritoshi");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = KamoNoritoshiEntity.this.getX();
            double y = KamoNoritoshiEntity.this.getY();
            double z = KamoNoritoshiEntity.this.getZ();
            Entity entity = KamoNoritoshiEntity.this;
            Level world = KamoNoritoshiEntity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.KAMO_NORITOSHI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(KamoNoritoshiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(KamoNoritoshiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(KamoNoritoshiEntity.class, EntityDataSerializers.STRING);
   }
}
