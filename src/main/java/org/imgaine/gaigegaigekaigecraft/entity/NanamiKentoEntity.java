...
public class NanamiKentoEntity extends Monster implements GeoEntity {
   ...
   public NanamiKentoEntity(EntityType<NanamiKentoEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.WEAPON_NANAMI.get()));
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_NANAMI_HELMET.get()));
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_NANAMI_CHESTPLATE.get()));
      this.setItemSlot(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_NANAMI_LEGGINGS.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "nanami_kento");
   }
   ...
   public void baseTick() {
      super.baseTick();
      AINanamiKentoProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.NANAMI_KENTO.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(NanamiKentoEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(NanamiKentoEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(NanamiKentoEntity.class, EntityDataSerializers.STRING);
   }
}
