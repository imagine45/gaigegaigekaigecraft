...
public class CursedSpiritGrade02Entity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "hanako");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.0, false) {
         ...
         public boolean canUse() {
            double x = CursedSpiritGrade02Entity.this.getX();
            double y = CursedSpiritGrade02Entity.this.getY();
            double z = CursedSpiritGrade02Entity.this.getZ();
            Entity entity = CursedSpiritGrade02Entity.this;
            Level world = CursedSpiritGrade02Entity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIHanakosanProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_02.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CursedSpiritGrade02Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CursedSpiritGrade02Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CursedSpiritGrade02Entity.class, EntityDataSerializers.STRING);
   }
}
