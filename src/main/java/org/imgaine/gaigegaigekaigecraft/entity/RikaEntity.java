...
public class RikaEntity extends Monster implements GeoEntity {
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "rika");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.5, false) {
         ...
         public boolean m_8036_() {
            double x = RikaEntity.this.m_20185_();
            double y = RikaEntity.this.m_20186_();
            double z = RikaEntity.this.m_20189_();
            Entity entity = RikaEntity.this;
            Level world = RikaEntity.this.m_9236_();
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22276_, 600.0);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(RikaEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(RikaEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(RikaEntity.class, EntityDataSerializers.f_135030_);
   }
}
