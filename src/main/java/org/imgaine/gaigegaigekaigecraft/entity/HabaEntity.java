...
public class HabaEntity extends Monster implements GeoEntity {
   ...
   public HabaEntity(EntityType<HabaEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.HEAD_PROPELLER_HELMET.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "haba");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = HabaEntity.this.getX();
            double y = HabaEntity.this.getY();
            double z = HabaEntity.this.getZ();
            Entity entity = HabaEntity.this;
            Level world = HabaEntity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.HABA.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(HabaEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(HabaEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(HabaEntity.class, EntityDataSerializers.STRING);
   }
}
