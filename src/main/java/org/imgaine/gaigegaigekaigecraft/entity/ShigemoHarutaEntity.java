...
public class ShigemoHarutaEntity extends Monster implements GeoEntity {
   ...
   public ShigemoHarutaEntity(EntityType<ShigemoHarutaEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.SWORD_SHIGEMO.get()));
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "shigemo_haruta");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = ShigemoHarutaEntity.this.getX();
            double y = ShigemoHarutaEntity.this.getY();
            double z = ShigemoHarutaEntity.this.getZ();
            Entity entity = ShigemoHarutaEntity.this;
            Level world = ShigemoHarutaEntity.this.level();
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.SHIGEMO_HARUTA.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(ShigemoHarutaEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(ShigemoHarutaEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(ShigemoHarutaEntity.class, EntityDataSerializers.STRING);
   }
}
