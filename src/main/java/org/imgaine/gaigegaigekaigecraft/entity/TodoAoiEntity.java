...
public class TodoAoiEntity extends Monster implements GeoEntity {
   ...
   public TodoAoiEntity(EntityType<TodoAoiEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.PENDANT_TODO_AOI.get()));
      this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.MUSCULAR_BODY_CHESTPLATE.get()));
      this.setItemSlot(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_TODO_AOI_LEGGINGS.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "todo_aoi");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = TodoAoiEntity.this.getX();
            double y = TodoAoiEntity.this.getY();
            double z = TodoAoiEntity.this.getZ();
            Entity entity = TodoAoiEntity.this;
            Level world = TodoAoiEntity.this.level();
   ...
   public boolean hurt(DamageSource source, float amount) {
      TodoAoiEntityIsHurtProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
      return super.hurt(source, amount);
   }

   public void die(DamageSource source) {
      super.die(source);
      TodoAoiEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }
   ...
   public void baseTick() {
      super.baseTick();
      AITodoProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.TODO_AOI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(TodoAoiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(TodoAoiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(TodoAoiEntity.class, EntityDataSerializers.STRING);
   }
}
