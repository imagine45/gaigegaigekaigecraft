...
import org.imgaine.gaigegaigekaigecraft.procedures.AITodoProcedure;
...
import org.imgaine.gaigegaigekaigecraft.procedures.SpawnLevel3Procedure;
import org.imgaine.gaigegaigekaigecraft.procedures.TodoAoiEntityDiesProcedure;
import org.imgaine.gaigegaigekaigecraft.procedures.TodoAoiEntityIsHurtProcedure;
import org.imgaine.gaigegaigekaigecraft.procedures.TodoAoiRightClickedOnEntityProcedure;
...
public class TodoAoiEntity extends Monster implements GeoEntity {
   ...
   public TodoAoiEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.TODO_AOI.get(), world);
   }

   public TodoAoiEntity(EntityType<TodoAoiEntity> type, Level world) {
      super(type, world);
      ...
      this.m_21557_(false);
      this.m_274367_(0.6F);
      this.m_8061_(EquipmentSlot.HEAD, new ItemStack((ItemLike)JujutsucraftModItems.PENDANT_TODO_AOI.get()));
      this.m_8061_(EquipmentSlot.CHEST, new ItemStack((ItemLike)JujutsucraftModItems.MUSCULAR_BODY_CHESTPLATE.get()));
      this.m_8061_(EquipmentSlot.LEGS, new ItemStack((ItemLike)JujutsucraftModItems.CLOTHES_TODO_AOI_LEGGINGS.get()));
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "todo_aoi");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean m_8036_() {
            double x = TodoAoiEntity.this.m_20185_();
            double y = TodoAoiEntity.this.m_20186_();
            double z = TodoAoiEntity.this.m_20189_();
            Entity entity = TodoAoiEntity.this;
            Level world = TodoAoiEntity.this.m_9236_();
   ...
   public boolean m_6469_(DamageSource source, float amount) {
      TodoAoiEntityIsHurtProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      return super.m_6469_(source, amount);
   }

   public void m_6667_(DamageSource source) {
      super.m_6667_(source);
      TodoAoiEntityDiesProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
   }
   ...
   public InteractionResult m_6071_(Player sourceentity, InteractionHand hand) {
      ...
      TodoAoiRightClickedOnEntityProcedure.execute(sourceentity);
      return retval;
   }

   public void m_6075_() {
      super.m_6075_();
      AITodoProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.TODO_AOI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(TodoAoiEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(TodoAoiEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(TodoAoiEntity.class, EntityDataSerializers.f_135030_);
   }
}
