...
public class TransfiguredHumanEntity extends Monster implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "idle_transfiguration1_skin");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = TransfiguredHumanEntity.this.getX();
            double y = TransfiguredHumanEntity.this.getY();
            double z = TransfiguredHumanEntity.this.getZ();
            Entity entity = TransfiguredHumanEntity.this;
            Level world = TransfiguredHumanEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AITransFiguredHumanProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.TRANSFIGURED_HUMAN.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(TransfiguredHumanEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(TransfiguredHumanEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(TransfiguredHumanEntity.class, EntityDataSerializers.STRING);
   }
}
