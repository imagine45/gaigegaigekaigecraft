...
public class EntityRozetsuDomainEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "rouzetsu_domain");
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityRozetsuDomainEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityRozetsuDomainEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityRozetsuDomainEntity.class, EntityDataSerializers.STRING);
   }
}
