...
public class EntityRozetsuDomainEntity extends PathfinderMob implements GeoEntity {
   ...
   public EntityRozetsuDomainEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_ROZETSU_DOMAIN.get(), world);
   }

   public EntityRozetsuDomainEntity(EntityType<EntityRozetsuDomainEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "rouzetsu_domain");
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EntityRozetsuDomainEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EntityRozetsuDomainEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EntityRozetsuDomainEntity.class, EntityDataSerializers.f_135030_);
   }
}
