...
public class CursedSpiritGrade38Entity extends Monster {
   public CursedSpiritGrade38Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_38.get(), world);
   }

   public CursedSpiritGrade38Entity(EntityType<CursedSpiritGrade38Entity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 10;
      this.m_21557_(false);
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(1, new MeleeAttackGoal(this, 1.2, false) {
         ...
         public boolean m_8036_() {
            double x = CursedSpiritGrade38Entity.this.m_20185_();
            double y = CursedSpiritGrade38Entity.this.m_20186_();
            double z = CursedSpiritGrade38Entity.this.m_20189_();
            Entity entity = CursedSpiritGrade38Entity.this;
            Level world = CursedSpiritGrade38Entity.this.m_9236_();
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_38.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.m_123341_();
         int y = pos.m_123342_();
         int z = pos.m_123343_();
