...
public class EntityJinichiDomain1Entity extends PathfinderMob implements GeoEntity {
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityJinichiDomain1Entity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityJinichiDomain1Entity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityJinichiDomain1Entity.class, EntityDataSerializers.STRING);
   }
}
