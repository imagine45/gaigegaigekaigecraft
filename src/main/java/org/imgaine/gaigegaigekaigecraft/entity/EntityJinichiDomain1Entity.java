...
public class EntityJinichiDomain1Entity extends PathfinderMob implements GeoEntity {
   ...
   public EntityJinichiDomain1Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_JINICHI_DOMAIN_1.get(), world);
   }

   public EntityJinichiDomain1Entity(EntityType<EntityJinichiDomain1Entity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "jinichi_domain");
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EntityJinichiDomain1Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EntityJinichiDomain1Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EntityJinichiDomain1Entity.class, EntityDataSerializers.f_135030_);
   }
}
