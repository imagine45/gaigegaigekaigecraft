...
public class NobaraKugisakiEntity extends Monster implements GeoEntity {
   ...
   public NobaraKugisakiEntity(EntityType<NobaraKugisakiEntity> type, Level world) {
      ...
      this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)JujutsucraftModItems.HAMMER.get()));
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "kugisaki_nobara");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
         ...
         public boolean canUse() {
            double x = NobaraKugisakiEntity.this.getX();
            double y = NobaraKugisakiEntity.this.getY();
            double z = NobaraKugisakiEntity.this.getZ();
            Entity entity = NobaraKugisakiEntity.this;
            Level world = NobaraKugisakiEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      AIKugisakiNobaraProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)JujutsucraftModEntities.NOBARA_KUGISAKI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(NobaraKugisakiEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(NobaraKugisakiEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(NobaraKugisakiEntity.class, EntityDataSerializers.STRING);
   }
}
