...
public class ResonanceEntity extends PathfinderMob implements GeoEntity {
   ...
   public void baseTick() {
      super.baseTick();
      AIResonanceProcedure.execute(this.level(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(ResonanceEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(ResonanceEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(ResonanceEntity.class, EntityDataSerializers.STRING);
   }
}
