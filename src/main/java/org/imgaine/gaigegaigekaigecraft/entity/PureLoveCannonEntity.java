...
public class PureLoveCannonEntity extends PathfinderMob {
   ...
   public void baseTick() {
      super.baseTick();
      AIPureLoveCannonProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   static {
      DATA_move = SynchedEntityData.defineId(PureLoveCannonEntity.class, EntityDataSerializers.BOOLEAN);
   }
}
