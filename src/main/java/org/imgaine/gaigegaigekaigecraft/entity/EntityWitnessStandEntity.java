...
import org.imgaine.gaigegaigekaigecraft.procedures.AIWitnessStandProcedure;
...
public class EntityWitnessStandEntity extends PathfinderMob implements GeoEntity {
   ...
   public EntityWitnessStandEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_WITNESS_STAND.get(), world);
   }

   public EntityWitnessStandEntity(EntityType<EntityWitnessStandEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "guillotine");
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      AIWitnessStandProcedure.execute(this.m_9236_(), this);
      this.m_6210_();
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(EntityWitnessStandEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(EntityWitnessStandEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(EntityWitnessStandEntity.class, EntityDataSerializers.f_135030_);
   }
}
