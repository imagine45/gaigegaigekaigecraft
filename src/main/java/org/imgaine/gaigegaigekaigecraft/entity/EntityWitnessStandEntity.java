...
public class EntityWitnessStandEntity extends PathfinderMob implements GeoEntity {
   ...
   public void baseTick() {
      super.baseTick();
      AIWitnessStandProcedure.execute(this.level(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EntityWitnessStandEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EntityWitnessStandEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EntityWitnessStandEntity.class, EntityDataSerializers.STRING);
   }
}
