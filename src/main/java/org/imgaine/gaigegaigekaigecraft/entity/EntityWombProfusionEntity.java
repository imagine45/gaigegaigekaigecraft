...
import org.imgaine.gaigegaigekaigecraft.procedures.AIWombProfusionProcedure;
...
public class EntityWombProfusionEntity extends PathfinderMob {
   public EntityWombProfusionEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)JujutsucraftModEntities.ENTITY_WOMB_PROFUSION.get(), world);
   }

   public EntityWombProfusionEntity(EntityType<EntityWombProfusionEntity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 0;
      this.m_21557_(true);
   ...
   public void m_6075_() {
      super.m_6075_();
      AIWombProfusionProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
   }
   ...
   public EntityDimensions m_6972_(Pose pose) {
      return super.m_6972_(pose).m_20388_(2.25F);
   }
