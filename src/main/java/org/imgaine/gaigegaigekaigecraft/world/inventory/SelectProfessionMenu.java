...
public class SelectProfessionMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
   ...
   public SelectProfessionMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
      super((MenuType)JujutsucraftModMenus.SELECT_PROFESSION.get(), id);
