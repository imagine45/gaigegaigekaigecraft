...
public class SelectTechnique2Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
   ...
   public SelectTechnique2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
      super((MenuType)JujutsucraftModMenus.SELECT_TECHNIQUE_2.get(), id);
