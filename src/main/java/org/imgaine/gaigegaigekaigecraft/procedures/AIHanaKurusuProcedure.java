...
public class AIHanaKurusuProcedure {
   public AIHanaKurusuProcedure() {
   }
         ...
         if (entity.isAlive()) {
            ...
            label64: {
               ...
               if (entity instanceof LivingEntity) {
                  LivingEntity _entity = (LivingEntity)entity;
                  if (!_entity.level().isClientSide()) {
                     _entity.addEffect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 2147483647, 7, false, false));
                  }
               }
            }
            ...
            if (var10000 instanceof LivingEntity) {
               ...
               if (entity.getPersistentData().getDouble("cnt_x") > 10.0 && entity.getPersistentData().getDouble("skill") == 0.0) {
                  ...
                  if (LogicStartProcedure.execute(entity)) {
                     rnd = 15.0;
                     tick = 350.0;
                     entity.getPersistentData().putDouble("skill", 2800.0 + rnd);
                     if (entity instanceof LivingEntity) {
                        LivingEntity _entity = (LivingEntity)entity;
                        if (!_entity.level().isClientSide()) {
