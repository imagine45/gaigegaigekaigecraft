...
public class AIHanakosanProcedure {
   public AIHanakosanProcedure() {
   }
   ...
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      if (entity != null) {
         ...
         double z_pos = 0.0;
         double yaw = 0.0;
         Entity shikigami = null;
         boolean exist_shikigami = false;
         if (entity.m_6084_()) {
            label71: {
            ...
            if (var10000 instanceof LivingEntity && entity.getPersistentData().m_128459_("cnt_target") > 6.0) {
               ...
               if (entity.getPersistentData().m_128459_("cnt_x") > 10.0 && entity.getPersistentData().m_128459_("skill") == 0.0) {
                  ...
                  if (LogicStartProcedure.execute(entity) && Math.random() < 0.5) {
                     if (GetDistanceProcedure.execute(entity) < 8.0) {
                        entity.getPersistentData().m_128347_("skill", 4331.0);
                        tick = 100.0;
                     } else {
                        entity.getPersistentData().m_128347_("skill", 4330.0);
                        tick = 50.0;
                     }
