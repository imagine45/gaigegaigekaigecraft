...
public class BuildApartmenthouse1Procedure {
   ...
   public static void execute(LevelAccessor world, double x, double y, double z) {
      ...
      double sy = 0.0;
      double sz = 0.0;
      if (world.m_6443_(CursedSpiritGrade24Entity.class, AABB.m_165882_(new Vec3(x, y, z), 64.0, 64.0, 64.0), (e) -> true).isEmpty()) {
         ...
         for(int index0 = 0; index0 < 2; ++index0) {
            ...
            if (Math.random() < 0.5) {
               if (world instanceof ServerLevel) {
                  ServerLevel _level = (ServerLevel)world;
                  Entity entityToSpawn = ((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_24.get()).m_262496_(_level, BlockPos.m_274561_(x_pos, y_pos, z_pos), MobSpawnType.MOB_SUMMONED);
