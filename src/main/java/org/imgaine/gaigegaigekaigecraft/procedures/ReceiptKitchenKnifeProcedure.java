...
public class ReceiptKitchenKnifeProcedure {
   public ReceiptKitchenKnifeProcedure() {
   }
      ...
      if (entity != null) {
         ...
         if (var10000 instanceof LivingEntity) {
            if (entity.getPersistentData().getDouble("cnt2") % 10.0 == 1.0) {
               ...
               double var72 = ((Entity)var10000).getX();
               ...
               double var73 = ((Entity)var10001).getY();
               ...
               var73 += (double)((Entity)var10002).getBbHeight() * 0.5;
               if (entity instanceof Mob) {
                  Mob _mobEnt = (Mob)entity;
                  var10002 = _mobEnt.getTarget();
               } else {
               ...
               RotateEntityProcedure.execute(var72, var73, ((Entity)var10002).getZ(), entity);
         ...
         if (entity.getPersistentData().getDouble("cnt1") < 4.0) {
            if (entity.getPersistentData().getDouble("cnt1") == 1.0) {
               ...
               yaw_1 = (double)entity.getYRot();
               pitch_1 = (double)entity.getXRot();
               ...
               for(int index1 = 0; index1 < 5; ++index1) {
                  if (NUM1 == 4.0) {
                     ...
                     if (NUM1 == 2.0) {
                        yaw += Math.toRadians(180.0);
                     }

                     pitch = NUM1 >= 1.0 && NUM1 <= 2.0 ? -45.0 : 0.0;
                     x_center = x_pos + Math.cos(yaw + Math.toRadians(90.0)) * Math.cos(picth) * distance;
                     y_center = y_pos + Math.sin(pitch) * -1.0 * distance;
                     z_center = z_pos + Math.sin(yaw + Math.toRadians(90.0)) * Math.cos(picth) * distance;
                  }

                  if (world instanceof ServerLevel) {
                     ServerLevel _serverLevel = (ServerLevel)world;
                     Entity entityinstance = ((EntityType)JujutsucraftModEntities.ENTITY_RECEIPT.get()).create(_serverLevel, (CompoundTag)null, (Consumer)null, BlockPos.containing(x_center, y_center, z_center), MobSpawnType.MOB_SUMMONED, false, false);
                     if (entityinstance != null) {
                        ...
                        if (entityinstance instanceof EntityReceiptEntity) {
                           ...
                           _datEntSetI.getEntityData().set(EntityReceiptEntity.DATA_mode, 1);
                        }
               ...
               entity.setYRot((float)yaw_1);
               entity.setXRot((float)pitch_1);
               entity.setYBodyRot(entity.getYRot());
               entity.setYHeadRot(entity.getYRot());
               entity.yRotO = entity.getYRot();
               entity.xRotO = entity.getXRot();
