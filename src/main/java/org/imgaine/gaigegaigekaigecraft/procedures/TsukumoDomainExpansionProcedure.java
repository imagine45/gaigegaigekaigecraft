...
public class TsukumoDomainExpansionProcedure {
   public TsukumoDomainExpansionProcedure() {
   }
   ...
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      if (entity != null) {
         ...
         entity.getPersistentData().m_128347_("select", 9.0);
         ...
         if (entity.getPersistentData().m_128459_("cnt1") > 0.0 && entity.getPersistentData().m_128459_("cnt1") > 33.0 && entity.getPersistentData().m_128459_("cnt1") == 34.0) {
            ...
            y_pos = entity.getPersistentData().m_128459_("y_pos_doma") + y_pos + 6.0;
            ...
            if (world instanceof ServerLevel) {
               ...
               Entity entityinstance = ((EntityType)JujutsucraftModEntities.ENTITY_JUPITER.get()).m_262451_(_serverLevel, (CompoundTag)null, (Consumer)null, BlockPos.m_274561_(x_pos, y_pos, z_pos), MobSpawnType.MOB_SUMMONED, false, false);
