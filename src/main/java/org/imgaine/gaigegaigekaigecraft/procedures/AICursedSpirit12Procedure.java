      ...
      if (entity != null) {
         ...
         if (entity.m_6084_()) {
            if (world instanceof ServerLevel) {
               ...
               _level.m_8767_(ParticleTypes.f_123765_, x, y, z, 15, (double)entity.m_20205_() * 0.5, 0.1, (double)entity.m_20205_() * 0.5, 0.1);
            }
               ...
               if (entity.getPersistentData().m_128459_("cnt_x") > 10.0 && entity.getPersistentData().m_128459_("skill") == 0.0) {
                  ...
                  if (LogicStartProcedure.execute(entity)) {
                     ...
                     if (Math.random() < 0.7 && GetDistanceNearestEnemyProcedure.execute(world, entity) < 6.0) {
                        entity.getPersistentData().m_128347_("skill", 2305.0);
                        tick = 75.0;
                     } else if (Math.random() < 0.5) {
                        entity.getPersistentData().m_128347_("skill", 152.0);
                        tick = 50.0;
                     } else {
                        entity.getPersistentData().m_128347_("skill", 151.0);
                        tick = 75.0;
                     }
