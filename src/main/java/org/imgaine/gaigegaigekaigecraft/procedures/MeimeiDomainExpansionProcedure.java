...
public class MeimeiDomainExpansionProcedure {
   public MeimeiDomainExpansionProcedure() {
   }
   ...
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      if (entity != null) {
         ...
         entity.getPersistentData().m_128347_("select", 11.0);
         ...
         if (entity.getPersistentData().m_128459_("cnt1") > 0.0 && entity.getPersistentData().m_128459_("cnt1") == 34.0) {
            ...
            for(int index0 = 0; index0 < 12; ++index0) {
               ...
               y_pos = entity.getPersistentData().m_128459_("y_pos_doma") + 1.0;
               ...
               if (world instanceof ServerLevel) {
                  ...
                  if (entityinstance != null) {
                     ...
                     if (entityinstance instanceof LivingEntity) {
                        ...
                        if (_livingEntity23.m_21204_().m_22171_((Attribute)JujutsucraftModAttributes.SIZE.get())) {
                           _livingEntity23.getAttribute_((Attribute)JujutsucraftModAttributes.SIZE.get()).m_22100_(2.0 + Math.random());
                        }
                     }
