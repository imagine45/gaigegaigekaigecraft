      ...
      if (entity != null) {
            ...
            if (entity.getPersistentData().m_128471_("PRESS_Z")) {
               ...
               if (entity.getPersistentData().m_128459_("cnt6") >= 5.0) {
                  if (world instanceof ServerLevel) {
                     ...
                     _level.m_8767_(ParticleTypes.f_123746_, x_pos, y_pos, z_pos, (int)(entity.getPersistentData().m_128459_("cnt6") + 1.0), 0.0, 0.0, 0.0, 0.25);
                  }

                  if (world instanceof ServerLevel) {
                     ServerLevel _level = (ServerLevel)world;
                     _level.m_8767_(ParticleTypes.f_123765_, x_pos, y_pos, z_pos, (int)(entity.getPersistentData().m_128459_("cnt6") + 1.0), 0.0, 0.0, 0.0, 0.25);
                  }
               ...
               if (entity.getPersistentData().m_128459_("cnt6") < 5.0) {
                  ...
                  if (entity.getPersistentData().m_128459_("cnt6") >= 5.0) {
                     ...
                     if (world instanceof ServerLevel) {
                        ServerLevel _level = (ServerLevel)world;
                        _level.m_8767_(ParticleTypes.f_123746_, x_pos, y_pos, z_pos, 20, 0.0, 0.0, 0.0, 1.0);
                     }
                  }
               }
            }
         ...
         if (entity.getPersistentData().m_128459_("cnt1") == 2.0) {
            ...
            if (world instanceof ServerLevel) {
               ...
               Entity entityinstance = ((EntityType)JujutsucraftModEntities.BULLET_SKULL.get()).m_262451_(_serverLevel, (CompoundTag)null, (Consumer)null, BlockPos.m_274561_(x_pos, y_pos, z_pos), MobSpawnType.MOB_SUMMONED, false, false);
               if (entityinstance != null) {
                  ...
                  entityinstance.getPersistentData().m_128347_("x_power", entity.m_20154_().f_82479_ * 2.0);
                  entityinstance.getPersistentData().m_128347_("y_power", entity.m_20154_().f_82480_ * 2.0);
                  entityinstance.getPersistentData().m_128347_("z_power", entity.m_20154_().f_82481_ * 2.0);
                  if (entityinstance instanceof LivingEntity) {
                     LivingEntity _livingEntity90 = (LivingEntity)entityinstance;
                     if (_livingEntity90.m_21204_().m_22171_((Attribute)JujutsucraftModAttributes.SIZE.get())) {
                        _livingEntity90.getAttribute_((Attribute)JujutsucraftModAttributes.SIZE.get()).m_22100_(2.0 + entity.getPersistentData().m_128459_("cnt6") * 0.2);
                     }
                  }
            ...
            if (world instanceof Level) {
               Level _level = (Level)world;
               if (!_level.m_5776_()) {
                  _level.m_5594_((Player)null, BlockPos.m_274561_(x, y, z), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.wither.shoot")), SoundSource.NEUTRAL, 0.8F, 1.0F);
               } else {
                  _level.m_7785_(x, y, z, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.wither.shoot")), SoundSource.NEUTRAL, 0.8F, 1.0F, false);
               }
            }
         }
