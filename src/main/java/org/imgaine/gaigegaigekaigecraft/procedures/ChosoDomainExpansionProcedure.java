...
public class ChosoDomainExpansionProcedure {
   ...
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      if (entity != null) {
         ...
         entity.getPersistentData().m_128347_("select", 10.0);
         DomainExpansionCreateBarrierProcedure.execute(world, x, y, z, entity);
         if (entity.getPersistentData().m_128459_("cnt1") > 33.0) {
            if (entity.getPersistentData().m_128459_("cnt1") == 34.0) {
               ...
               if (world instanceof ServerLevel) {
                  ...
                  Entity entityinstance = ((EntityType)JujutsucraftModEntities.ENTITY_HEART.get()).m_262451_(_serverLevel, (CompoundTag)null, (Consumer)null, BlockPos.m_274561_(x_pos, y_pos, z_pos), MobSpawnType.MOB_SUMMONED, false, false);
