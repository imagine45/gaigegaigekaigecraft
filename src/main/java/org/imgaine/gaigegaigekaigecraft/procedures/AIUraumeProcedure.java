         ...
         if (entity.m_6084_()) {
            label94: {
               ...
               if (entity instanceof LivingEntity) {
                  ...
                  if (!_entity.m_9236_().m_5776_()) {
                     _entity.m_7292_(new MobEffectInstance(MobEffects.f_19600_, 2147483647, 17, false, false));
                  }
               }
            }
            ...
            if (var10000 instanceof LivingEntity) {
               ...
               if (entity.getPersistentData().m_128459_("cnt_x") > 10.0 && entity.getPersistentData().m_128459_("skill") == 0.0) {
                  ...
                  if (LogicStartProcedure.execute(entity) && (Math.random() > 0.3 || entity.getPersistentData().m_128471_("UseCursedTechnique"))) {
                     ...
                     entity.getPersistentData().m_128347_("skill", (double)Math.round(2400.0 + rnd));
                     if (entity instanceof LivingEntity) {
                        LivingEntity _entity = (LivingEntity)entity;
                        if (!_entity.m_9236_().m_5776_()) {
