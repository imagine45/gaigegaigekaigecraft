      ...
      if (entity != null && guistate != null) {
         label29: {
            ...
            if (entity instanceof Player) {
               ...
               if (_playerHasItem.m_150109_().m_36063_(new ItemStack((ItemLike)JujutsucraftModItems.UNIFORM_NORMAL_HELMET.get()))) {
                  break label29;
               }
            }
            ...
            if (entity instanceof Player) {
               ...
               ItemStack _setstack = (new ItemStack((ItemLike)JujutsucraftModItems.UNIFORM_NORMAL_HELMET.get())).m_41777_();
