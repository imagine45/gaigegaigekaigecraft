...
public class BuildTempleWoodenProcedure {
   ...
   public static void execute(LevelAccessor world, double x, double y, double z) {
      ...
      double sy = 0.0;
      double sz = 0.0;
      if (world.m_6443_(CursedSpiritGrade13Entity.class, AABB.m_165882_(new Vec3(x, y, z), 64.0, 64.0, 64.0), (e) -> true).isEmpty()) {
         ...
         for(int index0 = 0; index0 < 20; ++index0) {
            ...
            for(int index1 = 0; index1 < 256; ++index1) {
               ...
               for(int index2 = 0; index2 < 24; ++index2) {
                  if (world.m_46859_(BlockPos.m_274561_(x_pos, y_pos, z_pos)) && !world.m_46859_(BlockPos.m_274561_(x_pos, y_pos - 1.0, z_pos)) && !world.m_8055_(BlockPos.m_274561_(x_pos, y_pos - 1.0, z_pos)).m_204336_(BlockTags.create(new ResourceLocation("minecraft:slabs")))) {
                     SUCCESS = true;
            ...
            if (!boss_flag) {
               ...
               if (world instanceof ServerLevel) {
                  ServerLevel _level = (ServerLevel)world;
                  Entity entityToSpawn = ((EntityType)JujutsucraftModEntities.CURSED_SPIRIT_GRADE_13.get()).m_262496_(_level, BlockPos.m_274561_(x_pos, y_pos, z_pos), MobSpawnType.MOB_SUMMONED);
               ...
               for(Entity entityiterator : world.m_6443_(Entity.class, (new AABB(_center, _center)).m_82400_(0.5), (e) -> true).stream().sorted(Comparator.comparingDouble((_entcnd) -> _entcnd.m_20238_(_center))).toList()) {
                  if (entityiterator instanceof CursedSpiritGrade13Entity && !entityiterator.m_9236_().m_5776_() && entityiterator.m_20194_() != null) {
