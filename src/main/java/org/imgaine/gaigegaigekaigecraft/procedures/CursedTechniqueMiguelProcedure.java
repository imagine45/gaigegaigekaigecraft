...
public class CursedTechniqueMiguelProcedure {
   public CursedTechniqueMiguelProcedure() {
   }
   ...
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      if (entity != null) {
         double level = 0.0;
         double skill = 0.0;
         skill = (double)Math.round(entity.getPersistentData().getDouble("skill") - 3000.0);
         if (skill == 5.0) {
