   ...
   public static void execute(LevelAccessor world, Entity entity) {
      if (entity != null) {
         ...
         if (var10000 instanceof LivingEntity) {
            ...
            double var54 = ((Entity)var10005).getY();
            ...
            var54 += (double)((Entity)var10006).getBbHeight() * 0.5;
            if (entity instanceof Mob) {
               Mob _mobEnt = (Mob)entity;
               var10006 = _mobEnt.getTarget();
            } else {
            ...
            var10002 = new Vec3(var53, var54, ((Entity)var10006).getZ());
            entity.lookAt(var10001, var10002);
         }

         dis = 6.0;

         for(int index0 = 0; index0 < (int)Math.min(Math.ceil(entity.getPersistentData().getDouble("cnt1") * 2.0), 50.0); ++index0) {
            ...
            if (dis % 10.0 == 6.0) {
               ...
               for(Entity entityiterator : world.getEntitiesOfClass(Entity.class, (new AABB(_center, _center)).inflate(Math.min(dis, 12.0) / 2.0), (e) -> true)) {
         ...
         if (world instanceof ServerLevel) {
            ...
            if (entityinstance != null) {
               ...
               if (entityinstance instanceof LivingEntity) {
                  ...
                  if (_livingEntity41.getAttributes().hasAttribute(Attributes.MAX_HEALTH)) {
                     _livingEntity41.getAttribute(Attributes.MAX_HEALTH).setBaseValue(HP);
                  }
               }
               ...
               if (entityinstance instanceof LivingEntity) {
                  ...
                  if (_livingEntity48.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE)) {
                     AttributeInstance var49;
                     double var52;
                     label153: {
                        var49 = _livingEntity48.getAttribute(Attributes.ATTACK_DAMAGE);
                        if (entityinstance instanceof LivingEntity) {
                           LivingEntity _livingEntity45 = (LivingEntity)entityinstance;
                           if (_livingEntity45.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE)) {
                              var52 = _livingEntity45.getAttribute(Attributes.ATTACK_DAMAGE).getBaseValue();
                              break label153;
                           }
                        }
                     ...
                     var49.setBaseValue(var52 + entity.getPersistentData().getDouble("cnt1") * 0.02);
                  }
               }

               entityinstance.getPersistentData().putDouble("cnt6", 1.5);
         ...
         if (entity.getPersistentData().getDouble("cnt1") > 20.0) {
            ...
            if (var10000 instanceof LivingEntity) {
               ...
               if (entity instanceof LivingEntity) {
                  ...
                  if (_livEnt58.hasEffect((MobEffect)JujutsucraftModMobEffects.DAMAGE_EFFECT.get())) {
