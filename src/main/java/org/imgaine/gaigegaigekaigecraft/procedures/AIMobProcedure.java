         ...
         if (entity.isAlive()) {
            ...
            if (entity instanceof JujutsuSorcererEntity) {
               ...
               if (entity instanceof JujutsuSorcererEntity) {
                  ...
                  var10000 = (double)(Integer)_datEntI.getEntityData().get(JujutsuSorcererEntity.DATA_power);
               } else {
                  var10000 = 0.0;
               }
               ...
               if (entity instanceof CurseUserEntity) {
                  ...
                  var28 = (double)(Integer)_datEntI.getEntityData().get(CurseUserEntity.DATA_power);
               } else {
                  var28 = 0.0;
               }
            ...
            label76: {
               ...
               if (entity instanceof LivingEntity) {
                  ...
                  if (!_entity.level().isClientSide()) {
                     _entity.addEffect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 2147483647, (int)level_power, false, false));
                  }
               }
            }
