      ...
      if (entity != null) {
         ...
         if (entity.getPersistentData().m_128459_("cnt2") == 1.0) {
            ...
            if (entity.getPersistentData().m_128459_("cnt1") > 0.0) {
               ...
               y_pos = entity.m_20186_() + (double)entity.m_20206_() * 0.75 + Math.sin(pitch) * -1.0 * (double)(1.0F + entity.m_20205_()) + (Math.random() - 0.5) * 0.1;
               z_pos = entity.m_20189_() + Math.sin(yaw) * Math.cos(pitch) * (double)(1.0F + entity.m_20205_());
               if (world instanceof ServerLevel) {
                  ServerLevel _serverLevel = (ServerLevel)world;
                  Entity entityinstance = ((EntityType)JujutsucraftModEntities.FOX_FIRE.get()).m_262451_(_serverLevel, (CompoundTag)null, (Consumer)null, BlockPos.m_274561_(x_pos, y_pos, z_pos), MobSpawnType.MOB_SUMMONED, false, false);
                  if (entityinstance != null) {
                     ...
                     entityinstance.getPersistentData().m_128347_("cnt1", 14.0);
                     entityinstance.getPersistentData().m_128347_("cnt6", -0.5);
               ...
               if (world instanceof ServerLevel) {
                  ...
                  if (entityinstance != null) {
                     ...
                     if (entityinstance instanceof LivingEntity) {
                        ...
                        if (_livingEntity69.m_21204_().m_22171_(Attributes.f_22276_)) {
                           _livingEntity69.getAttribute_(Attributes.f_22276_).m_22100_(HP);
                        }
                     }
                     ...
                     entityinstance.getPersistentData().m_128347_("speed", -0.25);
                     _serverLevel.m_7967_(entityinstance);
                  }
               }
            }
