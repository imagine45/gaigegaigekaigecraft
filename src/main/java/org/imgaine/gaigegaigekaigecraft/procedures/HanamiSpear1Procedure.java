      ...
      if (entity != null) {
         ...
         if (entity.getPersistentData().getDouble("cnt2") > 0.0) {
            ...
            if (var85 instanceof LivingEntity) {
               ...
               double var88 = ((Entity)var85).getY();
               ...
               y_target = var88 + (double)((Entity)var10001).getBbHeight() * 0.5;
               LivingEntity var89;
               if (entity instanceof Mob) {
                  Mob _mobEnt = (Mob)entity;
               ...
               if (entityinstance != null) {
                  ...
                  if (entityinstance instanceof LivingEntity) {
                     ...
                     if (!_entity.level().isClientSide()) {
                        ...
                        var90 = new MobEffectInstance(var10003, 2147483647, var10005, false, false);
                        _entity.addEffect(var90);
                     }
                  }
                  ...
                  if (entityinstance instanceof LivingEntity) {
                     ...
                     if (_livingEntity155.getAttributes().hasAttribute((Attribute)JujutsucraftModAttributes.SIZE.get())) {
                        _livingEntity155.getAttribute((Attribute)JujutsucraftModAttributes.SIZE.get()).setBaseValue(2.5 * (1.0 + entity.getPersistentData().getDouble("cnt6") * 0.2));
                     }
                  }
