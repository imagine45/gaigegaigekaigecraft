...
public class ThreefoldAfflictionProcedure {
   ...
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      if (entity != null) {
         ...
         double dis = 0.0;
         double num2 = 0.0;
         entity.getPersistentData().putDouble("select", 39.0);
         ...
         if (entity.getPersistentData().getDouble("cnt1") > 0.0 && entity.getPersistentData().getDouble("cnt1") == 34.0) {
            ...
            for(int index0 = 0; index0 < 12; ++index0) {
               ...
               if (world instanceof ServerLevel) {
                  ...
                  Entity entityinstance = ((EntityType)JujutsucraftModEntities.ENTITY_THREEFOLD_AFFLICTION.get()).create(_serverLevel, (CompoundTag)null, (Consumer)null, BlockPos.containing(x_pos, y_pos, z_pos), MobSpawnType.MOB_SUMMONED, false, false);
