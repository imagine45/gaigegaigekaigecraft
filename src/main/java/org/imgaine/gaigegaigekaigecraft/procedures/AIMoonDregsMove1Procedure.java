...
public class AIMoonDregsMove1Procedure {
   public AIMoonDregsMove1Procedure() {
   }
            ...
            if (entity.getPersistentData().getDouble("friend_num") != 0.0 && LogicOwnerExistProcedure.execute(world, entity)) {
               ...
               if (entity.getPersistentData().getDouble("friend_num") == entity_a.getPersistentData().getDouble("friend_num")) {
                  ...
                  if (var10000 instanceof LivingEntity) {
                     ...
                     double var95 = ((Entity)var10000).getY();
                     ...
                     y_pos = var95 + (double)((Entity)var10001).getBbHeight() * 0.5;
                     LivingEntity var96;
                     if (entity_a instanceof Mob) {
                        Mob _mobEnt = (Mob)entity_a;
               ...
               if (entity.getPersistentData().getDouble("cnt3") <= 5.0) {
                  ...
                  if (entity.getPersistentData().getDouble("cnt3") == 1.0) {
                     ...
                     if (entity instanceof MoonDregsEntity) {
                        PlayAnimationEntity2Procedure.execute(entity, "punch_both");
                     }
                  }
