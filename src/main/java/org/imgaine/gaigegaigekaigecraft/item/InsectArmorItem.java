...
import org.imgaine.gaigegaigekaigecraft.client.renderer.InsectArmorArmorRenderer;
...
public class InsectArmorItem extends ArmorItem implements GeoItem {
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
   public String animationprocedure = "empty";
   String prevAnim = "empty";

   public InsectArmorItem(ArmorItem.Type type, Item.Properties properties) {
      super(new ArmorMaterial() {
         ...
         public int m_7366_(ArmorItem.Type type) {
            return (new int[]{1, 2, 5, 2})[type.m_266308_().m_20749_()];
         }
      ...
      consumer.accept(new IClientItemExtensions() {
         ...
         public HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
            if (this.renderer == null) {
               this.renderer = new InsectArmorArmorRenderer();
            }
