...
import org.imgaine.gaigegaigekaigecraft.item.model.ExecutionersSwordItemModel;
...
public class ExecutionersSwordItemRenderer extends GeoItemRenderer<ExecutionersSwordItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected ExecutionersSwordItem animatable;
   private final Set<String> hiddenBones = new HashSet();
   private final Set<String> suppressedBones = new HashSet();

   public ExecutionersSwordItemRenderer() {
      super(new ExecutionersSwordItemModel());
   }

   public RenderType getRenderType(ExecutionersSwordItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(ExecutionersSwordItem instance) {
