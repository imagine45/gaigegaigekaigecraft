...
public class InvertedSpearOfHeavenItem extends SwordItem {
   ...
   public void m_7373_(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
      ...
      list.add(Component.m_237115_("item.jujutsucraft.inverted_spear_of_heaven.description_0"));
      list.add(Component.m_237115_("item.jujutsucraft.inverted_spear_of_heaven.description_1"));
   }
}
