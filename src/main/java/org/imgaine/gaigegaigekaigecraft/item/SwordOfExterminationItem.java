...
public class SwordOfExterminationItem extends SwordItem {
   ...
   public void m_7373_(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
      ...
      list.add(Component.m_237115_("item.jujutsucraft.sword_of_extermination.description_0"));
      list.add(Component.m_237115_("item.jujutsucraft.sword_of_extermination.description_1"));
   }
}
