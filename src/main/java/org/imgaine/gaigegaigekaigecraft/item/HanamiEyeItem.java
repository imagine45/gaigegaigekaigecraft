...
import org.imgaine.gaigegaigekaigecraft.client.renderer.HanamiEyeArmorRenderer;
...
public class HanamiEyeItem extends ArmorItem implements GeoItem {
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
   public String animationprocedure = "empty";
   String prevAnim = "empty";

   public HanamiEyeItem(ArmorItem.Type type, Item.Properties properties) {
      ...
      consumer.accept(new IClientItemExtensions() {
         ...
         public HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
            if (this.renderer == null) {
               this.renderer = new HanamiEyeArmorRenderer();
            }
