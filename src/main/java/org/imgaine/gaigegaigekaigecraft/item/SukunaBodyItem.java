...
public abstract class SukunaBodyItem extends ArmorItem {
   ...
   public static class Chestplate extends SukunaBodyItem {
      ...
      public void initializeClient(Consumer<IClientItemExtensions> consumer) {
         consumer.accept(new IClientItemExtensions() {
            ...
            public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
               HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("body", (new Modelsukuna_body(Minecraft.m_91087_().m_167973_().m_171103_(Modelsukuna_body.LAYER_LOCATION))).armorBody, "left_arm", (new Modelsukuna_body(Minecraft.m_91087_().m_167973_().m_171103_(Modelsukuna_body.LAYER_LOCATION))).armorLeftArm, "right_arm", (new Modelsukuna_body(Minecraft.m_91087_().m_167973_().m_171103_(Modelsukuna_body.LAYER_LOCATION))).armorRightArm, "head", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "right_leg", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "left_leg", new ModelPart(Collections.emptyList(), Collections.emptyMap()))));
      ...
      public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
         return "jujutsucraft:textures/entities/sukuna_perfect.png";
      }
   }
}
