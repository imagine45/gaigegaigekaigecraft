...
public abstract class ClothesKashimoHajimeItem extends ArmorItem {
   ...
   public static class Helmet extends ClothesKashimoHajimeItem {
      public Helmet() {
   ...
   public static class Chestplate extends ClothesKashimoHajimeItem {
      public Chestplate() {
   ...
   public static class Leggings extends ClothesKashimoHajimeItem {
      public Leggings() {
   ...
   public static class Boots extends ClothesKashimoHajimeItem {
      public Boots() {
