...
import org.imgaine.gaigegaigekaigecraft.client.renderer.MythicalBeastAmberArmorRenderer;
...
public class MythicalBeastAmberItem extends ArmorItem implements GeoItem {
   ...
   public MythicalBeastAmberItem(ArmorItem.Type type, Item.Properties properties) {
      ...
      consumer.accept(new IClientItemExtensions() {
         ...
         public HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
            if (this.renderer == null) {
               this.renderer = new MythicalBeastAmberArmorRenderer();
            }
