...
import org.imgaine.gaigegaigekaigecraft.client.renderer.ItadoriYujiPaperArmorRenderer;
...
public class ItadoriYujiPaperItem extends ArmorItem implements GeoItem {
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
   public String animationprocedure = "empty";
   String prevAnim = "empty";

   public ItadoriYujiPaperItem(ArmorItem.Type type, Item.Properties properties) {
      ...
      consumer.accept(new IClientItemExtensions() {
         ...
         public HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
            if (this.renderer == null) {
               this.renderer = new ItadoriYujiPaperArmorRenderer();
            }
