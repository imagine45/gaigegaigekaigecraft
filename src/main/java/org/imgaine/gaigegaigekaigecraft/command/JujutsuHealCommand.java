...
public class JujutsuHealCommand {
   ...
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher().register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.m_82127_("jjc_heal").requires((s) -> s.m_6761_(2))).then(Commands.m_82129_("amount", DoubleArgumentType.doubleArg()).then(Commands.m_82129_("target", EntityArgument.m_91460_()).executes((arguments) -> {
