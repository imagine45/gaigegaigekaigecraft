...
@Mod("gaigegaigekaigecraft")
public class Gaigegaigekaigecraft {
    public static final Logger LOGGER = LogManager.getLogger(Gaigegaigekaigecraft.class);
    public static final String MODID = "gaigegaigekaigecraft";
    private static final String PROTOCOL_VERSION = "1";
    public static final SimpleChannel PACKET_HANDLER = NetworkRegistry.newSimpleChannel(new ResourceLocation("gaigegaigekaigecraft", "gaigegaigekaigecraft"), () -> "1", "1"::equals, "1"::equals);
